...
def alignedSquareW1ComplementOrder68Plus610 {R : Type*} [CommRing R] (h w1n e1b e3b a2b a1 a0 b6 b5 b4 b3 b2 b1 : R) : R := by
  refine ?_ + (39007939461120 : R) * e3b ^ 2 * a2b * b5
    - (38999023360671744 : R) * a2b * a1 * b4
    - (48748779200839680 : R) * a2b * a0 * b5
  refine ?_ + (17842520457216 : R) * w1n * e1b ^ 2 * e3b ^ 2 * b6
  ...
  refine ?_ - (39910901022720 : R) * w1n ^ 3 * e1b * e3b ^ 2 * b6
  ...
  refine ?_ + (100543399317504 : R) * w1n ^ 7 * e1b ^ 2 * b6
  ...
  refine ?_ + (2106428730900480 : R) * h * w1n * e3b * a0 * b5
  ...
  refine ?_ + (6951214811971584 : R) * h * w1n ^ 3 * e1b * a2b * b4
  ...
  refine ?_ + (2918248819200 : R) * h * w1n ^ 8 * e1b * b5
  ...
  refine ?_ - (22537920577536 : R) * h ^ 2 * w1n * e1b * e3b ^ 2 * b4
  ...
  refine ?_ + (313770113040384 : R) * h ^ 2 * w1n ^ 5 * e1b ^ 2 * b4
  ...
  refine ?_ + (7801587892224 : R) * h ^ 3 * e1b * e3b ^ 2 * b3
  ...
  refine ?_ + (570491114618880 : R) * h ^ 3 * w1n ^ 2 * e1b ^ 3 * b3
  ...
  refine ?_ - (3249918613389312 : R) * h ^ 4 * e1b * a2b * b1
  ...
  refine ?_ + (5071032129945600 : R) * h ^ 4 * w1n * e1b * e3b * a2b * a1
  ...
  refine ?_ + (28524555730944000 : R) * h ^ 4 * w1n ^ 3 * e1b * a1 ^ 2
  ...
  refine ?_ + (156728328192 : R) * h ^ 4 * w1n ^ 7 * b2
  ...
  refine ?_ - (111515752857600 : R) * h ^ 5 * e1b ^ 5 * a1
  ...
  refine ?_ - (20537680126279680 : R) * h ^ 5 * w1n ^ 2 * e1b * a1 * a0
  ...
  refine ?_ + (49961856461045760 : R) * h ^ 5 * w1n ^ 4 * a1 * a0
  ...
  refine ?_ - (1714090051215360 : R) * h ^ 5 * w1n ^ 6 * e1b * e3b * a2b
  ...
  refine ?_ - (2086844497920 : R) * h ^ 6 * e3b ^ 3 * a0
  ...
  refine ?_ - (7113144729600 : R) * h ^ 6 * w1n * e1b ^ 7
  ...
  refine ?_ - (2544319940198400 : R) * h ^ 6 * w1n ^ 4 * e1b * e3b * a0
  ...
  refine ?_ + (21307883950080 : R) * h ^ 6 * w1n ^ 7 * e1b * e3b ^ 2
