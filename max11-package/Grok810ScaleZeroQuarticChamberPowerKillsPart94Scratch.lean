...
theorem quarticChamberBCEFG6810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest16810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest16810_natDegree_lt_of_live_BCEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hDz (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta hz0zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := kappaQuarticChamberFace16810_coeff_top_S16 hBne hCne hFne hGne (A := A) (D := D) (E := E) (by omega)
  ...
  have hr1 : (muQuarticChamberRest20810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest20810_natDegree_lt_of_live_BCEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hDz (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := muQuarticChamberFace20810_coeff_top_S16 hAne hBne hCne hFne hGne (D := D) (E := E) (by omega)
  ...
  have hr2 : (piQuarticChamberRest14810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest14810_natDegree_lt_of_live_BCEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hDz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace14810_coeff_top_S16 hAne hFne hGne (B := B) (C := C) (D := D) (E := E) (by omega)
