...
import Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch
import Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch
...
/-- Tower deep-rescue `BCDEF1` on chamber `BCDEF` / `BF·CF·DD·DE·EE·BBB·BBC·BCC·CCC`, target `a*b*c*d*f^3`. -/
theorem quarticChamberBCDEF10810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticChamberBCDEF10810 A B C D E F G)
  ...
  have hdp0 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn; omega
  have hdz0 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0; omega
  have hz0l : l = 0 ∨ (4 * A.natDegree + B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 3 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 2 * A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + 3 * B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 2 * A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 2 * B.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ B.natDegree + 2 * C.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ C.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ D.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree) := by
    have hbls : l = 0 ∨ (4 * A.natDegree + B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree) := by
      ...
      · exact Or.inl h
      · exact Or.inr (by clear * - h hAG hGn hcq0 hcq1 hcq4 hcq8; omega)
    ...
    · exact Or.inl h
    · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq4 hcq8; omega)
  have hz0beta : beta = 0 ∨ (3 * A.natDegree + B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 2 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ 3 * B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree) := by
    have hbbetas : beta = 0 ∨ (3 * A.natDegree + B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree) := by
      ...
      · exact Or.inl h
      · exact Or.inr (by clear * - h hGn hcq0 hcq1 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq4 hcq8; omega)
  ...
  have hr0 : (muQuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest9000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 hGz (by clear * - hcq0 hcq1 hcq4 hcq8; omega) (by clear * - hcq0 hcq1 hcq2 hcq8; omega) (by clear * - hcq8; omega) (by clear * - hcq0 hcq4 hcq8; omega) hz0l hz0beta (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega)) hz0delta (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq1 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega))
  have hct0 := muQuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne (G := G) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega)
  have hq0 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hmuDeg]
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega
  ...
  have hdp1 : 0 < A.natDegree + 2 * B.natDegree + E.natDegree := by
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0; omega
  have hdz1 : 0 < A.natDegree + 2 * B.natDegree + E.natDegree := by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1; omega
  have hz1l : l = 0 ∨ (4 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * A.natDegree + 3 * B.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * A.natDegree + B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * A.natDegree + C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + 2 * B.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + B.natDegree + 2 * C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + C.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + D.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * B.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + C.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + 2 * D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ E.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
    have hbls : l = 0 ∨ (4 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
      rcases hkbl with h | h | h | h | h | h | h
      · exact Or.inl h
      · exact Or.inr (by clear * - h hAG hGn hcq1 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq2 hcq8; omega)
      · exact Or.inr (by clear * - h hcq8; omega)
      · exact Or.inr (by clear * - h hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq2 hcq4 hcq8; omega)
    rcases hbls with h | h
    · exact Or.inl h
    · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq4 hcq8; omega)
  have hz1beta : beta = 0 ∨ (3 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + 3 * B.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 2 * B.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + 2 * C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ C.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ D.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
    have hbbetas : beta = 0 ∨ (3 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
      rcases hkbbeta with h | h | h | h | h | h | h
      · exact Or.inl h
      · exact Or.inr (by clear * - h hGn hcq1 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq2 hcq8; omega)
      · exact Or.inr (by clear * - h hcq8; omega)
      · exact Or.inr (by clear * - h hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq2 hcq4 hcq8; omega)
  ...
  have hz1delta : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * B.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
    have hbdeltas : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
      ...
      · exact Or.inr (by clear * - h hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq4 hcq8; omega)
    rcases hbdeltas with h | h
    · exact Or.inl h
    · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq4 hcq8; omega)
  have hr1 : (xiQuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest9000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 hGz (by clear * - hcq2 hcq4 hcq8; omega) (by clear * - hcq2 hcq4 hcq8; omega) (by clear * - hcq0 hcq2 hcq4 hcq8; omega) (by clear * - hcq0 hcq2 hcq8; omega) (by clear * - hcq8; omega) (by clear * - hcq0 hcq1 hcq2 hcq8; omega) (by clear * - hcq2 hcq4 hcq8; omega) hz1l hz1beta (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) hz1delta (Or.inr (by clear * - hcq0 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq1 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq2 hcq4 hcq8; omega))
  have hct1 := xiQuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne (G := G) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1; omega)
  have hq1 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    apply coeff_eq_zero_of_natDegree_lt
    rw [hxiDeg]
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1; omega
  ...
  have hdp2 : 0 < 2 * A.natDegree + 4 * B.natDegree := by
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1; omega
  have hdz2 : 0 < 2 * A.natDegree + 4 * B.natDegree := by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2; omega
  ...
  have hr2 : (piQuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest9000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 hGz (by clear * - hcq8; omega) (by clear * - hcq0 hcq1 hcq4 hcq8; omega) (by clear * - hcq1 hcq8; omega) (by clear * - hcq0 hcq1 hcq2 hcq8; omega) (by clear * - hcq8; omega) (by clear * - hcq0 hcq8; omega) (by clear * - hcq1 hcq2 hcq4 hcq8; omega) (by clear * - hcq0 hcq4 hcq8; omega) (by clear * - hcq2 hcq4 hcq8; omega) hz2l hz2beta (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) hz2delta (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega)) (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega))
  have hct2 := piQuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne (G := G) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    apply coeff_eq_zero_of_natDegree_lt
    rw [hpiDeg]
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega
  ...
  have hdp3 : 0 < A.natDegree + 3 * B.natDegree := by
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2; omega
  have hdz3 : 0 < A.natDegree + 3 * B.natDegree := by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3; omega
  have hz3l : l = 0 ∨ (5 * A.natDegree < A.natDegree + 3 * B.natDegree ∧ 3 * A.natDegree + C.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * A.natDegree + E.natDegree < A.natDegree + 3 * B.natDegree ∧ A.natDegree + B.natDegree + D.natDegree < A.natDegree + 3 * B.natDegree ∧ A.natDegree + 2 * C.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * B.natDegree + C.natDegree < A.natDegree + 3 * B.natDegree ∧ B.natDegree + F.natDegree < A.natDegree + 3 * B.natDegree ∧ C.natDegree + E.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * D.natDegree < A.natDegree + 3 * B.natDegree) := by
    have hbls : l = 0 ∨ (5 * A.natDegree < A.natDegree + 3 * B.natDegree) := by
      ...
      · exact Or.inl h
      · exact Or.inr (by clear * - h hAG hGn hcq1 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq8; omega)
  ...
  have hz3delta : delta = 0 ∨ (3 * A.natDegree < A.natDegree + 3 * B.natDegree ∧ A.natDegree + C.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * B.natDegree < A.natDegree + 3 * B.natDegree ∧ E.natDegree < A.natDegree + 3 * B.natDegree) := by
    have hbdeltas : delta = 0 ∨ (3 * A.natDegree < A.natDegree + 3 * B.natDegree) := by
      ...
      · exact Or.inl h
      · exact Or.inr (by clear * - h hGn hcq1 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq2 hcq4 hcq8; omega)
      · exact Or.inr (by clear * - h hcq8; omega)
      · exact Or.inr (by clear * - h hcq1 hcq8; omega)
      · exact Or.inr (by clear * - h hcq0 hcq1 hcq2 hcq8; omega)
  ...
  have hr3 : (kappaQuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest9000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 hGz (by clear * - hcq8; omega) hz3l hz3beta (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega)) hz3delta (Or.inr (by clear * - hcq8; omega)) hz3zeta (Or.inr (by clear * - hcq1 hcq4 hcq8; omega)) hz3theta
  have hct3 := kappaQuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne (G := G) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3; omega)
  have hq3 : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hkap]
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3; omega
  ...
  have hdp4 : A.natDegree < A.natDegree + 2 * B.natDegree + D.natDegree := by
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3; omega
  have hdz4 : 0 < A.natDegree + 2 * B.natDegree + D.natDegree := by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3 hdp4; omega
  ...
  have hr4 : (n2QuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
    ...
    n2QuarticChamberRest9000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 hGz (by clear * - hcq0 hcq1 hcq4 hcq8; omega) (by clear * - hcq1 hcq8; omega) (by clear * - hcq8; omega) hz4l hz4beta (Or.inr (by clear * - hcq0 hcq1 hcq2 hcq4 hcq8; omega)) hz4delta (Or.inr (by clear * - hcq0 hcq1 hcq4 hcq8; omega)) hz4zeta (Or.inr (by clear * - hcq1 hcq4 hcq8; omega)) hz4theta
  have hct4 := n2QuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne (G := G) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3 hdp4 hdz4; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3 hdp4 hdz4; omega) (by clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3 hdp4 hdz4; omega)
  have hq4 : (degreeZeroN2Quartic810 l beta gamma delta epsilon zeta eta theta
    ...
    clear * - hcq0 hcq1 hcq2 hcq3 hcq4 hcq5 hcq6 hcq7 hcq8 hcq9 hcq10 hcq11 hcq12 hcq13 hcq14 hcq15 hcq16 hApos hAB hAC hAD hAE hAF hAG hGn hdp0 hdz0 hdp1 hdz1 hdp2 hdz2 hdp3 hdz3 hdp4 hdz4 hle; omega
  ...
  exact quarticCostChamberBCDEF1810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc
...
open private quarticChamberBCDEFG58810_impossible_row0 from Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch in
open private quarticChamberBCDEFG58810_impossible_row1 from Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch in
open private quarticChamberBCDEFG58810_impossible_row2 from Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch in
open private quarticChamberBCDEFG58810_impossible_row3 from Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch in
open private quarticChamberBCDEFG58810_impossible_row4 from Grok810ScaleZeroQuarticChamberTowerKills1Part1Row101Scratch in
set_option maxHeartbeats 64000000 in
/-- Tower deep-rescue `BCDEFG10` on chamber `BCDEFG` / `BG·CG·DD·DE·EE·BBB·BBC·BCC·CCC`, target `a*b*d^3*g^2`. -/
theorem quarticChamberBCDEFG58810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    ...
    (hpiDeg : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0) :
    False := by
  obtain ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, hcq0, hcq1, hcq2, hcq3, hcq4, hcq5, hcq6, hcq7, hcq8, hcq9, hcq10, hcq11, hcq12, hcq13, hcq14, hcq15, hcq16, hcq17, hcq18, hcq19, hcq20, hcq21, hcq22⟩ := id hch
  obtain ⟨hApos, hAB, hAC, hAD, hAE, hAF, hAG⟩ := id hA
  have hAne : A ≠ 0 := by
    intro h0
    have hz0 : A.natDegree = 0 := by simp [h0]
    clear * - hApos hz0; omega
  have hin0 := quarticChamberBCDEFG58810_impossible_row0 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin1 := quarticChamberBCDEFG58810_impossible_row1 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin2 := quarticChamberBCDEFG58810_impossible_row2 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin3 := quarticChamberBCDEFG58810_impossible_row3 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin4 := quarticChamberBCDEFG58810_impossible_row4 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hAc : A.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hAne
  have hBc : B.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hBne
  have hCc : C.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hCne
  have hDc : D.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hDne
  ...
  exact quarticCostChamberBCDEFG10810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc hGc
...
open private quarticChamberBCDEFG83810_impossible_row0 from Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch in
open private quarticChamberBCDEFG83810_impossible_row1 from Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch in
open private quarticChamberBCDEFG83810_impossible_row2 from Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch in
open private quarticChamberBCDEFG83810_impossible_row3 from Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch in
open private quarticChamberBCDEFG83810_impossible_row4 from Grok810ScaleZeroQuarticChamberTowerKills1Part2Row101Scratch in
set_option maxHeartbeats 64000000 in
...
theorem quarticChamberBCDEFG83810_impossible
  ...
  have hAne : A ≠ 0 := by
    ...
    have hz0 : A.natDegree = 0 := by simp [h0]
    clear * - hApos hz0; omega
  have hin0 := quarticChamberBCDEFG83810_impossible_row0 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin1 := quarticChamberBCDEFG83810_impossible_row1 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin2 := quarticChamberBCDEFG83810_impossible_row2 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin3 := quarticChamberBCDEFG83810_impossible_row3 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hin4 := quarticChamberBCDEFG83810_impossible_row4 l beta gamma delta epsilon zeta eta theta A B C D E F G hch hnc hkap homi hnu hmuDeg hxiDeg hpiDeg
  have hAc : A.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hAne
  have hBc : B.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hBne
  have hCc : C.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hCne
  have hDc : D.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hDne
