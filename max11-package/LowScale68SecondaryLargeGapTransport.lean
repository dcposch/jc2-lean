...
/-! # Transport of the subcritical large-gap endgame across `3g < 2n`

The earlier closure
`maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroSubcritical_impossible68`
packages the chamber `n < 2g ∧ g < n ∧ 3g < 2n`.  The third conjunct is
used only to discharge
`cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_largeGapLoadZero`
at the residual cubic index `12n-3g-1`.  Every other lemma in that file is
valid on `n < 2g ∧ g < n` after `l = 0`.

This module replays the endgame with the sharp row-one cutoff as an
explicit hypothesis, closing the full large-gap chamber `g < n` once
`cubicLoadRowOnePolynomial68` has `natDegree < 12*n-3*g-1`.  The
complementary wall `g = n` is the alpha wall of
`LowScale68SecondaryAlphaWall.lean` and is not treated here.
-/
...
section LargeGapLoadZeroTransport68
...
theorem largeGapTransport_natDegree_mul_derivative_lt68
    (p q : k[X]) (u v : ℕ)
...
theorem largeGapTransport_natDegree_derivative_mul_lt68
    (p q : k[X]) (u v : ℕ)
...
theorem cubicLoadRowZeroPolynomial68_degree_lt_residualDouble_of_largeGapLoadZeroTransport
...
set_option maxHeartbeats 2000000 in
theorem secondaryLoadInvariantFourPolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
...
set_option maxHeartbeats 2000000 in
theorem secondaryLoadInvariantThreePolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
    (beta gamma delta epsilon zeta : k) (A B c D e : k[X])
    (n g h : ℕ) (hg : 0 < g) (hgh : g < h) (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_Q_degree_lt68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g : ℕ)
    (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have h1 := largeGapTransport_natDegree_mul_derivative_lt68 A
    (residualIncidenceQ68 B c d e) (2 * n) (9 * n - 3 * g) hA hv hQ
  have h2 := largeGapTransport_natDegree_derivative_mul_lt68 A
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_Bd_degree_le68_of_largeGapLoadZeroTransport
    (B d : k[X]) (n g h : ℕ)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_BcCore_degree_le68_of_largeGapLoadZeroTransport
    (A B c : k[X]) (n g : ℕ)
    (hg : 0 < g) (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_de_degree_le68_of_largeGapLoadZeroTransport
    (d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g) (hchamber : n < 2 * g ∧ g < n)
    (hd : d.natDegree ≤ 5 * n - h)
    (he : e.natDegree ≤ 6 * n - h) :
...
theorem residualRowTwo_coeff_leftChamber68_of_largeGapLoadZeroTransport
  ...
  have hidx : 11 * n - 3 * g - 1 < idx := by
    dsimp [idx]
    omega
  have hQdeg := residualRowTwoInner_Q_degree_lt68_of_largeGapLoadZeroTransport A B c d e n g hchamber hA hQ
  have hAQ : (A * derivative Q).natDegree < idx := hQdeg.1.trans hidx
  have hAQ' : (derivative A * Q).natDegree < idx := hQdeg.2.trans hidx
  have hcore := residualRowTwoInner_BcCore_degree_le68_of_largeGapLoadZeroTransport A B c n g hg hchamber hA hB hc
  ...
  have hBd := residualRowTwoInner_Bd_degree_le68_of_largeGapLoadZeroTransport B d n g h hg hgh hh hchamber hB hd
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwo_leftChamber_ne_zero68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowTwoPolynomial68 A B c d e).coeff
        (11 * n - 2 * h - 1) ≠ 0 := by
  rw [residualRowTwo_coeff_leftChamber68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh hchamber hleft
    hA hB hc hd he hQ]
...
set_option maxHeartbeats 4000000 in
theorem residualRowTwo_coeff_rightChamber68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
  ...
  have hBd' : (derivative (B ^ 2 * d)).natDegree < idx := by
    dsimp [idx]
    omega
  have hde := residualRowTwoInner_de_degree_le68_of_largeGapLoadZeroTransport d e n g h hg hgh hh hchamber hd he
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwo_rightChamber_ne_zero68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hright : 3 * g < 2 * h)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowTwoPolynomial68 A B c d e).coeff
        (11 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowTwo_coeff_rightChamber68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh hchamber hright
...
set_option maxHeartbeats 2000000 in
theorem residualBalancedRowTwoInner_Q_degree_lt68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g : ℕ)
    (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
...
set_option maxHeartbeats 2000000 in
theorem residualBalancedRowTwoInner_Bd_degree_le68_of_largeGapLoadZeroTransport
    (B d : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g) (hchamber : n < 2 * g ∧ g < n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hd : d.natDegree ≤ 5 * n - h) :
...
theorem residualRowTwo_coeff_balancedChamber68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
  ...
  have hQdeg := residualBalancedRowTwoInner_Q_degree_lt68_of_largeGapLoadZeroTransport A B c d e n g hchamber hA hQ
  have hAQ : (A * derivative Q).natDegree < idx := by
    dsimp [idx]
    exact hQdeg.1
  have hAQ' : (derivative A * Q).natDegree < idx := by
    dsimp [idx]
    exact hQdeg.2
  have hBd := residualBalancedRowTwoInner_Bd_degree_le68_of_largeGapLoadZeroTransport B d n g h hg hgh hh hchamber hB hd
  have hBd' : (derivative (B ^ 2 * d)).natDegree < idx := by
    dsimp [idx]
    omega
  have hB2deg : (B ^ 2).natDegree ≤ 6 * n - 2 * g := by
...
theorem residualRowTwo_balanced_coeff_eq_zero_iff68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  rw [residualRowTwo_coeff_balancedChamber68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh hchamber
...
theorem residualRowTwo_add_load_eq_zero_imp_balancedRelation68_of_largeGapLoadZeroTransport
  ...
  have hcoeff :
    ...
    exact h
  exact (residualRowTwo_balanced_coeff_eq_zero_iff68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh
    hchamber hbalanced hA hB hc hd he hQ hdisc).1 hcoeff

theorem residualRowTwo_eq_zero_imp_balancedRelation68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
...
theorem residualRowOne_coeff_balancedChamber68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hI3low : (A * derivative I3).natDegree < idx := by
    ...
    have h := largeGapTransport_natDegree_mul_derivative_lt68 A I3
...
set_option maxHeartbeats 2000000 in
theorem residualRowOne_coeff_balancedChamber_eq68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  rw [residualRowOne_coeff_balancedChamber68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh hchamber
...
theorem residualRowOne_balanced_coeff_ne_zero68_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowOnePolynomial68 A B c d e).coeff
        (12 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowOne_coeff_balancedChamber_eq68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh
...
theorem residualRowOne_add_load_eq_zero_imp_false68_of_largeGapLoadZeroTransport
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hcoeff :
    ...
    rw [coeff_add, coeff_zero, coeff_eq_zero_of_natDegree_lt hload,
      add_zero] at h
    exact h
  exact residualRowOne_balanced_coeff_ne_zero68_of_largeGapLoadZeroTransport A B c d e n g h hg hgh hh
    hchamber hbalanced hA hB hcdeg hd he hI3 hc0 hdisc hinc hrel hcoeff

set_option maxHeartbeats 2000000 in
theorem residualRowTwo_not_leftChamber68_of_largeGapLoadZeroTransport
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  exact residualRowTwo_leftChamber_ne_zero68_of_largeGapLoadZeroTransport A B c d e n g h
    hg hgh hh hchamber hleft hA hB hc hd he hQ hd0 he0 hcoeff0

set_option maxHeartbeats 2000000 in
theorem residualRowTwo_not_rightChamber68_of_largeGapLoadZeroTransport
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n) (hright : 3 * g < 2 * h)
    (hA : A.natDegree ≤ 2 * n)
  ...
  exact residualRowTwo_rightChamber_ne_zero68_of_largeGapLoadZeroTransport A B c d e n g h
    hg hgh hh hchamber hright hA hB hc hd he hQ hdisc ha0 hb0 hcoeff0

set_option maxHeartbeats 2000000 in
theorem residualSelectedGap_eq_balanced68_of_largeGapLoadZeroTransport
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  · exact (residualRowTwo_not_leftChamber68_of_largeGapLoadZeroTransport A B c d e load n g h
      hg hgh hh hchamber hleft hA hB hc hd he hQ hload hsum hd0 he0).elim
  · exact heq
  · exact (residualRowTwo_not_rightChamber68_of_largeGapLoadZeroTransport A B c d e load n g h
      hg hgh hh hchamber hright hA hB hc hd he hQ hload hsum hdisc hb0 hc0).elim

set_option maxHeartbeats 3000000 in
theorem secondaryResidualRowOnePolynomial68_coeff_double_of_largeGapLoadZeroTransport
...
set_option maxHeartbeats 3000000 in
theorem secondaryResidualRowZeroPolynomial68_coeff_double_of_largeGapLoadZeroTransport
    (A B c d e : k[X]) (n g : ℕ) (hg : 0 < g) (hchamber : n < 2 * g ∧ g < n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
...
set_option maxHeartbeats 4000000 in
theorem secondaryResidualTiedDoubleFace68_impossible_of_largeGapLoadZeroTransport
...
theorem secondaryResidualDoubleFace68_impossible_of_largeGapLoadZeroTransport
    (n g : ℕ) (a b c d e : k)
  ...
  exact secondaryResidualTiedDoubleFace68_impossible_of_largeGapLoadZeroTransport
    n g a b c d e ha hb hc hn hchamber hface

set_option maxHeartbeats 4000000 in
theorem polynomialSecondaryResidualDoubleFace68_of_largeGapLoadZeroTransport
  ...
  have hloadOne :
    ...
    simpa only [D0] using hrowOneCut
  have hone := congrArg
  ...
  rw [hcoords.t_eq, hcoords.u_eq, hcoords.v_eq,
    ...
    secondaryResidualRowOnePolynomial68_coeff_double_of_largeGapLoadZeroTransport A B c d e n g
  ...
  rw [hcoords.u_eq, hcoords.v_eq, cubicRowZeroPolynomial68_split,
    ...
    secondaryResidualRowZeroPolynomial68_coeff_double_of_largeGapLoadZeroTransport A B c d e n g
      hg hchamber hA hB hc hd he,
    coeff_eq_zero_of_natDegree_lt
      (cubicLoadRowZeroPolynomial68_degree_lt_residualDouble_of_largeGapLoadZeroTransport
...
set_option maxHeartbeats 2000000 in
theorem residualSelectedGap_eq_balanced68_of_rowTwoSystem_of_largeGapLoadZeroTransport
    (alpha beta gamma delta epsilon zeta eta : k)
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hchamber : n < 2 * g ∧ g < n)
  ...
  exact residualSelectedGap_eq_balanced68_of_largeGapLoadZeroTransport A B c d e
    (cubicLoadRowTwoPolynomial68 0 alpha beta gamma delta epsilon zeta eta
      A B c ((1 / 3 : k) • (A * B) + d) e)
    n g h hg hgh hh hchamber hA hB hc hd he hQ hload hsum hdisc hb0 hc0 hd0 he0

set_option maxHeartbeats 3000000 in
theorem secondaryResidualIncidenceDefectPolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    omega
  have hload :=
    secondaryLoadInvariantFourPolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
...
set_option maxHeartbeats 2000000 in
theorem secondaryResidualInvariantThreePolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    omega
  have hload :=
    secondaryLoadInvariantThreePolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
      beta gamma delta epsilon zeta A B c D e n g h hg hgh hchamber
      hA hB hc hD he
  have hsplit := hi3
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroResidualDoubleFace_of_rowOneCutoff68
  ...
  exact ⟨hl,
    polynomialSecondaryResidualDoubleFace68_of_largeGapLoadZeroTransport
      ...
      (by simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g, d] using hrowOneCut)⟩

theorem maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZero_impossible_of_rowOneCutoff68
    (l alpha beta gamma delta epsilon zeta eta terminal : k)
    (A B C0 D E : k[X]) (hterminal : terminal ≠ 0)
    (hsys : IntegratedPolynomialLowerSystem68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E)
  ...
  · have hface :=
    ...
    have hQ :
      ...
      have hq :=
        secondaryResidualIncidenceDefectPolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
    ...
    have hrowTwo :
      ...
      exact h2e
    have hbalanced :=
      residualSelectedGap_eq_balanced68_of_rowTwoSystem_of_largeGapLoadZeroTransport
        alpha beta gamma delta epsilon zeta eta Ae Be ce d ee n g h
    ...
    have hrel :=
      residualRowTwo_add_load_eq_zero_imp_balancedRelation68_of_largeGapLoadZeroTransport
        Ae Be ce d ee
        (cubicLoadRowTwoPolynomial68 0 alpha beta gamma delta epsilon zeta eta
    ...
    have hI3deg :=
      secondaryResidualInvariantThreePolynomial68_degree_lt_cubicFace_of_largeGapLoadZeroTransport
    ...
    have hload1 :
        (cubicLoadRowOnePolynomial68 0 alpha beta gamma delta epsilon zeta eta
          Ae Be ce ((1 / 3 : k) • (Ae * Be) + d) ee).natDegree <
            12 * n - 3 * g - 1 := by
      simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g, d] using hrowOneCut
    exact residualRowOne_add_load_eq_zero_imp_false68_of_largeGapLoadZeroTransport
      Ae Be ce d ee
      (cubicLoadRowOnePolynomial68 0 alpha beta gamma delta epsilon zeta eta
        Ae Be ce ((1 / 3 : k) • (Ae * Be) + d) ee)
      n g h hg0 hgh hh hchamber hbalanced hA hB hcdeg hbounds.1 hbounds.2
  ...
  · have hdouble : d.natDegree ≤ 5 * n - 2 * g ∧
      ...
      constructor <;> omega
    have hface :=
      maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroResidualDoubleFace_of_rowOneCutoff68
        l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
        hterminal hsys (by
    ...
    have hn : 0 < n := by simpa only [n] using hcore.1
    exact secondaryResidualDoubleFace68_impossible_of_largeGapLoadZeroTransport n g
      (Ae.coeff (2 * n)) (Be.coeff (3 * n - g))
      (ce.coeff (4 * n - g)) (d.coeff (5 * n - 2 * g))
      (ee.coeff (6 * n - 2 * g)) ha hsupport hn hchamber hface.2


/-! ## Specialization: the original `hrow` discharges the transport cutoff -/

/-- The tracked subcritical impossible theorem is the transport applied to
the unique `hrow` cutoff
`cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_largeGapLoadZero`. -/
theorem maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroSubcritical_via_rowOneCutoff68
    (l alpha beta gamma delta epsilon zeta eta terminal : k)
    (A B C0 D E : k[X]) (hterminal : terminal ≠ 0)
    (hsys : IntegratedPolynomialLowerSystem68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E)
  ...
  have hload1 :=
    cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_largeGapLoadZero
      alpha beta gamma delta epsilon zeta eta Ae Be ce d ee n g h
      hg0 hgap.2.2.2.2.1 hchamber.1 hchamber.2.1 hchamber.2.2
      hA hB hcdeg hgap.2.2.2.2.2.1 hgap.2.2.2.2.2.2
  exact maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZero_impossible_of_rowOneCutoff68
    l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
    hterminal hsys (by
      simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g] using
        And.intro hchamber.1 hchamber.2.1)
    (by
      simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g, d] using hload1)

end LargeGapLoadZeroTransport68

#print axioms largeGapTransport_natDegree_mul_derivative_lt68
#print axioms cubicLoadRowZeroPolynomial68_degree_lt_residualDouble_of_largeGapLoadZeroTransport
#print axioms polynomialSecondaryResidualDoubleFace68_of_largeGapLoadZeroTransport
#print axioms secondaryResidualDoubleFace68_impossible_of_largeGapLoadZeroTransport
#print axioms residualSelectedGap_eq_balanced68_of_largeGapLoadZeroTransport
#print axioms residualRowOne_add_load_eq_zero_imp_false68_of_largeGapLoadZeroTransport
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroResidualDoubleFace_of_rowOneCutoff68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZero_impossible_of_rowOneCutoff68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_largeGapLoadZeroSubcritical_via_rowOneCutoff68
