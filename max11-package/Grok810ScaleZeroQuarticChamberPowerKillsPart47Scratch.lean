...
theorem quarticChamberBCDEF51810_impossible
  ...
  have hct0 := kappaQuarticChamberFace1810_coeff_top_S00 hAne hBne hCne (D := D) (E := E) (F := F) (G := G) (by omega)
  ...
  have hr1 : (xiQuarticChamberRest5810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest5810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace5810_coeff_top_S00 hAne hBne hCne hEne (D := D) (F := F) (G := G) (by omega)
