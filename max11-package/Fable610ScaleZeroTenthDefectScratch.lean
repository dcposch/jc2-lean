...
clearing of `kappaResidual610` carried out on the *atoms* rather than on the fully
substituted source polynomials.  `kappaResidual610` is weighted homogeneous, so
substituting `X_i = n_i / (d_i h^(e_i))` makes `3761479876608 * h^55 * kappaResidual610`
a polynomial in `h, n_*` — 43 monomials. -/
def speedKappaResidual610Scaled55 (h nL nA nB nC nD nE nP nQ nR nS nT nU nV nW : F) : F :=
...
theorem speedKappaResidual610Scaled55_eq (h : F) (hh : h ≠ 0) (nL nA nB nC nD nE nP nQ nR nS nT nU nV nW : F) :
    (3761479876608 : F) * h ^ 55 *
        kappaResidual610
          ...
          (nV / (186624 * h ^ 40))
          (nW / (5038848 * h ^ 45)) =
      speedKappaResidual610Scaled55 h nL nA nB nC nD nE nP nQ nR nS nT nU nV nW := by
  ...
  simp only [alphaResidual610, betaResidual610, deltaResidual610, epsilonResidual610, etaResidual610, gammaResidual610, kappaResidual610, thetaResidual610, zetaResidual610, speedKappaResidual610Scaled55]
  field_simp
  ring
...
theorem eleventhDefect_eq_clearedKappa610
  ...
  rw [hL, hA, hB, hC, hD0, hE0, hP, hQ, hR, hS, hT, hU, hV, hW,
    speedKappaResidual610Scaled55_eq h hh]
  simp only [speedKappaResidual610Scaled55]
  ring
