import FiniteDoubleSourceChartsC5
import FiniteDoubleLiftSourceC5

/-! # Source-facing double-root exclusion before `c5` -/
...
double-root source chart below the weight-four load. -/
theorem TransverseFactor.doubleRoot_source_inconsistent_of_orderBounds_before_c5
  ...
  exact T.doubleRoot_source_inconsistent_of_coordinates_before_c5
    hd hc7 r0 A0 r w d e B 0 C2 hr0 hA0 hp hr hX hw0 hxcoord
...
which exclude the double-root source coordinate before `c5`. -/
theorem TransverseFactor.doubleRoot_source_inconsistent_from_source_before_c5
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
  ...
  obtain ⟨hDfull, B, hYcoord, hQfull⟩ :=
    T.doubleRoot_deviations_order_delta_from_source_before_c5
      F hscale hd hc7 hp r r0 A0 hr0 hA0 hr hu hX hY hZ hroot
  have hpS : 3 * T.delta ≤ 4 * S.normal.sextic.scale.p := by
    rw [hscale]
    exact hp
  exact T.doubleRoot_source_inconsistent_of_orderBounds_before_c5
    hdNormal hc7Normal r0 A0 r B hr0 hA0 hpS hr hx hX hroot
      hDfull hYcoord hQfull

end GCD369CubeHahnCommonValueData

#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_source_inconsistent_of_orderBounds_before_c5
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_source_inconsistent_from_source_before_c5
