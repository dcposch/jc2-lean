...
/-! # Row-one closure below the six-radius wall in the high balanced packet -/
...
section LaterDeepLowerOpenMiddleHighBalancedRowOne68
...
theorem fiveRadiusReducedRowTwo_balanced_relation_of_delta_zero_below_seven68
  ...
  rw [fiveRadiusReducedRowTwoPolynomial68_faceSplit,
    ...
    coeff_eq_zero_of_natDegree_lt hz, coeff_zero] at hzrow
...
theorem cubicLoadVAlphaLowPolynomial68_degree_le_fourRadius_of_below_six
    (gamma epsilon eta : k) (A B c D : k[X])
    (n g : ℕ) (hn : 0 < n) (hsixBelow : 3 * g < 6 * n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g) :
    (cubicLoadVAlphaLowPolynomial68 0 gamma 0 epsilon eta
...
theorem cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_highBalanced_below_six
  ...
  rw [cubicLoadRowOnePolynomial68_eq_alphaRest 0 alpha 0 gamma 0
      epsilon zeta eta A B c D e rfl,
    cubicLoadRowOneAlphaRestPolynomial68_eq_deepGapRest']
  let Ur := cubicLoadUAlphaRestPolynomial68 0 gamma 0 zeta A B c
  let Vr := cubicLoadVAlphaRestPolynomial68 alpha 0 gamma 0 epsilon
    eta A B c D e
  let Vlow := cubicLoadVAlphaLowPolynomial68 0 gamma 0 epsilon eta
    A B c D
  let C0c := (1 / 3 : k) • A ^ 2
  let Ec := (1 / 27 : k) • A ^ 3
  let Er := (1 / 3 : k) • (A * c) + e
  ...
  have hUr : Ur.natDegree ≤ 2 * n :=
    cubicLoadUAlphaRestPolynomial68_degree_le_of_beta gamma 0 zeta
      A B c n g hgt hA hB hc
  have hVr : Vr.natDegree ≤ 6 * n - g :=
    cubicLoadVAlphaRestPolynomial68_degree_le_of_laterDeepLower_le_two
      alpha 0 gamma 0 epsilon eta A B c D e n g hn hwindow hgle
      hA hB hc hD he
  have hVlow : Vlow.natDegree ≤ 4 * n - g :=
    cubicLoadVAlphaLowPolynomial68_degree_le_fourRadius_of_below_six
      gamma epsilon eta A B c D n g hn hsixBelow hA hB hc
...
set_option maxHeartbeats 8000000 in
theorem residualRowOne_coeff_balancedChamber_of_high_below_six68
    (A B c d e : k[X]) (n g h : ℕ)
    (hn : 0 < n) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hbalanced : 2 * h = 3 * g) (hsixBelow : 3 * g < 6 * n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (hd : d.natDegree ≤ 5 * n - h)
...
theorem residualRowOne_balanced_coeff_ne_zero_of_high_below_six68
    (A B c d e : k[X]) (n g h : ℕ)
    (hn : 0 < n) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hbalanced : 2 * h = 3 * g) (hsixBelow : 3 * g < 6 * n)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowOnePolynomial68 A B c d e).coeff
        (12 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowOne_coeff_balancedChamber_of_high_below_six68
    A B c d e n g h hn hg hgh hh hbalanced hsixBelow
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighBalancedBelowSix_impossible68
  ...
  change 2 * h = 3 * g ∧ 3 * g < 6 * n at hbalanced
  have hdelta :=
  ...
  have hrelation :=
    fiveRadiusReducedRowTwo_balanced_relation_of_delta_zero_below_seven68
      ...
      hmiddle hopen hbalanced.1 (by omega) hA hB hc hd he
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighBalancedBelowSeven_forces_six68
    (l alpha beta gamma delta epsilon zeta eta terminal : k)
    (A B C0 D E : k[X]) (hterminal : terminal ≠ 0)
    (hsys : IntegratedPolynomialLowerSystem68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E)
  ...
  exact maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighBalancedBelowSix_impossible68
    l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
    hterminal hsys hopen hmiddle hhigh (by
      simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g, d, h] using
        And.intro hbalanced.1 hsix)

#print axioms fiveRadiusReducedRowTwo_balanced_relation_of_delta_zero_below_seven68
#print axioms cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_highBalanced_below_six
#print axioms residualRowOne_coeff_balancedChamber_of_high_below_six68
#print axioms residualRowOne_balanced_coeff_ne_zero_of_high_below_six68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighBalancedBelowSix_impossible68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighBalancedBelowSeven_forces_six68

end LaterDeepLowerOpenMiddleHighBalancedRowOne68
