...
set_option maxHeartbeats 64000000 in
/-- Reusable arithmetic implication for one cost chamber. -/
private theorem astra4zExhaustTailBCDEFG112
    (a b c d e f g : ℕ)
    (hApos : 0 < a) (hAB : 2 * b < 3 * a) (hAC : c < 2 * a) (hAD : 2 * d < 5 * a) (hAE : e < 3 * a) (hAF : 2 * f < 7 * a) (hAG : g < 4 * a)
    (hs : 4 * d = a + 6 * b ∧
      b + f < 2 * d ∧
...
set_option maxHeartbeats 64000000 in
/-- Reusable arithmetic implication for one cost chamber. -/
private theorem astra4zExhaustTailBCDEFG119
    (a b c d e f g : ℕ)
    (hApos : 0 < a) (hAB : 2 * b < 3 * a) (hAC : c < 2 * a) (hAD : 2 * d < 5 * a) (hAE : e < 3 * a) (hAF : 2 * f < 7 * a) (hAG : g < 4 * a)
    (hs : a + 2 * d = 2 * e ∧
      4 * d = a + 6 * b ∧
...
set_option maxHeartbeats 64000000 in
/-- Reusable arithmetic implication for one cost chamber. -/
private theorem astra4zExhaustTailBCDEFG27
    (a b c d e f g : ℕ)
    (hApos : 0 < a) (hAB : 2 * b < 3 * a) (hAC : c < 2 * a) (hAD : 2 * d < 5 * a) (hAE : e < 3 * a) (hAF : 2 * f < 7 * a) (hAG : g < 4 * a)
    (hs : 5 * a + 2 * b = 2 * g ∧
      3 * a + b + f = 2 * g ∧
...
set_option maxHeartbeats 64000000 in
/-- Reusable arithmetic implication for one cost chamber. -/
private theorem astra4zExhaustTailBCDEFG49
    (a b c d e f g : ℕ)
    (hApos : 0 < a) (hAB : 2 * b < 3 * a) (hAC : c < 2 * a) (hAD : 2 * d < 5 * a) (hAE : e < 3 * a) (hAF : 2 * f < 7 * a) (hAG : g < 4 * a)
    (hs : 2 * a + b = f ∧
      2 * c < a + 2 * b ∧
...
set_option maxHeartbeats 64000000 in
/-- Reusable arithmetic implication for one cost chamber. -/
private theorem astra4zExhaustTailBCDEFG73
    (a b c d e f g : ℕ)
    (hApos : 0 < a) (hAB : 2 * b < 3 * a) (hAC : c < 2 * a) (hAD : 2 * d < 5 * a) (hAE : e < 3 * a) (hAF : 2 * f < 7 * a) (hAG : g < 4 * a)
    (hs : 5 * a + 2 * b = 2 * g ∧
      2 * c < a + 2 * b ∧
...
private theorem chamberExhaustBCDEFGPath000
  ...
  · -- F.natDegree < A.natDegree + D.natDegree
    ...
    · -- D.natDegree < A.natDegree + B.natDegree
      ...
      · -- B.natDegree + F.natDegree < 2 * D.natDegree
        ...
        · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG112 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG112 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
  ...
  · -- F.natDegree > A.natDegree + D.natDegree
    ...
    · -- D.natDegree < A.natDegree + B.natDegree
      ...
      · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG49 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG49 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
...
set_option maxHeartbeats 64000000 in
/-- Cost-argmin subtree on the three comparison branches `001`. -/
private theorem chamberExhaustBCDEFGPath001
    (A B C D E F G : k[X])
    (hA : QuarticRatioConeA810 A B C D E F G)
    (hBne : B ≠ 0) (hCne : C ≠ 0) (hDne : D ≠ 0) (hEne : E ≠ 0) (hFne : F ≠ 0) (hGne : G ≠ 0)
    (ht0a : (2 * C.natDegree) < (A.natDegree + 2 * B.natDegree))
  ...
  · -- F.natDegree > A.natDegree + D.natDegree
    ...
    · -- D.natDegree < A.natDegree + B.natDegree
      ...
      · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG27 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG27 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
      · -- 2 * A.natDegree + B.natDegree > F.natDegree
        rcases lt_trichotomy (A.natDegree + 4 * B.natDegree) (2 * F.natDegree) with ht6a | ht6b | ht6c
        · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG4 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG4 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
        · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG5 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG5 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
...
set_option maxHeartbeats 64000000 in
/-- Cost-argmin subtree on the three comparison branches `002`. -/
private theorem chamberExhaustBCDEFGPath002
    (A B C D E F G : k[X])
    (hA : QuarticRatioConeA810 A B C D E F G)
    (hBne : B ≠ 0) (hCne : C ≠ 0) (hDne : D ≠ 0) (hEne : E ≠ 0) (hFne : F ≠ 0) (hGne : G ≠ 0)
    (ht0a : (2 * C.natDegree) < (A.natDegree + 2 * B.natDegree))
  ...
  · -- 2 * G.natDegree > 3 * A.natDegree + 2 * D.natDegree
    ...
    · -- D.natDegree < A.natDegree + B.natDegree
      ...
      · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG73 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG73 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
...
set_option maxHeartbeats 64000000 in
/-- Cost-argmin subtree on the three comparison branches `010`. -/
private theorem chamberExhaustBCDEFGPath010
    (A B C D E F G : k[X])
    (hA : QuarticRatioConeA810 A B C D E F G)
    (hBne : B ≠ 0) (hCne : C ≠ 0) (hDne : D ≠ 0) (hEne : E ≠ 0) (hFne : F ≠ 0) (hGne : G ≠ 0)
    (ht0a : (2 * C.natDegree) < (A.natDegree + 2 * B.natDegree))
  ...
  · -- F.natDegree < A.natDegree + D.natDegree
    ...
    · -- D.natDegree < A.natDegree + B.natDegree
      ...
      · -- B.natDegree + F.natDegree < 2 * D.natDegree
        ...
        · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG119 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG119 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
        · exact QuarticChamberSupport810.size6 (QuarticChamberSupportSize6810.cBCDEFG0 ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, astra4zExhaustTailBCDEFG0 A.natDegree B.natDegree C.natDegree D.natDegree E.natDegree F.natDegree G.natDegree hApos hAB hAC hAD hAE hAF hAG (by omega)⟩)
      · -- B.natDegree + F.natDegree = 2 * D.natDegree
        rcases lt_trichotomy (A.natDegree + 6 * B.natDegree) (4 * D.natDegree) with ht6a | ht6b | ht6c
...
set_option maxHeartbeats 64000000 in
/-- Cost-argmin subtree on the three comparison branches `011`. -/
private theorem chamberExhaustBCDEFGPath011
    (A B C D E F G : k[X])
    (hA : QuarticRatioConeA810 A B C D E F G)
    (hBne : B ≠ 0) (hCne : C ≠ 0) (hDne : D ≠ 0) (hEne : E ≠ 0) (hFne : F ≠ 0) (hGne : G ≠ 0)
    (ht0a : (2 * C.natDegree) < (A.natDegree + 2 * B.natDegree))
...
set_option maxHeartbeats 64000000 in
/-- Cost-argmin subtree on the three comparison branches `012`. -/
private theorem chamberExhaustBCDEFGPath012
    (A B C D E F G : k[X])
    (hA : QuarticRatioConeA810 A B C D E F G)
    (hBne : B ≠ 0) (hCne : C ≠ 0) (hDne : D ≠ 0) (hEne : E ≠ 0) (hFne : F ≠ 0) (hGne : G ≠ 0)
    (ht0a : (2 * C.natDegree) < (A.natDegree + 2 * B.natDegree))
