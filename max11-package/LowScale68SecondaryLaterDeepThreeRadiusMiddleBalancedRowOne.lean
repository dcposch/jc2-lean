import LowScale68SecondaryLaterDeepThreeRadiusMiddleBalanced

/-! # Row-one closure of the balanced attained middle face on `2g = 3n` -/
...
section LaterDeepThreeRadiusMiddleBalancedRowOne68
...
/-! ## Endpoint load bounds -/

set_option maxHeartbeats 2000000 in
theorem secondaryLoadInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
...
set_option maxHeartbeats 2000000 in
theorem secondaryResidualInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
  ...
  have hload :=
    secondaryLoadInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
...
set_option maxHeartbeats 2000000 in
theorem cubicLoadVAlphaLowPolynomial68_degree_le_fourRadius_of_threeRadius_beta
...
theorem cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_threeRadius_beta
  ...
  have hVlow : Vlow.natDegree ≤ 4 * n - g :=
    cubicLoadVAlphaLowPolynomial68_degree_le_fourRadius_of_threeRadius_beta
...
/-! ## Endpoint residual coefficient -/

set_option maxHeartbeats 8000000 in
theorem residualRowOne_coeff_balancedChamber_of_threeRadius
...
theorem residualRowOne_coeff_balancedChamber_eq_of_threeRadius
    (A B c d e : k[X]) (n g h : ℕ)
    (hn : 0 < n) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = 3 * n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  rw [residualRowOne_coeff_balancedChamber_of_threeRadius A B c d e n g h
...
theorem residualRowOne_balanced_coeff_ne_zero_of_threeRadius
    (A B c d e : k[X]) (n g h : ℕ)
    (hn : 0 < n) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = 3 * n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowOnePolynomial68 A B c d e).coeff
        (12 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowOne_coeff_balancedChamber_eq_of_threeRadius A B c d e n g h
    hn hg hgh hh hwall hbalanced hA hB hcdeg hd he hI3 hc0 hdisc hinc hface2]
  exact mul_ne_zero
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_laterDeepThreeRadiusMiddleBalanced_impossible68
  ...
  have packet :=
    maximalExpandedIntegratedPolynomialLowerSystem_laterDeepThreeRadiusMiddleBalancedRowTwo68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
      hterminal hsys (by
        simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g] using hwall)
      (by simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g, d, h] using hbalanced)
  ...
  change l = 0 ∧ beta = 0 ∧ g < h ∧
      d.natDegree ≤ 5 * n - h ∧ ee.natDegree ≤ 6 * n - h ∧ _ at selector
  have hn : 0 < n := by simpa only [n] using core.1
  have hg : 0 < g := secondary.1
  have hgh : g < h := selector.2.2.1
  ...
  rw [hCrec, hErec, firstIntegralThreePolynomial68_cubicCoordinates,
    hDrec, selector.1, selector.2.1] at hi3c
  have hI3 :=
    secondaryResidualInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
      gamma delta epsilon zeta i3 Ae Be ce d ee n g hn hwall hA hB hc
  ...
  rw [coeff_add, coeff_zero, coeff_eq_zero_of_natDegree_lt hload, add_zero]
    at hcoeff
  exact residualRowOne_balanced_coeff_ne_zero_of_threeRadius
    Ae Be ce d ee n g h hn hg hgh hh hwall hbalanced hA hB hc hd he hI3
    packet.2.1 packet.2.2.2.2.2.1 packet.2.2.2.2.1.four
    packet.2.2.2.2.2.2 hcoeff

#print axioms secondaryLoadInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
#print axioms secondaryResidualInvariantThreePolynomial68_degree_le_sixRadius_of_threeRadius_beta
#print axioms cubicLoadVAlphaLowPolynomial68_degree_le_fourRadius_of_threeRadius_beta
#print axioms cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_threeRadius_beta
#print axioms residualRowOne_coeff_balancedChamber_of_threeRadius
#print axioms residualRowOne_coeff_balancedChamber_eq_of_threeRadius
#print axioms residualRowOne_balanced_coeff_ne_zero_of_threeRadius
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_laterDeepThreeRadiusMiddleBalanced_impossible68

end LaterDeepThreeRadiusMiddleBalancedRowOne68
