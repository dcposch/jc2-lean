...
theorem quarticChamberBCDEF46810_impossible
  ...
  have hct0 := kappaQuarticChamberFace8810_coeff_top_S06 hAne hBne hCne hDne hEne (F := F) (G := G) (by omega) (by omega)
  ...
  have hct1 := muQuarticChamberFace13810_coeff_top_S06 hAne hBne hCne hDne hEne (F := F) (G := G) (by omega) (by omega) (by omega)
  ...
  have hr2 : (xiQuarticChamberRest13810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest13810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := xiQuarticChamberFace13810_coeff_top_S06 hAne hBne hCne hDne hEne (F := F) (G := G) (by omega) (by omega)
  ...
  have hct3 := piQuarticChamberFace6810_coeff_top_S06 hAne hBne hCne hDne hEne (F := F) (G := G) (by omega) (by omega) (by omega) (by omega) (by omega)
