...
theorem quarticChamberBCDG5810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest9810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest9810_natDegree_lt_of_live_BCDG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hEz hFz (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) hz0zeta (Or.inr (by omega)) hz0theta
  have hct0 := kappaQuarticChamberFace9810_coeff_top_S08 hAne hBne hCne hGne (D := D) (E := E) (F := F) (by omega) (by omega)
  ...
  have hr1 : (muQuarticChamberRest10810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest10810_natDegree_lt_of_live_BCDG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hEz hFz (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := muQuarticChamberFace10810_coeff_top_S08 hAne hBne hCne hGne (D := D) (E := E) (F := F) (by omega) (by omega)
  ...
  have hr2 : (piQuarticChamberRest8810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest8810_natDegree_lt_of_live_BCDG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hEz hFz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace8810_coeff_top_S08 hAne hBne hCne hGne (D := D) (E := E) (F := F) (by omega) (by omega) (by omega) (by omega) (by omega)
