...
theorem quarticChamberBCDEG13810_impossible
  ...
  have hct0 := kappaQuarticChamberFace9810_coeff_top_S11 hAne hBne hCne hGne (D := D) (E := E) (F := F) (by omega) (by omega)
  ...
  have hr1 : (xiQuarticChamberRest16810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest16810_natDegree_lt_of_live_BCDEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hFz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace16810_coeff_top_S11 hAne hBne hCne hEne hGne (D := D) (F := F) (by omega) (by omega)
