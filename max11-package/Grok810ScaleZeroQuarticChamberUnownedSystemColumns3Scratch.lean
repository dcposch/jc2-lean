...
theorem omicronQuarticColumnL1810_natDegree_lt_of_live_BFG
  ...
  have hpow7 : (0 : k[X]) ^ 7 = 0 := zero_pow (by decide)
  have hpow8 : (0 : k[X]) ^ 8 = 0 := zero_pow (by decide)
  simp only [omicronQuarticColumnL1810, hpow2, hpow3, hpow4, hpow5, hpow6, hpow7, hpow8, zero_mul, mul_zero, zero_smul, smul_zero, add_zero, zero_add, sub_zero, zero_sub, neg_zero, natDegree_zero]
  compute_degree
  omega
...
theorem primitiveQuarticColumnL1810_natDegree_lt_of_live_BFG
  ...
  have hpow7 : (0 : k[X]) ^ 7 = 0 := zero_pow (by decide)
  have hpow8 : (0 : k[X]) ^ 8 = 0 := zero_pow (by decide)
  simp only [primitiveQuarticColumnL1810, hpow2, hpow3, hpow4, hpow5, hpow6, hpow7, hpow8, zero_mul, mul_zero, zero_smul, smul_zero, add_zero, zero_add, sub_zero, zero_sub, neg_zero, natDegree_zero]
  compute_degree
  omega
...
theorem n4QuarticColumnL1810PartCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnL1810PartCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnL1810PartCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnL1810PartCDG2810]
  compute_degree
  omega
...
theorem n3QuarticColumnL1810PartBCDG1810_natDegree_lt
  ...
  simp only [n3QuarticColumnL1810PartBCDG1810]
  compute_degree
  omega
...
theorem n3QuarticColumnL1810PartBCDG2810_natDegree_lt
  ...
  simp only [n3QuarticColumnL1810PartBCDG2810]
  compute_degree
  omega
...
theorem n3QuarticColumnL1810PartBCDG3810_natDegree_lt
  ...
  simp only [n3QuarticColumnL1810PartBCDG3810]
  compute_degree
  omega
...
theorem n3QuarticColumnBeta810PartBCDG1810_natDegree_lt
  ...
  simp only [n3QuarticColumnBeta810PartBCDG1810]
  compute_degree
  omega
...
theorem n3QuarticColumnBeta810PartBCDG2810_natDegree_lt
  ...
  simp only [n3QuarticColumnBeta810PartBCDG2810]
  compute_degree
  omega
...
theorem n3QuarticColumnDelta810PartBCDG1810_natDegree_lt
  ...
  simp only [n3QuarticColumnDelta810PartBCDG1810]
  compute_degree
  omega
...
theorem n3QuarticColumnDelta810PartBCDG2810_natDegree_lt
  ...
  simp only [n3QuarticColumnDelta810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnL1810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnL1810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnL1810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnL1810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnL1810PartBCDG3810_natDegree_lt
  ...
  simp only [n4QuarticColumnL1810PartBCDG3810]
  compute_degree
  omega
...
theorem n4QuarticColumnL2810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnL2810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnL2810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnL2810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnBeta1810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnBeta1810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnBeta1810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnBeta1810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnGamma810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnGamma810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnGamma810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnGamma810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnDelta810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnDelta810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnDelta810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnDelta810PartBCDG2810]
  compute_degree
  omega
...
theorem n4QuarticColumnZeta810PartBCDG1810_natDegree_lt
  ...
  simp only [n4QuarticColumnZeta810PartBCDG1810]
  compute_degree
  omega
...
theorem n4QuarticColumnZeta810PartBCDG2810_natDegree_lt
  ...
  simp only [n4QuarticColumnZeta810PartBCDG2810]
  compute_degree
  omega
...
theorem nuQuarticColumnL810PartBCFG1810_natDegree_lt
  ...
  simp only [nuQuarticColumnL810PartBCFG1810]
  compute_degree
  omega
...
theorem nuQuarticColumnL810PartBCFG2810_natDegree_lt
  ...
  simp only [nuQuarticColumnL810PartBCFG2810]
  compute_degree
  omega
