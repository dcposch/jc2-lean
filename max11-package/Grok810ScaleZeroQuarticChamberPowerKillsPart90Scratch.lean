...
theorem quarticChamberBCDEF33810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest14810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest14810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hGz (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) hz0zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := kappaQuarticChamberFace14810_coeff_top_S15 hCne hDne hEne hFne (A := A) (B := B) (G := G) (by omega)
  ...
  have hr1 : (muQuarticChamberRest18810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest18810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := muQuarticChamberFace18810_coeff_top_S15 hAne hCne hDne hEne (B := B) (F := F) (G := G) (by omega) (by omega)
  ...
  have hr2 : (xiQuarticChamberRest20810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest20810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := xiQuarticChamberFace20810_coeff_top_S15 hAne hCne hDne hEne hFne (B := B) (G := G) (by omega)
  ...
  have hr3 : (piQuarticChamberRest12810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest12810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp3 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct3 := piQuarticChamberFace12810_coeff_top_S15 hAne hCne hDne hEne hFne (B := B) (G := G) (by omega) (by omega) (by omega)
