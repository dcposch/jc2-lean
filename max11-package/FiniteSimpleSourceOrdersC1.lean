...
/-! # Pre-resonant orders in the simple-root source chart before `c1`

After the weight-one, weight-two, weight-four, and weight-five loads have
vanished, the same pre-resonant split applies once `3 * delta < 8 * p`.
...
or, once the weight-six and weight-seven loads also vanish, the reduced
ninth-Faber equation has a unique leading cubic term below the weight-eight
load.
-/
...
`6 * p` when `3 * delta < 8 * p`. -/
theorem TransverseFactor.sourceSextic_inconsistent_of_transverse_below_twiceDelta_before_c1
...
already below the weight-eight load. -/
theorem TransverseFactor.simpleRoot_sourceBelow_inconsistent_of_normal_lower_before_c1
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
...
weight-eight load. -/
theorem TransverseFactor.simpleRoot_sourceBelow_inconsistent_of_normal_exact_before_c1
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
    (hd : S.normal.d = 0) (hc7 : S.normal.c7 = 0)
    (hc5 : S.normal.c5 = 0) (hc4 : S.normal.c4 = 0)
  ...
  exact T.reducedFaberNine_inconsistent_of_exact_cubic_order_before_c1
    hd hc7 hc5 hc4 hc3 hc2 alpha gamma (c * (9 * r0 ^ 2)) halpha
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.sourceSextic_inconsistent_of_transverse_below_twiceDelta_before_c1
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_sourceBelow_inconsistent_of_normal_lower_before_c1
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_sourceBelow_inconsistent_of_normal_exact_before_c1
