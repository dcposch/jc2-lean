...
theorem nuQuarticColumnL810_live_NuFacesc1_natDegree_lt
  ...
  simp only [nuQuarticColumnL810_live_NuFacesc1]
  compute_degree
  omega
...
theorem nuQuarticColumnL810_live_NuFacesc2_natDegree_lt
  ...
  simp only [nuQuarticColumnL810_live_NuFacesc2]
  compute_degree
  omega
...
theorem nuQuarticColumnL810_live_NuFacesc3_natDegree_lt
  ...
  simp only [nuQuarticColumnL810_live_NuFacesc3]
  compute_degree
  omega
...
theorem nuQuarticColumnBeta810_live_NuFacesc1_natDegree_lt
  ...
  simp only [nuQuarticColumnBeta810_live_NuFacesc1]
  compute_degree
  omega
...
theorem nuQuarticColumnBeta810_live_NuFacesc2_natDegree_lt
  ...
  simp only [nuQuarticColumnBeta810_live_NuFacesc2]
  compute_degree
  omega
...
theorem nuQuarticColumnGamma810_natDegree_lt
  ...
  simp only [nuQuarticColumnGamma810]
  compute_degree
  omega
...
theorem nuQuarticColumnDelta810_natDegree_lt
  ...
  simp only [nuQuarticColumnDelta810]
  compute_degree
  omega
...
theorem nuQuarticColumnEpsilon810_natDegree_lt
  ...
  simp only [nuQuarticColumnEpsilon810]
  compute_degree
  omega
...
theorem nuQuarticColumnZeta810_natDegree_lt
  ...
  simp only [nuQuarticColumnZeta810]
  compute_degree
  omega
...
theorem nuQuarticColumnEta810_natDegree_lt
  ...
  simp only [nuQuarticColumnEta810]
  compute_degree
  omega
...
theorem nuQuarticColumnTheta810_natDegree_lt
  ...
  simp only [nuQuarticColumnTheta810]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_natDegree_lt_of_live_BDFG
  ...
  have hpow7 : (0 : k[X]) ^ 7 = 0 := zero_pow (by decide)
  have hpow8 : (0 : k[X]) ^ 8 = 0 := zero_pow (by decide)
  simp only [nuQuarticChamberRestLF1000810, hpow2, hpow3, hpow4, hpow5, hpow6, hpow7, hpow8, zero_mul, mul_zero, zero_smul, smul_zero, add_zero, zero_add, sub_zero, zero_sub, neg_zero, natDegree_zero]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBCDFG_NuFacesc1_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBCDFG_NuFacesc1]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBCDFG_NuFacesc2_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBCDFG_NuFacesc2]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBDEFG_NuFacesc1_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBDEFG_NuFacesc1]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBDEFG_NuFacesc2_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBDEFG_NuFacesc2]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBCDEFG_NuFacesc1_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBCDEFG_NuFacesc1]
  compute_degree
  omega
...
theorem nuQuarticChamberRestLF1000810_liveBCDEFG_NuFacesc2_natDegree_lt
  ...
  simp only [nuQuarticChamberRestLF1000810_liveBCDEFG_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDF_NuFacesc1_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDF_NuFacesc1]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDF_NuFacesc2_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDF_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_natDegree_lt_of_live_BCEF
  ...
  have hpow7 : (0 : k[X]) ^ 7 = 0 := zero_pow (by decide)
  have hpow8 : (0 : k[X]) ^ 8 = 0 := zero_pow (by decide)
  simp only [piQuarticChamberRestLF2000810, hpow2, hpow3, hpow4, hpow5, hpow6, hpow7, hpow8, zero_mul, mul_zero, zero_smul, smul_zero, add_zero, zero_add, sub_zero, zero_sub, neg_zero, natDegree_zero]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDEF_NuFacesc1_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDEF_NuFacesc1]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDEF_NuFacesc2_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDEF_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDFG_NuFacesc1_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDFG_NuFacesc1]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDFG_NuFacesc2_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDFG_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCEFG_NuFacesc1_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCEFG_NuFacesc1]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCEFG_NuFacesc2_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCEFG_NuFacesc2]
  compute_degree
  omega
...
theorem muQuarticChamberRestLF9810_liveBCDEFG_NuFacesc1_natDegree_lt
  ...
  simp only [muQuarticChamberRestLF9810_liveBCDEFG_NuFacesc1]
  compute_degree
  omega
...
theorem muQuarticChamberRestLF9810_liveBCDEFG_NuFacesc2_natDegree_lt
  ...
  simp only [muQuarticChamberRestLF9810_liveBCDEFG_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc1_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc1]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc2_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc2]
  compute_degree
  omega
...
theorem piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc3_natDegree_lt
  ...
  simp only [piQuarticChamberRestLF2000810_liveBCDEFG_NuFacesc3]
  compute_degree
  omega
