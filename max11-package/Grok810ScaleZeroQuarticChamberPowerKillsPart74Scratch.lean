...
theorem quarticChamberBCDEF13810_impossible
  ...
  have hct0 := kappaQuarticChamberFace6810_coeff_top_S10 hAne hBne hCne hFne (D := D) (E := E) (G := G) (by omega) (by omega)
  ...
  have hct1 := muQuarticChamberFace15810_coeff_top_S10 hAne hBne hCne hEne hFne (D := D) (G := G) (by omega) (by omega) (by omega)
  ...
  have hct2 := xiQuarticChamberFace5810_coeff_top_S10 hAne hBne hCne hEne (D := D) (F := F) (G := G) (by omega)
