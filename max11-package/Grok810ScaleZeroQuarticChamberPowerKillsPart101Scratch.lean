...
theorem quarticChamberBCDEFG82810_impossible
  ...
  have hr0 : (muQuarticChamberRest21810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest21810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := muQuarticChamberFace21810_coeff_top_S22 hAne hCne hDne hEne hGne (B := B) (F := F) (by omega) (by omega)
  ...
  have hct1 := xiQuarticChamberFace22810_coeff_top_S22 hAne hDne hEne hFne hGne (B := B) (C := C) (by omega)
  ...
  have hr2 : (piQuarticChamberRest14810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest14810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace14810_coeff_top_S22 hAne hFne hGne (B := B) (C := C) (D := D) (E := E) (by omega)
