...
/-! # Closure for the zeta-zero strict-high interior -/
...
section LaterDeepLowerOpenMiddleHighZetaZeroEndgame68
...
theorem fiveRadiusReducedRowTwo_leftDE_impossible_of_delta_zeta_zero68
    ...
    (hrow : fiveRadiusReducedRowTwoPolynomial68
      gamma epsilon 0 i4 A B c d e = 0) : False := by
  let idx := 11 * n - 2 * h - 1
  ...
  rw [fiveRadiusReducedRowTwoPolynomial68_faceSplit,
    ...
    coeff_zero] at hzrow
  simp only [zero_smul, coeff_zero, zero_add, add_zero] at hzrow
  exact hdeNe hzrow

set_option maxHeartbeats 5000000 in
theorem fiveRadiusReducedRowTwo_rightFixed_impossible_of_delta_zeta_zero68
    (gamma epsilon i4 : k) (A B c d e : k[X])
    (n g h : ℕ) (hn : 0 < n) (hg : 0 < g) (hgh : g < h)
    (hh : h < 2 * g)
    (hopen : 3 * n < 2 * g ∧ 2 * g < 5 * n)
...
theorem fiveRadiusReducedRowTwo_balanced_relation_of_delta_zeta_zero68
    (gamma epsilon i4 : k) (A B c d e : k[X])
    (n g h : ℕ) (hn : 0 < n) (hg : 0 < g) (hgh : g < h)
    (hh : h < 2 * g)
    (hopen : 3 * n < 2 * g ∧ 2 * g < 5 * n)
  ...
  have hface : 11 * n - 2 * h - 1 = idx := by dsimp [idx]; omega
  ...
  have hzrow := congrArg (fun p : k[X] => p.coeff idx) hrow
  rw [fiveRadiusReducedRowTwoPolynomial68_faceSplit,
    coeff_add, coeff_add, coeff_add, hfixed, hde,
    coeff_eq_zero_of_natDegree_lt htail, coeff_zero] at hzrow
  simp only [zero_smul, coeff_zero, add_zero] at hzrow
...
theorem secondaryResidualInvariantThreePolynomial68_degree_le_six_sub_h_of_balanced_zeta_zero
    (gamma epsilon i3 : k) (A B c d e : k[X])
    (n g h : ℕ) (hn : 0 < n) (hgh : g < h) (hh : h < 2 * g)
    (hopen : 3 * n < 2 * g ∧ 2 * g < 5 * n)
    (hbalanced : 2 * h = 3 * g) (height : 3 * g < 8 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (he : e.natDegree ≤ 6 * n - h)
  ...
  have hload : (secondaryLoadInvariantThreePolynomial68
      0 0 gamma 0 epsilon 0 A B c D e).natDegree ≤ 6 * n - h := by
...
theorem residualRowOne_coeff_balancedChamber_of_high_zeta_zero68
...
theorem residualRowOne_balanced_coeff_ne_zero_of_high_zeta_zero68
    (A B c d e : k[X]) (n g h : ℕ)
    (hn : 0 < n) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hbalanced : 2 * h = 3 * g) (height : 3 * g < 8 * n)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowOnePolynomial68 A B c d e).coeff
        (12 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowOne_coeff_balancedChamber_of_high_zeta_zero68
    A B c d e n g h hn hg hgh hh hbalanced height hA hB hcdeg hd he hI3]
...
set_option maxHeartbeats 3000000 in
theorem cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_balanced_zeta_zero
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighAboveSevenZetaZero_impossible68
  ...
  change 7 * n < 2 * h ∧ 7 * n < 3 * g at hhigh
  ...
  · exact fiveRadiusReducedRowTwo_rightFixed_impossible_of_delta_zeta_zero68
      gamma epsilon i4 Ae Be ce d ee n g h hn hg ordinary.2.2.1 hmiddle
      hopen hright ha ordinary.2.2.2.2.2.1 hA hB hc hd he
      ordinary.2.2.2.2.2.2.2.2.2 hred

#print axioms fiveRadiusReducedRowTwo_leftDE_impossible_of_delta_zeta_zero68
#print axioms fiveRadiusReducedRowTwo_rightFixed_impossible_of_delta_zeta_zero68
#print axioms fiveRadiusReducedRowTwo_balanced_relation_of_delta_zeta_zero68
#print axioms secondaryResidualInvariantThreePolynomial68_degree_le_six_sub_h_of_balanced_zeta_zero
#print axioms cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_balanced_zeta_zero
#print axioms residualRowOne_balanced_coeff_ne_zero_of_high_zeta_zero68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleHighAboveSevenZetaZero_impossible68

end LaterDeepLowerOpenMiddleHighZetaZeroEndgame68
