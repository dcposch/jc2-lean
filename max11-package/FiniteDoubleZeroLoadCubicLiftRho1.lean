import FiniteDoubleZeroLoadCubic

/-! # Lifted zero-load obstruction before `rho1`
...
strictly before the weight-ten load, with no source-root case split.
-/
...
strictly below the `rho1` cutoff. -/
theorem TransverseFactor.doubleRoot_inconsistent_before_rho1
  ...
  obtain ⟨hDfull, B, hYcoord, hQfull⟩ :=
    T.doubleRoot_deviations_order_delta_from_source_before_rho1
      F hscale hd hc7 hc5 hc4 hc3 hc2 hc1 (le_of_lt hp) r r0 A0 hr0 hA0 hr hu hX hY hZ
        hroot
  ...
  exact T.doubleRoot_zeroLoad_balanced_cubic_inconsistent_before_rho1
    F hscale hd hc7 hc5 hc4 hc3 hc2 hc1 hp r d B q r0 A0 hr0 hA0 hr hX hY
      hroot hDcoord hBcoord hCcoord

end GCD369CubeHahnCommonValueData

#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_inconsistent_before_rho1
