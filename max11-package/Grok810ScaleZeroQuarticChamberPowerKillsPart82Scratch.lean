...
theorem quarticChamberBCDEF20810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest12810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest12810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hGz (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) hz0zeta (Or.inr (by omega)) hz0theta
  have hct0 := kappaQuarticChamberFace12810_coeff_top_S13 hAne hBne hDne hEne (C := C) (F := F) (G := G) (by omega)
  ...
  have hct1 := muQuarticChamberFace17810_coeff_top_S13 hAne hBne hDne hEne hFne (C := C) (G := G) (by omega) (by omega)
  ...
  have hct2 := xiQuarticChamberFace18810_coeff_top_S13 hAne hBne hDne hEne hFne (C := C) (G := G) (by omega)
  ...
  have hr3 : (piQuarticChamberRest10810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest10810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp3 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct3 := piQuarticChamberFace10810_coeff_top_S13 hAne hBne hDne hEne hFne (C := C) (G := G) (by omega) (by omega)
