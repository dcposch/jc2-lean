import Sol68FiveToSixCuspLoadedLowerRowZetaFirstUniformJetEndpointB3EqualityEpsilonSupportQZeroLoadThirdSourcePart01Scratch
...
theorem fiveToSix_zetaFirst_B3_equality_support_qZero_rowZero_load_third68
  ...
  have hRdeg:R.natDegree≤p-1:=by
    ...
    repeat'
      ...
      | with_reducible exact leaf68_bd_of_le hQdeg
      | with_reducible exact leaf68_bd_of_le hRdeg
  ...
  have hTdeg:T.natDegree≤p-1:=by
    ...
    repeat'
      ...
      | with_reducible exact leaf68_bd_of_le hQdeg
      | with_reducible exact leaf68_bd_of_le hRdeg
      | with_reducible exact leaf68_bd_of_le hTdeg
      | exact leaf68_bd_of_le (by assumption)
      | with_reducible apply leaf68_bd_smul
      | with_reducible apply leaf68_bd_neg
      | with_reducible apply leaf68_bd_sub
