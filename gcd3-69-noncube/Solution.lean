import SolutionSpeedTPart00Scratch
...
theorem GCD369AlignedKellerRow4 {K : Type*} [Field K] [CharZero K] [Differential K]
  ...
  norm_num only [Finset.sum_range_succ, Finset.sum_range_zero,
    ...
    nsmul_eq_mul, coeff_C, coeff_C_mul, coeff_mul_C,
    coeff_mul_X_pow', coeff_X, coeff_X_pow,
    hkappa, div_eq_mul_inv, Derivation.leibniz,
    Derivation.leibniz_inv, Derivation.leibniz_div, Derivation.leibniz_pow, hOfNat] at h4
  norm_num at h4
  linear_combination 128 * h4
...
theorem GCD369AlignedKellerRow3 {K : Type*} [Field K] [CharZero K] [Differential K]
  ...
  norm_num only [Finset.sum_range_succ, Finset.sum_range_zero,
    ...
    coeff_mul_X_pow', coeff_X, coeff_X_pow,
    hkappa, div_eq_mul_inv, Derivation.leibniz,
    Derivation.leibniz_inv, Derivation.leibniz_div, Derivation.leibniz_pow, hOfNat] at h3
  norm_num at h3
  linear_combination 128 * h3
...
theorem GCD369AlignedKellerRow2 {K : Type*} [Field K] [CharZero K] [Differential K]
  ...
  norm_num only [Finset.sum_range_succ, Finset.sum_range_zero,
    ...
    coeff_mul_X_pow', coeff_X, coeff_X_pow,
    hkappa, div_eq_mul_inv, Derivation.leibniz,
    Derivation.leibniz_inv, Derivation.leibniz_div, Derivation.leibniz_pow, hOfNat] at h2
  norm_num at h2
  linear_combination 128 * h2
...
theorem GCD369AlignedKellerRow1 {K : Type*} [Field K] [CharZero K] [Differential K]
  ...
  norm_num only [Finset.sum_range_succ, Finset.sum_range_zero,
    ...
    coeff_mul_X_pow', coeff_X, coeff_X_pow,
    hkappa, div_eq_mul_inv, Derivation.leibniz,
    Derivation.leibniz_inv, Derivation.leibniz_div, Derivation.leibniz_pow, hOfNat] at h1
  norm_num at h1
  linear_combination 128 * h1
...
#print axioms GCD369RatFuncDerivative
#print axioms GCD369RatFuncConstants
...
#print axioms GCD369PolynomialNoncubeDifferentialKummerPackage
