...
- **2026-08-26** · [PALOMAR-2026-08-25-000002 v2](https://palomar-registry.org/entry.html?id=PALOMAR-2026-08-25-000002&version=2):
  [`gcd3-69-noncube/`](gcd3-69-noncube/), the two-sheet lower-Pfaffian
  reduction plus the finite-place, one-point-support, and shifted
  Davenport--Stothers noncube exclusions at partial degrees `(6,9)`
