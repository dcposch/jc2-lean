import FiniteSimpleSourceStrictFromSourceC2

/-! # Simple-source coordinates at the balanced `c2` resonance
...
`3 * delta ≤ 7 * p`, the canonical moving-root deviations already have the
quadratic factorization needed at the balanced `c2` endpoint, and its
...
theorem TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c2
  ...
  have hsplit := T.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c2
    hdNormal hc7Normal hc5Normal hc4Normal hc3Normal r0 A0 r B hr0 hA0 hpS hr hx hX hroot
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c2
