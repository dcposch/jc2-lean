import FiniteSimpleSourceChartAllC7
import FiniteDoubleLiftSourceC7

/-! # Source-driven simple-root order lift before `c7` -/
...
chart below `c7`; its displacement is zero or starts at `delta`. -/
theorem TransverseFactor.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c7
  ...
  exact T.simpleRoot_source_zero_or_order_delta_of_coordinates_before_c7
    hd r0 A0 r w d e B 0 C2 hr0 hA0 hp hr hX hw0 hxcoord
...
simple-root order split before `c7`. -/
theorem TransverseFactor.simpleRoot_source_zero_or_order_delta_from_source_before_c7
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c7
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_source_zero_or_order_delta_from_source_before_c7
