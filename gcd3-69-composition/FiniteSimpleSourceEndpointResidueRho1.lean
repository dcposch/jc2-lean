...
/-! # The simple-source residue at the balanced `rho1` endpoint

At `10 * p = 3 * delta`, a nonzero residue in the half-scale transverse
...
/-- At the weight-ten endpoint, a transverse value of exact order
`delta + delta / 2` is incompatible with a cubic value of order at least
`delta`. -/
theorem TransverseFactor.sourceSextic_inconsistent_of_half_residue_at_rho1
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
    (hEq : 10 * S.normal.sextic.scale.p = 3 * T.delta)
...
/-- On the simple source-root branch at the balanced weight-ten resonance,
the exact quadratic moving-root coordinate has zero half-scale `B`
residue. -/
theorem TransverseFactor.simpleRoot_quadratic_B_residue_zero_at_rho1
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
    (hd : S.normal.d = 0)
    (hc7 : S.normal.c7 = 0)
  ...
  · have hKmain := GCD369CubeHahnRegular.mul_orderTop_lower
    ...
    exact T.sourceSextic_inconsistent_of_half_residue_at_rho1 hEq hK
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.sourceSextic_inconsistent_of_half_residue_at_rho1
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_quadratic_B_residue_zero_at_rho1
