...
/-! # Simple-source coordinates at the balanced `c1` resonance
...
`3 * delta ≤ 8 * p`, the canonical moving-root deviations already have the
quadratic factorization needed at the balanced `c1` endpoint, and its
...
theorem TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c1
  ...
  have hsplit := T.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c1
    hdNormal hc7Normal hc5Normal hc4Normal hc3Normal hc2Normal r0 A0 r B hr0 hA0 hpS hr hx hX hroot
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c1
