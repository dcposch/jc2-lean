...
/-! # Simple-source coordinates at the balanced `c4` resonance
...
`3 * delta ≤ 5 * p`, the canonical moving-root deviations already have the
quadratic factorization needed at the balanced `c4` endpoint, and its
...
theorem TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c4
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_zeroQuadratic_coordinates_from_source_before_c4
