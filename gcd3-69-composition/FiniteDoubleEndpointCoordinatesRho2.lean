...
/-! # Quadratic coordinates at the `rho2` endpoint

The row lift remains valid at equality: coefficients strictly below the
intrinsic cubic still lie below the weight-eleven load.  Hence the canonical
...
/-- Exact quadratic moving-root coordinates at the balanced `rho2` cutoff. -/
theorem TransverseFactor.doubleRoot_quadratic_coordinates_at_rho2
  ...
  obtain ⟨hDfull, B, hYcoord, hQfull⟩ :=
    T.doubleRoot_deviations_order_delta_from_source_before_rho2
      F hscale hd hc7 hc5 hc4 hc3 hc2 hc1 hr1 hp r r0 A0 hr0 hA0 hr hu hX hY hZ
        hroot
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_quadratic_coordinates_at_rho2
