...
/-!
# Polynomial-cube `(6,9)` core trajectory certificates
...
theorem GCD369CubeSourceTransformInverse {K : Type*} [Field K]
  ...
  have hcoordinate :
    ...
    rw [mul_add, ← mul_assoc (C s) (C s⁻¹) X,
      ← C_mul, mul_inv_cancel₀ hs, C_1, one_mul,
      ← C_mul, hconstant]
    simp
...
def GCD369CubeFaberC7N1 {K : Type*} [CommRing K]
  ...
  729 * GCD369CubeFaberN1 a0 a1 a2 a3 a4 + c7 *
...
def GCD369CubeFaberC7N2 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c7 : K) : K :=
  2187 * GCD369CubeFaberN2 a0 a1 a2 a3 a4 + c7 *
...
def GCD369CubeFaberC7N3 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c7 : K) : K :=
  243 * GCD369CubeFaberN3 a0 a1 a2 a3 a4 + c7 *
    (48384 * a0 * a2 - 12096 * a0 * a4 ^ 2 + 24192 * a1 ^ 2 -
      32256 * a1 * a3 * a4 - 16128 * a2 ^ 2 * a4 -
...
def GCD369CubeFaberC7N4 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c7 : K) : K :=
  6561 * GCD369CubeFaberN4 a0 a1 a2 a3 a4 + c7 *
    (326592 * a0 * a1 - 108864 * a0 * a3 * a4 -
      163296 * a1 * a2 * a4 - 81648 * a1 * a3 ^ 2 +
      37800 * a1 * a4 ^ 3 - 108864 * a2 ^ 2 * a3 +
...
theorem GCD369CubeFaberC7Numerators {K : Type*} [Field K] [CharZero K]
    (a0 a1 a2 a3 a4 c7 : K) :
    62208 * GCD369CubeFaberR1 a0 a1 a2 a3 a4 0 c7 0 0 0 0 0 =
        GCD369CubeFaberC7N1 a0 a1 a2 a3 a4 c7 ∧
    186624 * GCD369CubeFaberR2 a0 a1 a2 a3 a4 0 c7 0 0 0 0 0 =
        GCD369CubeFaberC7N2 a0 a1 a2 a3 a4 c7 ∧
    248832 * GCD369CubeFaberR3 a0 a1 a2 a3 a4 0 c7 0 0 0 0 0 =
...
def GCD369CubeFaberC5N3 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c5 : K) : K :=
  243 * GCD369CubeFaberN3 a0 a1 a2 a3 a4 + c5 *
...
def GCD369CubeFaberC5N4 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c5 : K) : K :=
  6561 * GCD369CubeFaberN4 a0 a1 a2 a3 a4 + c5 *
...
theorem GCD369CubeFaberC5Numerators {K : Type*} [Field K] [CharZero K]
    (a0 a1 a2 a3 a4 c5 : K) :
    62208 * GCD369CubeFaberR1 a0 a1 a2 a3 a4 0 0 c5 0 0 0 0 =
        GCD369CubeFaberC5N1 a0 a1 a2 a3 a4 c5 ∧
    186624 * GCD369CubeFaberR2 a0 a1 a2 a3 a4 0 0 c5 0 0 0 0 =
        GCD369CubeFaberC5N2 a0 a1 a2 a3 a4 c5 ∧
    248832 * GCD369CubeFaberR3 a0 a1 a2 a3 a4 0 0 c5 0 0 0 0 =
...
def GCD369CubeFaberC4N4 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c4 : K) : K :=
  6561 * GCD369CubeFaberN4 a0 a1 a2 a3 a4 + c4 *
...
theorem GCD369CubeFaberC4Numerators {K : Type*} [Field K] [CharZero K]
    (a0 a1 a2 a3 a4 c4 : K) :
    62208 * GCD369CubeFaberR1 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N1 a0 a1 a2 a3 a4 c4 ∧
    186624 * GCD369CubeFaberR2 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N2 a0 a1 a2 a3 a4 c4 ∧
    248832 * GCD369CubeFaberR3 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N3 a0 a1 a2 a3 a4 c4 ∧
...
def GCD369CubeFaberC2N4 {K : Type*} [CommRing K]
    (a0 a1 a2 a3 a4 c2 : K) : K :=
  6561 * GCD369CubeFaberN4 a0 a1 a2 a3 a4 + c2 *
...
theorem GCD369CubeFaberC2Numerators {K : Type*} [Field K] [CharZero K]
    (a0 a1 a2 a3 a4 c2 : K) :
    62208 * GCD369CubeFaberR1 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N1 a0 a1 a2 a3 a4 c2 ∧
    186624 * GCD369CubeFaberR2 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N2 a0 a1 a2 a3 a4 c2 ∧
    248832 * GCD369CubeFaberR3 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N3 a0 a1 a2 a3 a4 c2 ∧
...
theorem GCD369CubeFaberC1Numerators {K : Type*} [Field K] [CharZero K]
    (a0 a1 a2 a3 a4 c1 : K) :
    62208 * GCD369CubeFaberR1 a0 a1 a2 a3 a4 0 0 0 0 0 0 c1 =
        GCD369CubeFaberC1N1 a0 a1 a2 a3 a4 c1 ∧
    186624 * GCD369CubeFaberR2 a0 a1 a2 a3 a4 0 0 0 0 0 0 c1 =
        GCD369CubeFaberC1N2 a0 a1 a2 a3 a4 c1 ∧
    248832 * GCD369CubeFaberR3 a0 a1 a2 a3 a4 0 0 0 0 0 0 c1 =
...
theorem GCD369CubeFaberC7NormalExpansion {K : Type*}
    ...
    let A4 : K[X] := C (2 * u)
    ∃ Q1 Q2 Q3 Q4 : K[X],
      GCD369CubeFaberC7N1 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-32 * (56 * T * u ^ 4 - 1008 * T * u * v ^ 2 +
            GCD369CubeNormalRow1 Xn Yn Zn u)) * H ^ 2 + H ^ 3 * Q1 ∧
      GCD369CubeFaberC7N2 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-96 * (224 * T * u ^ 3 * v - 336 * T * v ^ 3 +
            729 * v * Xn ^ 2 + 1458 * u * Xn * Yn - 1458 * Yn * Zn)) *
              H ^ 2 + H ^ 3 * Q2 ∧
      GCD369CubeFaberC7N3 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (31104 * GCD369CubeNormalRow3 Xn Yn Zn u v) * H ^ 2 + H ^ 3 * Q3 ∧
      GCD369CubeFaberC7N4 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-288 * (224 * T * u ^ 4 * v - 1008 * T * u * v ^ 3 -
  ...
  let b21 : K :=
    -252 * T * Yn * u ^ 2 - 504 * T * Xn * u * v + 756 * T * Zn * v
  let b22 : K := 378 * T * Xn * Yn
  let b31 : K :=
    -112 * T * Xn * u ^ 3 + 504 * T * Yn * u * v +
      504 * T * Xn * v ^ 2 + 243 * Xn ^ 3
  let b32 : K :=
    504 * T * Xn ^ 2 * u - 378 * T * Yn ^ 2 - 756 * T * Xn * Zn
  let b41 : K :=
    -168 * T * Yn * u ^ 3 + 1512 * T * Zn * u * v - 2187 * Xn ^ 2 * Yn
  let b42 : K :=
    -2268 * T * Xn * Yn * u - 1512 * T * Xn ^ 2 * v +
      2268 * T * Yn * Zn
  refine ⟨C (32 * b11) + C (32 * b12) * X,
    C (96 * b21) + C (96 * b22) * X,
    C (-64 * b31) + C (-64 * b32) * X,
...
theorem GCD369CubeFaberC7NormalCoefficients {K : Type*}
    ...
    let A3 : K[X] := C (2 * v)
    let A4 : K[X] := C (2 * u)
    (GCD369CubeFaberC7N1 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -32 * (56 * T * u ^ 4 - 1008 * T * u * v ^ 2 +
          GCD369CubeNormalRow1 Xn Yn Zn u) ∧
    (GCD369CubeFaberC7N2 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -96 * (224 * T * u ^ 3 * v - 336 * T * v ^ 3 +
          729 * v * Xn ^ 2 + 1458 * u * Xn * Yn - 1458 * Yn * Zn) ∧
    (GCD369CubeFaberC7N3 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        31104 * GCD369CubeNormalRow3 Xn Yn Zn u v ∧
    (GCD369CubeFaberC7N4 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -288 * (224 * T * u ^ 4 * v - 1008 * T * u * v ^ 3 -
          2187 * u * v * Xn ^ 2 - 1458 * u ^ 2 * Xn * Yn +
          2916 * v * Xn * Zn + 1458 * v * Yn ^ 2 +
          1458 * u * Yn * Zn) := by
  dsimp
  obtain ⟨Q1, Q2, Q3, Q4, h1, h2, h3, h4⟩ :=
    GCD369CubeFaberC7NormalExpansion Xn Yn Zn u v T
  constructor
  · rw [h1]
    simp only [coeff_add, coeff_C_mul_X_pow, coeff_X_pow_mul']
    norm_num
...
def GCD369CubeC7LeadingFaberRows {K : Type*} [Field K]
  ...
  let A3 : K[X] := C (2 * v)
  let A4 : K[X] := C (2 * u)
  (GCD369CubeFaberC7N1 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
  (GCD369CubeFaberC7N2 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
...
theorem GCD369CubeFaberC5NormalExpansion {K : Type*}
    ...
    let A4 : K[X] := C (2 * u)
    ∃ Q1 Q2 Q3 Q4 : K[X],
      GCD369CubeFaberC5N1 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-96 * (40 * T * u ^ 3 - 360 * T * v ^ 2 +
            243 * u * Xn ^ 2 - 486 * Xn * Zn - 243 * Yn ^ 2)) *
              H ^ 2 + H ^ 3 * Q1 ∧
      GCD369CubeFaberC5N2 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-864 * (40 * T * u ^ 2 * v + 81 * v * Xn ^ 2 +
            162 * u * Xn * Yn - 162 * Yn * Zn)) * H ^ 2 + H ^ 3 * Q2 ∧
      GCD369CubeFaberC5N3 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (31104 * GCD369CubeNormalRow3 Xn Yn Zn u v) * H ^ 2 + H ^ 3 * Q3 ∧
      GCD369CubeFaberC5N4 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-2592 * (40 * T * u ^ 3 * v - 80 * T * v ^ 3 -
  ...
  let b32 : K := 30 * T * Xn ^ 2
  let b41 : K := 120 * T * Xn * u * v - 243 * Xn ^ 2 * Yn
  let b42 : K := -180 * T * Xn * Yn
  refine ⟨C (96 * b11), C (-864 * b21),
...
theorem GCD369CubeFaberC5NormalCoefficients {K : Type*}
    ...
    let A3 : K[X] := C (2 * v)
    let A4 : K[X] := C (2 * u)
    (GCD369CubeFaberC5N1 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -96 * (40 * T * u ^ 3 - 360 * T * v ^ 2 +
          243 * u * Xn ^ 2 - 486 * Xn * Zn - 243 * Yn ^ 2) ∧
    (GCD369CubeFaberC5N2 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -864 * (40 * T * u ^ 2 * v + 81 * v * Xn ^ 2 +
          162 * u * Xn * Yn - 162 * Yn * Zn) ∧
    (GCD369CubeFaberC5N3 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        31104 * GCD369CubeNormalRow3 Xn Yn Zn u v ∧
    (GCD369CubeFaberC5N4 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -2592 * (40 * T * u ^ 3 * v - 80 * T * v ^ 3 -
          243 * u * v * Xn ^ 2 - 162 * u ^ 2 * Xn * Yn +
          324 * v * Xn * Zn + 162 * v * Yn ^ 2 +
          162 * u * Yn * Zn) := by
  dsimp
  obtain ⟨Q1, Q2, Q3, Q4, h1, h2, h3, h4⟩ :=
    GCD369CubeFaberC5NormalExpansion Xn Yn Zn u v T
  constructor
  · rw [h1]
    simp only [coeff_add, coeff_C_mul_X_pow, coeff_X_pow_mul']
    norm_num
...
def GCD369CubeC5LeadingFaberRows {K : Type*} [Field K]
  ...
  let A3 : K[X] := C (2 * v)
  let A4 : K[X] := C (2 * u)
  (GCD369CubeFaberC5N1 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
  (GCD369CubeFaberC5N2 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
...
theorem GCD369CubeFaberC4NormalExpansion {K : Type*}
    ...
    let A4 : K[X] := C (2 * u)
    ∃ Q1 Q2 Q3 Q4 : K[X],
      GCD369CubeFaberC4N1 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (864 * (32 * T * u * v - 27 * u * Xn ^ 2 +
            54 * Xn * Zn + 27 * Yn ^ 2)) * H ^ 2 + H ^ 3 * Q1 ∧
      GCD369CubeFaberC4N2 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-288 * (32 * T * u ^ 3 - 144 * T * v ^ 2 +
            243 * v * Xn ^ 2 + 486 * u * Xn * Yn - 486 * Yn * Zn)) *
              H ^ 2 + H ^ 3 * Q2 ∧
      GCD369CubeFaberC4N3 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (31104 * GCD369CubeNormalRow3 Xn Yn Zn u v) * H ^ 2 + H ^ 3 * Q3 ∧
      GCD369CubeFaberC4N4 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-2592 * (8 * T * u ^ 4 - 96 * T * u * v ^ 2 -
            243 * u * v * Xn ^ 2 - 162 * u ^ 2 * Xn * Yn +
            324 * v * Xn * Zn + 162 * v * Yn ^ 2 +
            162 * u * Yn * Zn)) * H ^ 2 + H ^ 3 * Q4 := by
  dsimp
  ...
  let b41 : K :=
    96 * T * Xn * u ^ 2 - 288 * T * Yn * v - 243 * Xn ^ 2 * Yn
  let b42 : K := -144 * T * Xn ^ 2
...
theorem GCD369CubeFaberC4NormalCoefficients {K : Type*}
    ...
    let A3 : K[X] := C (2 * v)
    let A4 : K[X] := C (2 * u)
    (GCD369CubeFaberC4N1 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        864 * (32 * T * u * v - 27 * u * Xn ^ 2 +
          54 * Xn * Zn + 27 * Yn ^ 2) ∧
    (GCD369CubeFaberC4N2 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -288 * (32 * T * u ^ 3 - 144 * T * v ^ 2 +
          243 * v * Xn ^ 2 + 486 * u * Xn * Yn - 486 * Yn * Zn) ∧
    (GCD369CubeFaberC4N3 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        31104 * GCD369CubeNormalRow3 Xn Yn Zn u v ∧
    (GCD369CubeFaberC4N4 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -2592 * (8 * T * u ^ 4 - 96 * T * u * v ^ 2 -
          243 * u * v * Xn ^ 2 - 162 * u ^ 2 * Xn * Yn +
          324 * v * Xn * Zn + 162 * v * Yn ^ 2 +
          162 * u * Yn * Zn) := by
  dsimp
  obtain ⟨Q1, Q2, Q3, Q4, h1, h2, h3, h4⟩ :=
    GCD369CubeFaberC4NormalExpansion Xn Yn Zn u v T
  constructor
  · rw [h1]
    simp only [coeff_add, coeff_C_mul_X_pow, coeff_X_pow_mul']
    norm_num
...
def GCD369CubeC4LeadingFaberRows {K : Type*} [Field K]
  ...
  let A3 : K[X] := C (2 * v)
  let A4 : K[X] := C (2 * u)
  (GCD369CubeFaberC4N1 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
  (GCD369CubeFaberC4N2 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
...
theorem GCD369CubeFaberC2NormalExpansion {K : Type*}
    ...
    let A4 : K[X] := C (2 * u)
    ∃ Q1 Q2 Q3 Q4 : K[X],
      GCD369CubeFaberC2N1 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-2592 * (-16 * T * v + 9 * u * Xn ^ 2 -
            18 * Xn * Zn - 9 * Yn ^ 2)) * H ^ 2 + H ^ 3 * Q1 ∧
      GCD369CubeFaberC2N2 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-2592 * (8 * T * u ^ 2 + 27 * v * Xn ^ 2 +
            54 * u * Xn * Yn - 54 * Yn * Zn)) * H ^ 2 + H ^ 3 * Q2 ∧
      GCD369CubeFaberC2N3 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (31104 * GCD369CubeNormalRow3 Xn Yn Zn u v) * H ^ 2 + H ^ 3 * Q3 ∧
      GCD369CubeFaberC2N4 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-2592 * (16 * T * u ^ 3 - 72 * T * v ^ 2 -
            243 * u * v * Xn ^ 2 - 162 * u ^ 2 * Xn * Yn +
            324 * v * Xn * Zn + 162 * v * Yn ^ 2 +
            162 * u * Yn * Zn)) * H ^ 2 + H ^ 3 * Q4 := by
  dsimp
...
theorem GCD369CubeFaberC2NormalCoefficients {K : Type*}
    ...
    let A3 : K[X] := C (2 * v)
    let A4 : K[X] := C (2 * u)
    (GCD369CubeFaberC2N1 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -2592 * (-16 * T * v + 9 * u * Xn ^ 2 -
          18 * Xn * Zn - 9 * Yn ^ 2) ∧
    (GCD369CubeFaberC2N2 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -2592 * (8 * T * u ^ 2 + 27 * v * Xn ^ 2 +
          54 * u * Xn * Yn - 54 * Yn * Zn) ∧
    (GCD369CubeFaberC2N3 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        31104 * GCD369CubeNormalRow3 Xn Yn Zn u v ∧
    (GCD369CubeFaberC2N4 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -2592 * (16 * T * u ^ 3 - 72 * T * v ^ 2 -
          243 * u * v * Xn ^ 2 - 162 * u ^ 2 * Xn * Yn +
          324 * v * Xn * Zn + 162 * v * Yn ^ 2 +
          162 * u * Yn * Zn) := by
  dsimp
  obtain ⟨Q1, Q2, Q3, Q4, h1, h2, h3, h4⟩ :=
    GCD369CubeFaberC2NormalExpansion Xn Yn Zn u v T
  constructor
  · rw [h1]
    simp only [coeff_add, coeff_C_mul_X_pow, coeff_X_pow_mul']
    norm_num
...
def GCD369CubeC2LeadingFaberRows {K : Type*} [Field K]
  ...
  let A3 : K[X] := C (2 * v)
  let A4 : K[X] := C (2 * u)
  (GCD369CubeFaberC2N1 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
  (GCD369CubeFaberC2N2 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
...
theorem GCD369CubeFaberC1NormalExpansion {K : Type*}
    ...
    let A4 : K[X] := C (2 * u)
    ∃ Q1 Q2 Q3 Q4 : K[X],
      GCD369CubeFaberC1N1 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (2592 * (8 * T * u - 9 * u * Xn ^ 2 +
            18 * Xn * Zn + 9 * Yn ^ 2)) * H ^ 2 + H ^ 3 * Q1 ∧
      GCD369CubeFaberC1N2 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (-7776 * (-8 * T * v + 9 * v * Xn ^ 2 +
            18 * u * Xn * Yn - 18 * Yn * Zn)) * H ^ 2 + H ^ 3 * Q2 ∧
      GCD369CubeFaberC1N3 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (31104 * GCD369CubeNormalRow3 Xn Yn Zn u v) * H ^ 2 + H ^ 3 * Q3 ∧
      GCD369CubeFaberC1N4 A0 A1 A2 A3 A4 (C T * H ^ 2) =
          C (23328 * (8 * T * u * v + 27 * u * v * Xn ^ 2 +
...
theorem GCD369CubeFaberC1NormalCoefficients {K : Type*}
    ...
    let A3 : K[X] := C (2 * v)
    let A4 : K[X] := C (2 * u)
    (GCD369CubeFaberC1N1 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        2592 * (8 * T * u - 9 * u * Xn ^ 2 +
          18 * Xn * Zn + 9 * Yn ^ 2) ∧
    (GCD369CubeFaberC1N2 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        -7776 * (-8 * T * v + 9 * v * Xn ^ 2 +
          18 * u * Xn * Yn - 18 * Yn * Zn) ∧
    (GCD369CubeFaberC1N3 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        31104 * GCD369CubeNormalRow3 Xn Yn Zn u v ∧
    (GCD369CubeFaberC1N4 A0 A1 A2 A3 A4 (C T * H ^ 2)).coeff 2 =
        23328 * (8 * T * u * v + 27 * u * v * Xn ^ 2 +
          18 * u ^ 2 * Xn * Yn - 36 * v * Xn * Zn -
          18 * v * Yn ^ 2 - 18 * u * Yn * Zn) := by
  dsimp
  obtain ⟨Q1, Q2, Q3, Q4, h1, h2, h3, h4⟩ :=
    GCD369CubeFaberC1NormalExpansion Xn Yn Zn u v T
  constructor
  · rw [h1]
    simp only [coeff_add, coeff_C_mul_X_pow, coeff_X_pow_mul']
    norm_num
...
def GCD369CubeC1LeadingFaberRows {K : Type*} [Field K]
  ...
  let A3 : K[X] := C (2 * v)
  let A4 : K[X] := C (2 * u)
  (GCD369CubeFaberC1N1 A0 A1 A2 A3 A4 (H ^ 2)).coeff 2 = 0 ∧
...
theorem GCD369CubeC7Rows_of_faber
    ...
    GCD369CubeC7Rows Xn Yn Zn u v := by
  dsimp [GCD369CubeC7LeadingFaberRows] at hfaber
  have hcoeff := GCD369CubeFaberC7NormalCoefficients Xn Yn Zn u v 1
  dsimp at hcoeff
  simp only [C_1, one_mul, mul_one] at hcoeff
  rcases hfaber with ⟨hf1, hf2, hf3, hf4⟩
  rcases hcoeff with ⟨hc1, hc2, hc3, hc4⟩
  ...
  have hr1 :
      56 * u ^ 4 - 1008 * u * v ^ 2 +
          GCD369CubeNormalRow1 Xn Yn Zn u = 0 := by
    exact (mul_eq_zero.mp hf1).resolve_left (by norm_num)
  have hr2 :
      224 * u ^ 3 * v - 336 * v ^ 3 + 729 * v * Xn ^ 2 +
          1458 * u * Xn * Yn - 1458 * Yn * Zn = 0 := by
    exact (mul_eq_zero.mp hf2).resolve_left (by norm_num)
  have hr3 : GCD369CubeNormalRow3 Xn Yn Zn u v = 0 := by
    exact (mul_eq_zero.mp hf3).resolve_left (by norm_num)
  have hr4 :
...
theorem GCD369CubeC5Rows_of_faber
    ...
    GCD369CubeC5Rows Xn Yn Zn u v := by
  dsimp [GCD369CubeC5LeadingFaberRows] at hfaber
  have hcoeff := GCD369CubeFaberC5NormalCoefficients Xn Yn Zn u v 1
  dsimp at hcoeff
  simp only [C_1, one_mul, mul_one] at hcoeff
  rcases hfaber with ⟨hf1, hf2, hf3, hf4⟩
  rcases hcoeff with ⟨hc1, hc2, hc3, hc4⟩
...
theorem GCD369CubeC4Rows_of_faber
    ...
    GCD369CubeC4Rows Xn Yn Zn u v := by
  dsimp [GCD369CubeC4LeadingFaberRows] at hfaber
  have hcoeff := GCD369CubeFaberC4NormalCoefficients Xn Yn Zn u v 1
  dsimp at hcoeff
  simp only [C_1, one_mul, mul_one] at hcoeff
  rcases hfaber with ⟨hf1, hf2, hf3, hf4⟩
  rcases hcoeff with ⟨hc1, hc2, hc3, hc4⟩
  ...
  rw [hc4] at hf4
  have hr1 :
      32 * u * v - 27 * u * Xn ^ 2 + 54 * Xn * Zn + 27 * Yn ^ 2 = 0 := by
    exact (mul_eq_zero.mp hf1).resolve_left (by norm_num)
  have hr2 :
      32 * u ^ 3 - 144 * v ^ 2 + 243 * v * Xn ^ 2 +
          486 * u * Xn * Yn - 486 * Yn * Zn = 0 := by
    exact (mul_eq_zero.mp hf2).resolve_left (by norm_num)
  have hr3 : GCD369CubeNormalRow3 Xn Yn Zn u v = 0 := by
    exact (mul_eq_zero.mp hf3).resolve_left (by norm_num)
  have hr4 :
...
theorem GCD369CubeC2Rows_of_faber
    ...
    GCD369CubeC2Rows Xn Yn Zn u v := by
  dsimp [GCD369CubeC2LeadingFaberRows] at hfaber
  have hcoeff := GCD369CubeFaberC2NormalCoefficients Xn Yn Zn u v 1
  dsimp at hcoeff
  simp only [C_1, one_mul, mul_one] at hcoeff
  rcases hfaber with ⟨hf1, hf2, hf3, hf4⟩
  rcases hcoeff with ⟨hc1, hc2, hc3, hc4⟩
  ...
  rw [hc4] at hf4
  have hr1 :
      -16 * v + 9 * u * Xn ^ 2 - 18 * Xn * Zn - 9 * Yn ^ 2 = 0 := by
    exact (mul_eq_zero.mp hf1).resolve_left (by norm_num)
  have hr2 :
      8 * u ^ 2 + 27 * v * Xn ^ 2 + 54 * u * Xn * Yn -
          54 * Yn * Zn = 0 := by
...
theorem GCD369CubeC1Rows_of_faber
    ...
    GCD369CubeC1Rows Xn Yn Zn u v := by
  dsimp [GCD369CubeC1LeadingFaberRows] at hfaber
  have hcoeff := GCD369CubeFaberC1NormalCoefficients Xn Yn Zn u v 1
  dsimp at hcoeff
  simp only [C_1, one_mul, mul_one] at hcoeff
  rcases hfaber with ⟨hf1, hf2, hf3, hf4⟩
  rcases hcoeff with ⟨hc1, hc2, hc3, hc4⟩
  ...
  rw [hc4] at hf4
  have hr1 :
      8 * u - 9 * u * Xn ^ 2 + 18 * Xn * Zn + 9 * Yn ^ 2 = 0 := by
    exact (mul_eq_zero.mp hf1).resolve_left (by norm_num)
  have hr2 :
      -8 * v + 9 * v * Xn ^ 2 + 18 * u * Xn * Yn -
          18 * Yn * Zn = 0 := by
    exact (mul_eq_zero.mp hf2).resolve_left (by norm_num)
  have hr3 : GCD369CubeNormalRow3 Xn Yn Zn u v = 0 := by
    exact (mul_eq_zero.mp hf3).resolve_left (by norm_num)
  have hr4 :
      8 * u * v + 27 * u * v * Xn ^ 2 + 18 * u ^ 2 * Xn * Yn -
          36 * v * Xn * Zn - 18 * v * Yn ^ 2 - 18 * u * Yn * Zn = 0 := by
    exact (mul_eq_zero.mp hf4).resolve_left (by norm_num)
  rw [GCD369CubeNormalRow3] at hr3
  refine ⟨hprojective, ?_, ?_, ?_, ?_⟩
  · linear_combination hr1
...
#print axioms GCD369CubeFaberC7Numerators
#print axioms GCD369CubeFaberC7NormalExpansion
#print axioms GCD369CubeFaberC7NormalCoefficients
#print axioms GCD369CubeC7Rows_of_faber
#print axioms GCD369CubeFaberC5Numerators
#print axioms GCD369CubeFaberC5NormalExpansion
#print axioms GCD369CubeFaberC5NormalCoefficients
#print axioms GCD369CubeC5Rows_of_faber
#print axioms GCD369CubeFaberC4Numerators
#print axioms GCD369CubeFaberC4NormalExpansion
#print axioms GCD369CubeFaberC4NormalCoefficients
#print axioms GCD369CubeC4Rows_of_faber
#print axioms GCD369CubeFaberC2Numerators
#print axioms GCD369CubeFaberC2NormalExpansion
#print axioms GCD369CubeFaberC2NormalCoefficients
#print axioms GCD369CubeC2Rows_of_faber
#print axioms GCD369CubeFaberC1Numerators
