...
weight-two load, once the weight-one parameter has vanished. -/
theorem TransverseFactor.simpleRoot_strictLate_inconsistent_of_fullScale_before_c7
  ...
  have hrows := T.doubleRoot_row12Coeffs_zero_before_c7 F hscale
    hd r hroot T.delta T.hdelta.le (by nlinarith [hp, T.hdelta])
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_strictLate_inconsistent_of_fullScale_before_c7
