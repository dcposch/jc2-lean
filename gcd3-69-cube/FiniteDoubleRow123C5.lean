...
/-! # The first three moving-root rows through the residual weight-four scale
...
vanishing below four times the Hahn scale, under the same residual bound.
-/
...
theorem TransverseFactor.doubleRoot_row123Coeffs_zero_before_c5
    ...
    (hearly : 2 * T.delta + e < 4 * F.scale.p) :
    let A := T.Xn
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_row123Coeffs_zero_before_c5
