...
/-! # Early double-root source order case before `c1` -/

noncomputable section

namespace GCD369CubeHahnCommonValueData

/-- In the early moving-root range below `c1`, the sextic source equation
forces the Newton resonance `delta = 3 * nu`; ninth-Faber vanishing below the
weight-eight load then gives the incompatible second residue equation. -/
theorem TransverseFactor.doubleRoot_sourceEarly_inconsistent_of_exactOrders_before_c1
  ...
  · have hdelta : T.delta = 3 * nu := by
    ...
    have hz := S.normal.faberNineCoeff_zero_before_c1 hd hc7 hc5 hc4 hc3 hc2
      (6 * nu) (by nlinarith)
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_sourceEarly_inconsistent_of_exactOrders_before_c1
