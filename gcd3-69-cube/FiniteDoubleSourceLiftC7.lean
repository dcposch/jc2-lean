import FiniteDoubleSourceChartsC7
import FiniteDoubleLiftSourceC7

/-! # Source-facing double-root exclusion before `c7` -/
...
double-root source chart below the weight-two load. -/
theorem TransverseFactor.doubleRoot_source_inconsistent_of_orderBounds_before_c7
  ...
  exact T.doubleRoot_source_inconsistent_of_coordinates_before_c7
...
which exclude the double-root source coordinate before `c7`. -/
theorem TransverseFactor.doubleRoot_source_inconsistent_from_source_before_c7
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_source_inconsistent_of_orderBounds_before_c7
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_source_inconsistent_from_source_before_c7
