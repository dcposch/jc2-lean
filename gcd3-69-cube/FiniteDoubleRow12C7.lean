...
/-! # The first two moving-root rows through the residual weight-two scale

After the weight-one load has vanished, the bundled three-row coefficient
...
This file records their coefficient range below twice the Hahn scale.
-/
...
theorem TransverseFactor.doubleRoot_row12Coeffs_zero_before_c7
    ...
    (e : ℚ) (he : 0 ≤ e) (hearly : 2 * T.delta + e < 2 * F.scale.p) :
    let A := T.Xn
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_row12Coeffs_zero_before_c7
