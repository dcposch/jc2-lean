import FiniteC4Source

/-! # Source coefficient extraction for the first `c4` load

When the weight-one parameter `d` and the weight-two parameter `c7`,
together with the weight-four parameter `c5`, are the zero constant and
every later source parameter is a literal ground-field constant, the
complete scaled Faber equations reduce through order `5 p` to the
specialized `c4` numerators.  Their Hahn coefficients at that cutoff
therefore vanish.
-/
...
/-- Setting `d`, `c7`, `c5`, and every parameter after `c4` to zero
specializes the four complete numerators to the integral `c4` rows over
any commutative ring. -/
theorem GCD369CubeFaberFullN_c4_specialize
    {R : Type*} [CommRing R] (a0 a1 a2 a3 a4 c4 : R) :
    GCD369CubeFaberFullN1 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N1 a0 a1 a2 a3 a4 c4 ∧
    GCD369CubeFaberFullN2 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N2 a0 a1 a2 a3 a4 c4 ∧
    GCD369CubeFaberFullN3 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
        GCD369CubeFaberC4N3 a0 a1 a2 a3 a4 c4 ∧
    GCD369CubeFaberFullN4 a0 a1 a2 a3 a4 0 0 0 c4 0 0 0 =
...
/-- The four integral `c4` rows commute with arbitrary commutative-ring
homomorphisms. -/
theorem GCD369CubeFaberC4_map
    {R L : Type*} [CommRing R] [CommRing L] (f : R →+* L)
    (a0 a1 a2 a3 a4 c4 : R) :
    f (GCD369CubeFaberC4N1 a0 a1 a2 a3 a4 c4) =
        GCD369CubeFaberC4N1 (f a0) (f a1) (f a2) (f a3) (f a4) (f c4) ∧
    f (GCD369CubeFaberC4N2 a0 a1 a2 a3 a4 c4) =
        GCD369CubeFaberC4N2 (f a0) (f a1) (f a2) (f a3) (f a4) (f c4) ∧
    f (GCD369CubeFaberC4N3 a0 a1 a2 a3 a4 c4) =
        GCD369CubeFaberC4N3 (f a0) (f a1) (f a2) (f a3) (f a4) (f c4) ∧
    f (GCD369CubeFaberC4N4 a0 a1 a2 a3 a4 c4) =
        GCD369CubeFaberC4N4 (f a0) (f a1) (f a2) (f a3) (f a4) (f c4) := by
  constructor
  · simp only [GCD369CubeFaberC4N1, GCD369CubeFaberN1,
...
/-- When `d`, `c7`, and `c5` are the zero constant and every later source
parameter, together with the four invariants, is a literal ground-field
constant, the complete scaled equations reduce through order `5 p` to the
specialized `c4` numerators, whose coefficients at that cutoff vanish. -/
theorem c4NCoeff_zero
    {k : Type*} [Field k] [CharZero k]
    (F : GCD369CubeHahnFaberPoleData k)
    (C3 C2 C1 R1 R2 R3 R4 : k)
    ...
    (GCD369CubeFaberC4N1
      ...
      (F.scale.weightedRegular 5 F.c4)).1.coeff
        (((5 : ℕ) : ℚ) * F.scale.p) = 0 ∧
    (GCD369CubeFaberC4N2
      F.scale.regular0 F.scale.regular1 F.scale.regular2
      F.scale.regular3 F.scale.regular4
    ...
    (GCD369CubeFaberC4N4
      ...
      F.scale.regular3 F.scale.regular4
      (F.scale.weightedRegular 5 F.c4)).1.coeff
        (((5 : ℕ) : ℚ) * F.scale.p) = 0 := by
  let e : ℚ := ((5 : ℕ) : ℚ) * F.scale.p
  have he : 0 ≤ e := mul_nonneg (Nat.cast_nonneg 5) F.scale.hp.le
  ...
  have hweight (w : ℕ) (hw : 5 < w) :
    ...
    exact mul_lt_mul_of_pos_right
      (show ((5 : ℕ) : ℚ) < (w : ℚ) by exact_mod_cast hw) F.scale.hp
  ...
  have hc5_zero : F.scale.weightedRegular 4 F.c5 = 0 := by
    rw [hc5, map_zero]
    apply Subtype.ext
    simp [GCD369CubeHahnPoleScale.weightedRegular]
  have hc5q : q (F.scale.weightedRegular 4 F.c5) = 0 := by
    rw [hc5_zero, map_zero]
  ...
  · let full := GCD369CubeFaberFullN1
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).1,
        (GCD369CubeFaberC4_map q _ _ _ _ _ _).1,
        hdq, hc7q, hc5q, hc3q, hc2q, hc1q]
      exact (GCD369CubeFaberFullN_c4_specialize _ _ _ _ _ _).1
  ...
  · let full := GCD369CubeFaberFullN2
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.1,
        (GCD369CubeFaberC4_map q _ _ _ _ _ _).2.1,
        hdq, hc7q, hc5q, hc3q, hc2q, hc1q]
      exact (GCD369CubeFaberFullN_c4_specialize _ _ _ _ _ _).2.1
  ...
  · let full := GCD369CubeFaberFullN3
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.2.1,
        (GCD369CubeFaberC4_map q _ _ _ _ _ _).2.2.1,
        hdq, hc7q, hc5q, hc3q, hc2q, hc1q]
      exact (GCD369CubeFaberFullN_c4_specialize _ _ _ _ _ _).2.2.1
  ...
  · let full := GCD369CubeFaberFullN4
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.2.2,
        (GCD369CubeFaberC4_map q _ _ _ _ _ _).2.2.2,
        hdq, hc7q, hc5q, hc3q, hc2q, hc1q]
      exact (GCD369CubeFaberFullN_c4_specialize _ _ _ _ _ _).2.2.2
...
#print axioms GCD369CubeFaberFullN_c4_specialize
#print axioms GCD369CubeFaberC4_map
#print axioms GCD369CubeHahnFaberPoleData.c4NCoeff_zero
