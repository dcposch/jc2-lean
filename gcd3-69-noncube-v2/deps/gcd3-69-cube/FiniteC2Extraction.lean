import FiniteC2Source

/-! # Source coefficient extraction for the first `c2` load

When the weight-one parameter `d`, the weight-two parameter `c7`, the
weight-four parameter `c5`, the weight-five parameter `c4`, and the
normalized/gauge `c3` are the zero constant and every later source
parameter is a literal ground-field constant, the complete scaled Faber
equations reduce through order `7 p` to the specialized `c2` numerators.
Their Hahn coefficients at that cutoff therefore vanish.
-/

noncomputable section
open Polynomial

/-- Setting `d`, `c7`, `c5`, `c4`, the normalized/gauge `c3`, and every
parameter after `c2` to zero specializes the four complete numerators to
the integral `c2` rows over any commutative ring. -/
theorem GCD369CubeFaberFullN_c2_specialize
    {R : Type*} [CommRing R] (a0 a1 a2 a3 a4 c2 : R) :
    GCD369CubeFaberFullN1 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N1 a0 a1 a2 a3 a4 c2 ∧
    GCD369CubeFaberFullN2 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N2 a0 a1 a2 a3 a4 c2 ∧
    GCD369CubeFaberFullN3 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
        GCD369CubeFaberC2N3 a0 a1 a2 a3 a4 c2 ∧
    GCD369CubeFaberFullN4 a0 a1 a2 a3 a4 0 0 0 0 0 c2 0 =
...
/-- The four integral `c2` rows commute with arbitrary commutative-ring
homomorphisms. -/
theorem GCD369CubeFaberC2_map
    {R L : Type*} [CommRing R] [CommRing L] (f : R →+* L)
    (a0 a1 a2 a3 a4 c2 : R) :
    f (GCD369CubeFaberC2N1 a0 a1 a2 a3 a4 c2) =
        GCD369CubeFaberC2N1 (f a0) (f a1) (f a2) (f a3) (f a4) (f c2) ∧
    f (GCD369CubeFaberC2N2 a0 a1 a2 a3 a4 c2) =
        GCD369CubeFaberC2N2 (f a0) (f a1) (f a2) (f a3) (f a4) (f c2) ∧
    f (GCD369CubeFaberC2N3 a0 a1 a2 a3 a4 c2) =
        GCD369CubeFaberC2N3 (f a0) (f a1) (f a2) (f a3) (f a4) (f c2) ∧
    f (GCD369CubeFaberC2N4 a0 a1 a2 a3 a4 c2) =
        GCD369CubeFaberC2N4 (f a0) (f a1) (f a2) (f a3) (f a4) (f c2) := by
  constructor
  · simp only [GCD369CubeFaberC2N1, GCD369CubeFaberN1,
...
/-- When `d`, `c7`, `c5`, `c4`, and the normalized/gauge `c3` are the zero
constant and every later source parameter, together with the four
invariants, is a literal ground-field constant, the complete scaled
equations reduce through order `7 p` to the specialized `c2` numerators,
whose coefficients at that cutoff vanish. -/
theorem c2NCoeff_zero
    ...
    (GCD369CubeFaberC2N1
      ...
      (F.scale.weightedRegular 7 F.c2)).1.coeff
        (((7 : ℕ) : ℚ) * F.scale.p) = 0 ∧
    (GCD369CubeFaberC2N2
      F.scale.regular0 F.scale.regular1 F.scale.regular2
      F.scale.regular3 F.scale.regular4
    ...
    (GCD369CubeFaberC2N4
      ...
      F.scale.regular3 F.scale.regular4
      (F.scale.weightedRegular 7 F.c2)).1.coeff
        (((7 : ℕ) : ℚ) * F.scale.p) = 0 := by
  let e : ℚ := ((7 : ℕ) : ℚ) * F.scale.p
  have he : 0 ≤ e := mul_nonneg (Nat.cast_nonneg 7) F.scale.hp.le
  ...
  have hweight (w : ℕ) (hw : 7 < w) :
    ...
    exact mul_lt_mul_of_pos_right
      (show ((7 : ℕ) : ℚ) < (w : ℚ) by exact_mod_cast hw) F.scale.hp
  have hkill (w : ℕ) (hw : 7 < w) (c : k)
  ...
  · let full := GCD369CubeFaberFullN1
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).1,
        (GCD369CubeFaberC2_map q _ _ _ _ _ _).1,
        hdq, hc7q, hc5q, hc4q, hc3q, hc1q]
      exact (GCD369CubeFaberFullN_c2_specialize _ _ _ _ _ _).1
  ...
  · let full := GCD369CubeFaberFullN2
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.1,
        (GCD369CubeFaberC2_map q _ _ _ _ _ _).2.1,
        hdq, hc7q, hc5q, hc4q, hc3q, hc1q]
      exact (GCD369CubeFaberFullN_c2_specialize _ _ _ _ _ _).2.1
  ...
  · let full := GCD369CubeFaberFullN3
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.2.1,
        (GCD369CubeFaberC2_map q _ _ _ _ _ _).2.2.1,
        hdq, hc7q, hc5q, hc4q, hc3q, hc1q]
      exact (GCD369CubeFaberFullN_c2_specialize _ _ _ _ _ _).2.2.1
  ...
  · let full := GCD369CubeFaberFullN4
    ...
    have hqfull_crow : q full = q crow := by
      ...
      rw [(GCD369CubeFaberFullN_map q _ _ _ _ _ _ _ _ _ _ _ _).2.2.2,
        (GCD369CubeFaberC2_map q _ _ _ _ _ _).2.2.2,
        hdq, hc7q, hc5q, hc4q, hc3q, hc1q]
      exact (GCD369CubeFaberFullN_c2_specialize _ _ _ _ _ _).2.2.2
...
#print axioms GCD369CubeFaberFullN_c2_specialize
#print axioms GCD369CubeFaberC2_map
#print axioms GCD369CubeHahnFaberPoleData.c2NCoeff_zero
