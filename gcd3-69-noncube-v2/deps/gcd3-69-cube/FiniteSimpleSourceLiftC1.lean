import FiniteSimpleSourceChartAllC1
import FiniteDoubleLiftSourceC1

/-! # Source-driven simple-root order lift before `c1` -/
...
chart below `c1`; its displacement is zero or starts at `delta`. -/
theorem TransverseFactor.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c1
  ...
  exact T.simpleRoot_source_zero_or_order_delta_of_coordinates_before_c1
    hd hc7 hc5 hc4 hc3 hc2 r0 A0 r w d e B 0 C2 hr0 hA0 hp hr hX hw0 hxcoord
...
simple-root order split before `c1`. -/
theorem TransverseFactor.simpleRoot_source_zero_or_order_delta_from_source_before_c1
    {k : Type*} [Field k] [CharZero k]
    {S : GCD369CubeHahnCommonValueData k} (T : S.TransverseFactor)
  ...
  have hpS : 3 * T.delta < 8 * S.normal.sextic.scale.p := by
    rw [hscale]
    exact hp
  exact T.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c1
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_source_zero_or_order_delta_of_orderBounds_before_c1
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.simpleRoot_source_zero_or_order_delta_from_source_before_c1
