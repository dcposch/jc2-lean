...
/-! # Early double-root source order case before `rho1` -/

noncomputable section

namespace GCD369CubeHahnCommonValueData

/-- In the early moving-root range below `rho1`, the sextic source equation
forces the Newton resonance `delta = 3 * nu`; ninth-Faber vanishing below the
later weight-nine load then gives the incompatible second residue equation. -/
theorem TransverseFactor.doubleRoot_sourceEarly_inconsistent_of_exactOrders_before_rho1
...
#print axioms
  GCD369CubeHahnCommonValueData.TransverseFactor.doubleRoot_sourceEarly_inconsistent_of_exactOrders_before_rho1
