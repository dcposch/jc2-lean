import Sol68ScaleTwoRouteScratch
...
theorem ratFuncAtHahn68_linearRoot_orderTop_eq_one_scratch
...
order `-1`. -/
theorem ratFuncAtHahn68_kellerTerminal_orderTop_eq_neg_one_scratch
  ...
  have hhOrder : hH.orderTop = (↑(1 : ℚ) : WithTop ℚ) := by
    dsimp only [hH]
    exact ratFuncAtHahn68_linearRoot_orderTop_eq_one_scratch
      h0 a hdegree hroot
...
theorem squareConstantLIntegratedSourceData68_scratch
...
theorem normalized68ScaleTwo_nonzeroFace_localRootData_scratch
    [IsAlgClosed k]
  ...
  obtain ⟨h0, lambda, a, hh0, hlambda, hh0degree, hH, hroot, hN⟩ :=
    normalized68ScaleTwo_nonzeroFace_has_linear_root_scratch hsource hnonzero
  rcases hsource with
  ...
  obtain ⟨S⟩ := squareConstantLIntegratedSourceData68_scratch
  ...
  let T : SquareConstantLIntegratedLocalRootData68
    ...
    septic_ne_zero := hl
    scale_order :=
      ratFuncAtHahn68_linearRoot_orderTop_eq_one_scratch
        h0 a hh0degree hroot
    terminal_order :=
      ratFuncAtHahn68_kellerTerminal_orderTop_eq_neg_one_scratch
...
theorem normalized68ScaleTwo_nonzeroFace_impossible_of_localRootExclusion
  ...
  obtain ⟨j, h0, l, ⟨T⟩⟩ :=
    normalized68ScaleTwo_nonzeroFace_localRootData_scratch hsource hnonzero
  exact hlocal _ _ j h0 l T

end NonalignedSourceAdapter68

#print axioms squareConstantLIntegratedSourceData68_scratch
#print axioms ratFuncAtHahn68_linearRoot_orderTop_eq_one_scratch
#print axioms ratFuncAtHahn68_kellerTerminal_orderTop_eq_neg_one_scratch
#print axioms normalized68ScaleTwo_nonzeroFace_localRootData_scratch
