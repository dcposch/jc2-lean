...
theorem mixedConstABC_beta0_D0_leads_impossible
  ...
  have hrest :
    ...
    have hbase :
        (degreeZeroBaseGroupHighDRest610 l A B C0 D0 E0).natDegree <
          3 * D0.natDegree := by
      apply lt_of_le_of_lt astra4b_structural_degreeZeroBaseGroupHighDRest610
      clear * - hA hB hC hDpos hE
