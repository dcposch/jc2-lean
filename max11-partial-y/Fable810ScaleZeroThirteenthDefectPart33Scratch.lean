import Fable810ScaleZeroThirteenthDefectPart32Scratch

/-! Part 33 of 37 of `Fable810ScaleZeroThirteenthDefectScratch`, split so that no single module elaborates them all
