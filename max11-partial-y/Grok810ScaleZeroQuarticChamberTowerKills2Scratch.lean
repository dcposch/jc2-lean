...
/-- Tower deep-rescue `BCDEFG2` on chamber `BCDEFG` / `BF·BG·CF·CG·BBB·BBC·BCC·CCC` leaf 1, target `a*b*c^2*d*g^2`. -/
theorem quarticRefinedBCDEFG7L1810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticRefinedBCDEFG7L1810 A B C D E F G)
    ...
    (hpiDeg : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0) :
    False := by
  obtain ⟨hcell, hx0, hx1, hx2, hx3, hx4, hx5, hx6, hx7, hx8, hx9, hx10, hx11, hx12, hx13, hx14, hx15, hx16, hx17, hx18, hx19, hx20, hx21, hx22, hx23, hx24, hx25⟩ := hch
  ...
  have hdp0 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by
    omega
  have hdz0 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by omega
  ...
  have hz0delta : delta = 0 ∨ (2 * A.natDegree + B.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree ∧ F.natDegree < A.natDegree + 2 * B.natDegree + C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr0 : (muQuarticChamberRest9004810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + C.natDegree :=
    muQuarticChamberRest9004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := muQuarticChamberFace9004810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by omega) (by omega) (by omega)
  have hq0 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hmuDeg]
    omega
  rw [degreeZeroMuQuartic810_eq_face9004_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr0,
    add_zero] at hq0
  have hs0 : (5 / 512 : k) * muQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct0.symm.trans hq0
  have hin0 : muQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs0 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp1 : 0 < A.natDegree + 2 * B.natDegree + E.natDegree := by
    omega
  have hdz1 : 0 < A.natDegree + 2 * B.natDegree + E.natDegree := by omega
  ...
  have hz1delta : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * B.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr1 : (xiQuarticChamberRest9003810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + E.natDegree :=
    xiQuarticChamberRest9003810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace9003810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega)
  have hq1 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hxiDeg]
    omega
  rw [degreeZeroXiQuartic810_eq_face9003_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr1,
    add_zero] at hq1
  have hs1 : (5 / 512 : k) * xiQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct1.symm.trans hq1
  have hin1 : xiQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs1 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp2 : 0 < 2 * A.natDegree + 4 * B.natDegree := by
    omega
  have hdz2 : 0 < 2 * A.natDegree + 4 * B.natDegree := by omega
  ...
  have hz2delta : delta = 0 ∨ (2 * A.natDegree + B.natDegree + C.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + 3 * B.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ 2 * A.natDegree + F.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + B.natDegree + E.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + C.natDegree + D.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ 2 * B.natDegree + D.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ B.natDegree + 2 * C.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ C.natDegree + F.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ D.natDegree + E.natDegree < 2 * A.natDegree + 4 * B.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr2 : (piQuarticChamberRest9004810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + 4 * B.natDegree :=
    piQuarticChamberRest9004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace9004810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hpiDeg]
    omega
  rw [degreeZeroPiQuartic810_eq_face9004_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr2,
    add_zero] at hq2
  have hs2 : (5 / 4096 : k) * piQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct2.symm.trans hq2
  have hin2 : piQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs2 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp3 : 0 < A.natDegree + 3 * B.natDegree := by
    omega
  have hdz3 : 0 < A.natDegree + 3 * B.natDegree := by omega
  ...
  have hr3 : (kappaQuarticChamberRest9003810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest9003810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) hz3zeta (Or.inr (by omega)) hz3theta
  have hct3 := kappaQuarticChamberFace9003810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by omega) (by omega) (by omega)
  ...
  have hin3 : kappaQuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    ...
    · exact absurd h (by norm_num)
    · exact h
  have hdp4 : A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree := by
    omega
  have hdz4 : 0 < 3 * A.natDegree + 2 * B.natDegree + D.natDegree := by omega
  have hz4l : l = 0 ∨ (8 * A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 6 * A.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 5 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 5 * A.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * B.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 4 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + B.natDegree + C.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 3 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 3 * B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * B.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + C.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + D.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + C.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + D.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + C.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * B.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * B.natDegree + C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * B.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + 2 * C.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + D.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + E.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * C.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ C.natDegree + D.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ C.natDegree + 2 * E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * D.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hz4beta : beta = 0 ∨ (7 * A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 5 * A.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 4 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + C.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 3 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * B.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + D.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + C.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + D.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ C.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hz4delta : delta = 0 ∨ (6 * A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * A.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 4 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * B.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + C.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ D.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hz4zeta : zeta = 0 ∨ (5 * A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 3 * A.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * B.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + F.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ C.natDegree + E.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hz4theta : theta = 0 ∨ (4 * A.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * A.natDegree + C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ B.natDegree + D.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ 2 * C.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree ∧ G.natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr4 : (n4QuarticChamberRest9000810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 3 * A.natDegree + 2 * B.natDegree + D.natDegree :=
    n4QuarticChamberRest9000810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) hz4theta
  have hct4 := n4QuarticChamberFace9000810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega)
  have hq4 : (degreeZeroN4Quartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (3 * A.natDegree + 2 * B.natDegree + D.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    have hle := degreeZeroN4Quartic810_natDegree_le l beta gamma delta epsilon zeta eta theta
      A B C D E F G hApos hprim homi
    omega
  rw [degreeZeroN4Quartic810_eq_face9000_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr4,
    add_zero] at hq4
  have hs4 : (5 / 8192 : k) * n4QuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct4.symm.trans hq4
  have hin4 : n4QuarticCostChamberBCDEFG2Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
  ...
  exact quarticCostChamberBCDEFG2810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc hGc

set_option maxHeartbeats 64000000 in
/-- Tower deep-rescue `BCDEFG5` on chamber `BCDEFG` / `BF·BG·CF·CG·DD·BBB·BBC·BCC·CCC`, target `a*c*d^3`. -/
theorem quarticChamberBCDEFG9810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticChamberBCDEFG9810 A B C D E F G)
    (hnc : ¬ (B.natDegree = 0 ∧ C.natDegree = 0 ∧ D.natDegree = 0 ∧
        E.natDegree = 0 ∧ F.natDegree = 0 ∧ G.natDegree = 0))
    (hkap : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0)
  ...
  have hr0 : (muQuarticChamberRest9005810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + C.natDegree :=
    muQuarticChamberRest9005810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := muQuarticChamberFace9005810_coeff_top hAne hBne hCne hDne hFne hGne (E := E) (by omega) (by omega) (by omega) (by omega)
  have hq0 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hmuDeg]
  ...
  have hdp1 : 0 < A.natDegree + B.natDegree + C.natDegree + D.natDegree := by
    omega
  have hdz1 : 0 < A.natDegree + B.natDegree + C.natDegree + D.natDegree := by omega
  ...
  have hr1 : (xiQuarticChamberRest9006810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest9006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace9006810_coeff_top hAne hBne hCne hDne hFne (E := E) (G := G) (by omega)
  have hq1 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
  ...
  have hr2 : (piQuarticChamberRest9005810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + 4 * B.natDegree :=
    piQuarticChamberRest9005810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace9005810_coeff_top hAne hBne hCne hDne hFne hGne (E := E) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hpiDeg]
  ...
  have hdp4 : A.natDegree < A.natDegree + 2 * B.natDegree + D.natDegree := by
    omega
  have hdz4 : 0 < A.natDegree + 2 * B.natDegree + D.natDegree := by omega
  ...
  have hr4 : (n2QuarticChamberRest9004810 l beta gamma delta epsilon zeta eta theta
    ...
    n2QuarticChamberRest9004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) hz4theta
  have hct4 := n2QuarticChamberFace9004810_coeff_top hAne hBne hCne hDne hGne (E := E) (F := F) (by omega) (by omega)
  ...
  have hFc : F.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hFne
  have hGc : G.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hGne
  exact quarticCostChamberBCDEFG5810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc hGc

set_option maxHeartbeats 64000000 in
/-- Tower deep-rescue `BCDEFG6` on chamber `BCDEFG` / `BF·BG·CF·CG·DD·DE·EE`, target `a*d*f^2`. -/
theorem quarticChamberBCDEFG11810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
  ...
  have hr0 : (xiQuarticChamberRest9007810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest9007810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := xiQuarticChamberFace9007810_coeff_top hAne hDne hEne hFne hGne (B := B) (C := C) (by omega)
  ...
  have hr1 : (piQuarticChamberRest9006810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest9006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := piQuarticChamberFace9006810_coeff_top hAne hFne hGne (B := B) (C := C) (D := D) (E := E) (by omega)
  ...
  have hdp2 : A.natDegree < D.natDegree + G.natDegree := by
    omega
  have hdz2 : 0 < D.natDegree + G.natDegree := by omega
  ...
  have hr2 : (n2QuarticChamberRest9005810 l beta gamma delta epsilon zeta eta theta
    ...
    n2QuarticChamberRest9005810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) hz2zeta (Or.inr (by omega)) hz2theta
  have hct2 := n2QuarticChamberFace9005810_coeff_top hDne hEne hFne hGne (A := A) (B := B) (C := C) (by omega)
  ...
  have hFc : F.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hFne
  have hGc : G.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hGne
  exact quarticCostChamberBCDEFG6810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hAc hBc hCc hDc hEc hFc hGc

set_option maxHeartbeats 64000000 in
/-- Tower deep-rescue `BCDEFG7` on chamber `BCDEFG` / `BF·BG·CF·CG·EE·BBB·BBC·BCC·CCC`, target `c*e^3`. -/
theorem quarticChamberBCDEFG15810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
  ...
  have hr0 : (muQuarticChamberRest9006810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + C.natDegree :=
    muQuarticChamberRest9006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := muQuarticChamberFace9006810_coeff_top hAne hBne hCne hEne hFne hGne (D := D) (by omega) (by omega) (by omega) (by omega)
  have hq0 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hmuDeg]
  ...
  have hr1 : (xiQuarticChamberRest9008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + E.natDegree :=
    xiQuarticChamberRest9008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace9008810_coeff_top hAne hBne hCne hEne hGne (D := D) (F := F) (by omega) (by omega)
  have hq1 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + E.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hxiDeg]
  ...
  have hr2 : (piQuarticChamberRest9007810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + 4 * B.natDegree :=
    piQuarticChamberRest9007810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace9007810_coeff_top hAne hBne hCne hEne hFne hGne (D := D) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hpiDeg]
  ...
  have hdp4 : A.natDegree < B.natDegree + C.natDegree + E.natDegree := by
    omega
  have hdz4 : 0 < B.natDegree + C.natDegree + E.natDegree := by omega
  ...
  have hr4 : (n2QuarticChamberRest9006810 l beta gamma delta epsilon zeta eta theta
    ...
    n2QuarticChamberRest9006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) hz4theta
  have hct4 := n2QuarticChamberFace9006810_coeff_top hBne hCne hEne hFne (A := A) (D := D) (G := G) (by omega)
  have hq4 : (degreeZeroN2Quartic810 l beta gamma delta epsilon zeta eta theta
  ...
  have hFc : F.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hFne
  have hGc : G.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hGne
  exact quarticCostChamberBCDEFG7810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc hGc

set_option maxHeartbeats 64000000 in
/-- Tower deep-rescue `BCDEFG8` on chamber `BCDEFG` / `BF·BG·DD·DE·EE·BBB`, target `a*b^2*d*e*f`. -/
theorem quarticChamberBCDEFG22810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticChamberBCDEFG22810 A B C D E F G)
    (hnc : ¬ (B.natDegree = 0 ∧ C.natDegree = 0 ∧ D.natDegree = 0 ∧
        E.natDegree = 0 ∧ F.natDegree = 0 ∧ G.natDegree = 0))
    (hkap : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0)
  ...
  have hdp0 : 0 < A.natDegree + B.natDegree + F.natDegree := by
    omega
  have hdz0 : 0 < A.natDegree + B.natDegree + F.natDegree := by omega
  ...
  have hz0beta : beta = 0 ∨ (3 * A.natDegree + B.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ 2 * A.natDegree + D.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ 3 * B.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + B.natDegree + F.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hz0delta : delta = 0 ∨ (2 * A.natDegree + B.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ A.natDegree + D.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ B.natDegree + C.natDegree < A.natDegree + B.natDegree + F.natDegree ∧ F.natDegree < A.natDegree + B.natDegree + F.natDegree) := by
    rcases hkbdelta with h | h | h | h | h | h | h | h | h
    · exact Or.inl h
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr0 : (muQuarticChamberRest9007810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + B.natDegree + F.natDegree :=
    muQuarticChamberRest9007810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := muQuarticChamberFace9007810_coeff_top hAne hBne hDne hEne hFne (C := C) (G := G) (by omega) (by omega)
  have hq0 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + B.natDegree + F.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hmuDeg]
    omega
  rw [degreeZeroMuQuartic810_eq_face9007_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr0,
    add_zero] at hq0
  have hs0 : (5 / 128 : k) * muQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct0.symm.trans hq0
  have hin0 : muQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs0 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp1 : 0 < A.natDegree + 2 * B.natDegree + E.natDegree := by
  ...
  have hz1delta : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ 3 * B.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + 2 * B.natDegree + E.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr1 : (xiQuarticChamberRest9009810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + E.natDegree :=
    xiQuarticChamberRest9009810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace9009810_coeff_top hAne hBne hDne hEne hFne hGne (C := C) (by omega) (by omega)
  have hq1 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + E.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hxiDeg]
    omega
  rw [degreeZeroXiQuartic810_eq_face9009_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr1,
    add_zero] at hq1
  have hs1 : (5 / 512 : k) * xiQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct1.symm.trans hq1
  have hin1 : xiQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs1 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp2 : 0 < 2 * A.natDegree + 4 * B.natDegree := by
  ...
  have hz2delta : delta = 0 ∨ (2 * A.natDegree + B.natDegree + C.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + 3 * B.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ 2 * A.natDegree + F.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + B.natDegree + E.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ A.natDegree + C.natDegree + D.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ 2 * B.natDegree + D.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ B.natDegree + 2 * C.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ C.natDegree + F.natDegree < 2 * A.natDegree + 4 * B.natDegree ∧ D.natDegree + E.natDegree < 2 * A.natDegree + 4 * B.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr2 : (piQuarticChamberRest9008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + 4 * B.natDegree :=
    piQuarticChamberRest9008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace9008810_coeff_top hAne hBne hDne hEne hFne hGne (C := C) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hpiDeg]
    omega
  rw [degreeZeroPiQuartic810_eq_face9008_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr2,
    add_zero] at hq2
  have hs2 : (5 / 4096 : k) * piQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct2.symm.trans hq2
  have hin2 : piQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs2 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp3 : 0 < A.natDegree + 3 * B.natDegree := by
  ...
  have hz3theta : theta = 0 ∨ (A.natDegree < A.natDegree + 3 * B.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr3 : (kappaQuarticChamberRest9004810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 3 * B.natDegree :=
    kappaQuarticChamberRest9004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) hz3zeta (Or.inr (by omega)) hz3theta
  have hct3 := kappaQuarticChamberFace9004810_coeff_top hAne hBne hDne hEne hGne (C := C) (F := F) (by omega) (by omega)
  have hq3 : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hkap]
    omega
  rw [degreeZeroKappaQuartic810_eq_face9004_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr3,
    add_zero] at hq3
  have hs3 : (5 / 512 : k) * kappaQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct3.symm.trans hq3
  have hin3 : kappaQuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs3 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hdp4 : A.natDegree < A.natDegree + 2 * B.natDegree + D.natDegree := by
  ...
  have hz4theta : theta = 0 ∨ (2 * A.natDegree < A.natDegree + 2 * B.natDegree + D.natDegree ∧ C.natDegree < A.natDegree + 2 * B.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr4 : (n2QuarticChamberRest9007810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * B.natDegree + D.natDegree :=
    n2QuarticChamberRest9007810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) hz4theta
  have hct4 := n2QuarticChamberFace9007810_coeff_top hAne hBne hDne hEne hFne hGne (C := C) (by omega) (by omega)
  have hq4 : (degreeZeroN2Quartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + D.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    have hle := degreeZeroN2Quartic810_natDegree_le l beta gamma delta epsilon zeta eta theta
      A B C D E F G hnu hkap
    omega
  rw [degreeZeroN2Quartic810_eq_face9007_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr4,
    add_zero] at hq4
  have hs4 : (5 / 512 : k) * n2QuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 :=
    hct4.symm.trans hq4
  have hin4 : n2QuarticCostChamberBCDEFG8Face810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff = 0 := by
    rcases mul_eq_zero.mp hs4 with h | h
    · exact absurd h (by norm_num)
    · exact h
  have hAc : A.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hAne
  ...
  have hFc : F.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hFne
  have hGc : G.leadingCoeff ≠ 0 := leadingCoeff_ne_zero.mpr hGne
  exact quarticCostChamberBCDEFG8810_impossible A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hAc hBc hCc hDc hEc hFc hGc
