...
theorem grokScaleZero_twelfthCoefficientJacobianRow_raw_810 {K : Type*}
...
theorem muResidual810_deriv_zero
  ...
  simp only [muResidual810, alphaResidual810, betaResidual810,
    ...
    zero_mul, add_zero, mul_zero, pow_two, hsq,
    hsqB, hsqC, hsqD, hcub, hcubB, hquar, hquint]
  rw [hWderiv, hXderiv, hPderiv, hQderiv, hRderiv, hSderiv, hTderiv, hUderiv, hVderiv]
...
theorem normalized810ScaleZero_twelfthCoefficientJacobianRow
  ...
  simpa only [p, q] using grokScaleZero_twelfthCoefficientJacobianRow_raw_810 hp hq hjac
...
theorem scaleZero_twelfthCoefficientJacobianRow_810
    ...
    (p.coeff 5).derivative * q.coeff 1 +
      ...
      ((p.coeff 6 * Polynomial.C (6 : k)) * (q.coeff 0).derivative +
        ...
        p.coeff 1 * (q.coeff 5).derivative) =
      0 := by
  have hrow := grokScaleZero_twelfthCoefficientJacobianRow_raw_810 hp hq hjac
  simpa using hrow
...
#print axioms grokScaleZero_twelfthCoefficientJacobianRow_raw_810
