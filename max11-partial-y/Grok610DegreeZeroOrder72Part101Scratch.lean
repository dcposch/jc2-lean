...
/-- Combined order-`72` source head on `p32(a) = p21(a) = p1(a) = 0`. -/
def degreeZeroPostCollapseP32P21P1ZeroOrderThreeHead610
    (w1 a42 p32n p21n p1n p0 q41 q3 : R) : R :=
  -3080652018941952*a42^4*q3 + 13007197413310464*a42^4*q41*w1 - 16430144101023744*a42^3*p32n*q41 + 19510796119965696*a42^3*q3*w1^2 - 36131103925862400*a42^3*q41*w1^3 + 22749430293725184*a42^2*p1n*q41 + 17062072720293888*a42^2*p21n*q3 - 49290432303071232*a42^2*p21n*q41*w1 - 36967824227303424*a42^2*p32n*q3*w1 + 78043184479862784*a42^2*p32n*q41*w1^2 - 20323745958297600*a42^2*q3*w1^4 + 28001605542543360*a42^2*q41*w1^5 - 29249267520503808*a42*p0*q3 + 45498860587450368*a42*p0*q41*w1 + 34124145440587776*a42*p1n*q3*w1 - 49290432303071232*a42*p1n*q41*w1^2 + 45498860587450368*a42*p21n*p32n*q41 - 36967824227303424*a42*p21n*q3*w1^2 + 52028789653241856*a42*p21n*q41*w1^3 + 17062072720293888*a42*p32n^2*q3 - 49290432303071232*a42*p32n^2*q41*w1 + 39021592239931392*a42*p32n*q3*w1^3 - 54196655888793600*a42*p32n*q41*w1^4 + 7000401385635840*a42*q3*w1^6 - 8222693691064320*a42*q41*w1^7 - 38999023360671744*p0*p32n*q41 + 17062072720293888*p0*q3*w1^2 - 16430144101023744*p0*q41*w1^3 - 38999023360671744*p1n*p21n*q41 - 29249267520503808*p1n*p32n*q3 + 45498860587450368*p1n*p32n*q41*w1 - 12322608075767808*p1n*q3*w1^3 + 13007197413310464*p1n*q41*w1^4 - 14624633760251904*p21n^2*q3 + 22749430293725184*p21n^2*q41*w1 + 34124145440587776*p21n*p32n*q3*w1 - 49290432303071232*p21n*p32n*q41*w1^2 + 9755398059982848*p21n*q3*w1^4 - 10839331177758720*p21n*q41*w1^5 + 7583143431241728*p32n^3*q41 - 18483912113651712*p32n^2*q3*w1^2 + 26014394826620928*p32n^2*q41*w1^3 - 8129498383319040*p32n*q3*w1^5 + 9333868514181120*p32n*q41*w1^6 - 770877533537280*q3*w1^8 + 818462566471680*q41*w1^9
...
/-- Combined order-`72` mixin on `p32 = h · p32n`, `p21 = h · p21n`. -/
def degreeZeroPostCollapseP32P21ZeroOrderThreeHead610
    (w1 a42 p32n p21n p1 p0 u2 b63 q53 q41 q3 q2 : R) : R :=
  -3080652018941952*a42^4*q3 + 13007197413310464*a42^4*q41*w1 - 16430144101023744*a42^3*p32n*q41 + 19510796119965696*a42^3*q3*w1^2 - 36131103925862400*a42^3*q41*w1^3 - 61613040378839040*a42^2*p1*q53*w1 + 17062072720293888*a42^2*p21n*q3 - 49290432303071232*a42^2*p21n*q41*w1 - 36967824227303424*a42^2*p32n*q3*w1 + 78043184479862784*a42^2*p32n*q41*w1^2 - 20323745958297600*a42^2*q3*w1^4 + 28001605542543360*a42^2*q41*w1^5 - 29249267520503808*a42*p0*q3 + 45498860587450368*a42*p0*q41*w1 + 39811503014019072*a42*p1^2*u2 + 56873575734312960*a42*p1*p32n*q53 - 19499511680335872*a42*p1*q2 + 65035987066552320*a42*p1*q53*w1^3 + 45498860587450368*a42*p21n*p32n*q41 - 36967824227303424*a42*p21n*q3*w1^2 + 52028789653241856*a42*p21n*q41*w1^3 + 17062072720293888*a42*p32n^2*q3 - 49290432303071232*a42*p32n^2*q41*w1 + 39021592239931392*a42*p32n*q3*w1^3 - 54196655888793600*a42*p32n*q41*w1^4 + 7000401385635840*a42*q3*w1^6 - 8222693691064320*a42*q41*w1^7 + 34124145440587776*b63*p1^2*w1 - 38999023360671744*p0*p32n*q41 + 17062072720293888*p0*q3*w1^2 - 16430144101023744*p0*q41*w1^3 + 18957858578104320*p1^3 - 43129128265187328*p1^2*u2*w1^2 + 56873575734312960*p1*p21n*q53*w1 - 61613040378839040*p1*p32n*q53*w1^2 + 11374715146862592*p1*q2*w1^2 - 13549163972198400*p1*q53*w1^5 - 14624633760251904*p21n^2*q3 + 22749430293725184*p21n^2*q41*w1 + 34124145440587776*p21n*p32n*q3*w1 - 49290432303071232*p21n*p32n*q41*w1^2 + 9755398059982848*p21n*q3*w1^4 - 10839331177758720*p21n*q41*w1^5 + 7583143431241728*p32n^3*q41 - 18483912113651712*p32n^2*q3*w1^2 + 26014394826620928*p32n^2*q41*w1^3 - 8129498383319040*p32n*q3*w1^5 + 9333868514181120*p32n*q41*w1^6 - 770877533537280*q3*w1^8 + 818462566471680*q41*w1^9
...
private abbrev order72Part07SpeedT_chunk01
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  -1000057340805120*a42^7*h^2*lambda - 15556447523635200*a42^7*h^2*w1 + 21584570939043840*a42^6*h^2*lambda*w1^2 + 23334671285452800*a42^6*h^2*p32n + 18667737028362240*a42^6*h^2*s2*w1 + 63954284263833600*a42^6*h^2*w1^3 - 3161471593512960*a42^6*h*u2 - 16258996766638080*a42^5*b63*h*w1 + 8129498383319040*a42^5*h^2*lambda*p21n - 42002408313815040*a42^5*h^2*lambda*p32n*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 11 through 20. -/
private abbrev order72Part07SpeedT_chunk02
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 77344712531573760*a42^5*h^2*lambda*w1^4 + 99360535796121600*a42^5*h^2*p21n*w1 - 21678662355517440*a42^5*h^2*p32n*s2 - 221679377211801600*a42^5*h^2*p32n*w1^2 - 115117711674900480*a42^5*h^2*s2*w1^3 - 34375427791810560*a42^5*h^2*w1^5 - 27098327944396800*a42^5*h*p1 + 49002809699450880*a42^5*h*u2*w1^2 + 3251799353327616*a42^5*q53 + 19510796119965696*a42^4*b63*h*p32n

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 21 through 30. -/
private abbrev order72Part07SpeedT_chunk03
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 70004013856358400*a42^4*b63*h*w1^3 - 9755398059982848*a42^4*h^2*lambda*p0 - 105006020784537600*a42^4*h^2*lambda*p21n*w1^2 + 20323745958297600*a42^4*h^2*lambda*p32n^2 + 215845709390438400*a42^4*h^2*lambda*p32n*w1^3 + 105274747612419840*a42^4*h^2*lambda*w1^6 - 86714649422069760*a42^4*h^2*p0*w1 - 135491639721984000*a42^4*h^2*p21n*p32n - 108393311777587200*a42^4*h^2*p21n*s2*w1 - 194455594045440000*a42^4*h^2*p21n*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 31 through 40. -/
private abbrev order72Part07SpeedT_chunk04
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 248401339490304000*a42^4*h^2*p32n^2*w1 + 280016055425433600*a42^4*h^2*p32n*s2*w1^2 + 209849995240704000*a42^4*h^2*p32n*w1^4 + 206252566750863360*a42^4*h^2*s2*w1^5 - 66841109595187200*a42^4*h^2*w1^7 + 40647491916595200*a42^4*h*lambda*p1*w1 + 26014394826620928*a42^4*h*p1*s2 + 146782609698816000*a42^4*h*p1*w1^2 + 22762595473293312*a42^4*h*p21n*u2 - 94844147805388800*a42^4*h*p32n*u2*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 41 through 50. -/
private abbrev order72Part07SpeedT_chunk05
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 125909997144422400*a42^4*h*u2*w1^4 - 33872909930496000*a42^4*q53*w1^2 + 78043184479862784*a42^3*b63*h*p21n*w1 - 162589967666380800*a42^3*b63*h*p32n*w1^2 - 86338283756175360*a42^3*b63*h*w1^5 - 24645216151535616*a42^3*b63*p1 + 81294983833190400*a42^3*h^2*lambda*p0*w1^2 - 19510796119965696*a42^3*h^2*lambda*p21n^2 + 162589967666380800*a42^3*h^2*lambda*p21n*p32n*w1 + 215845709390438400*a42^3*h^2*lambda*p21n*w1^4

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 51 through 60. -/
private abbrev order72Part07SpeedT_chunk06
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 210012041569075200*a42^3*h^2*lambda*p32n^2*w1^2 - 309378850126295040*a42^3*h^2*lambda*p32n*w1^5 - 68929894270036800*a42^3*h^2*lambda*w1^8 + 130071974133104640*a42^3*h^2*p0*p32n + 104057579306483712*a42^3*h^2*p0*s2*w1 + 60218506543104000*a42^3*h^2*p0*w1^3 - 173429298844139520*a42^3*h^2*p21n^2*w1 + 104057579306483712*a42^3*h^2*p21n*p32n*s2 + 587130438795264000*a42^3*h^2*p21n*p32n*w1^2 + 373354740567244800*a42^3*h^2*p21n*s2*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 61 through 70. -/
private abbrev order72Part07SpeedT_chunk07
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 47965713197875200*a42^3*h^2*p21n*w1^5 - 90327759814656000*a42^3*h^2*p32n^3 - 216786623555174400*a42^3*h^2*p32n^2*s2*w1 - 388911188090880000*a42^3*h^2*p32n^2*w1^3 - 575588558374502400*a42^3*h^2*p32n*s2*w1^4 + 143230949132544000*a42^3*h^2*p32n*w1^6 - 160418663028449280*a42^3*h^2*s2*w1^7 + 85098634901280000*a42^3*h^2*w1^9 - 39021592239931392*a42^3*h*lambda*p1*p32n - 140008027712716800*a42^3*h*lambda*p1*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 71 through 80. -/
private abbrev order72Part07SpeedT_chunk08
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 28752752176791552*a42^3*h*p0*u2 + 130071974133104640*a42^3*h*p1*p21n - 346858597688279040*a42^3*h*p1*p32n*w1 - 216786623555174400*a42^3*h*p1*s2*w1^2 - 19445559404544000*a42^3*h*p1*w1^4 - 189688295610777600*a42^3*h*p21n*u2*w1^2 + 45525190946586624*a42^3*h*p32n^2*u2 + 326685397996339200*a42^3*h*p32n*u2*w1^3 + 1895785857810432*a42^3*h*q1 + 120313997271336960*a42^3*h*u2*w1^6

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 81 through 90. -/
private abbrev order72Part07SpeedT_chunk09
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 91050381893173248*a42^3*p1*u2*w1 - 20537680126279680*a42^3*p21n*q53 + 65035987066552320*a42^3*p32n*q53*w1 - 8215072050511872*a42^3*q2*w1 + 58336678213632000*a42^3*q53*w1^4 - 73935648454606848*a42^2*b63*h*p0*w1 - 73935648454606848*a42^2*b63*h*p21n*p32n - 162589967666380800*a42^2*b63*h*p21n*w1^3 + 117064776719794176*a42^2*b63*h*p32n^2*w1 + 210012041569075200*a42^2*b63*h*p32n*w1^4

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 91 through 100. -/
private abbrev order72Part07SpeedT_chunk10
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 44196978589470720*a42^2*b63*h*w1^7 + 117064776719794176*a42^2*b63*p1*w1^2 + 36967824227303424*a42^2*h^2*lambda*p0*p21n - 117064776719794176*a42^2*h^2*lambda*p0*p32n*w1 - 105006020784537600*a42^2*h^2*lambda*p0*w1^4 + 121942475749785600*a42^2*h^2*lambda*p21n^2*w1^2 - 58532388359897088*a42^2*h^2*lambda*p21n*p32n^2 - 420024083138150400*a42^2*h^2*lambda*p21n*p32n*w1^3 - 154689425063147520*a42^2*h^2*lambda*p21n*w1^6 + 81294983833190400*a42^2*h^2*lambda*p32n^3*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 101 through 110. -/
private abbrev order72Part07SpeedT_chunk11
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 323768564085657600*a42^2*h^2*lambda*p32n^2*w1^4 + 180470995907005440*a42^2*h^2*lambda*p32n*w1^7 + 23359575280401360*a42^2*h^2*lambda*w1^10 + 205376801262796800*a42^2*h^2*p0*p21n*w1 - 98580864606142464*a42^2*h^2*p0*p32n*s2 - 227625954732933120*a42^2*h^2*p0*p32n*w1^2 - 216786623555174400*a42^2*h^2*p0*s2*w1^3 + 93338685141811200*a42^2*h^2*p0*w1^5 + 195107961199656960*a42^2*h^2*p21n^2*p32n + 156086368959725568*a42^2*h^2*p21n^2*s2*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 111 through 120. -/
private abbrev order72Part07SpeedT_chunk12
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 90327759814656000*a42^2*h^2*p21n^2*w1^3 - 520287896532418560*a42^2*h^2*p21n*p32n^2*w1 - 650359870665523200*a42^2*h^2*p21n*p32n*s2*w1^2 - 58336678213632000*a42^2*h^2*p21n*p32n*w1^4 - 345353135024701440*a42^2*h^2*p21n*s2*w1^5 + 171877138959052800*a42^2*h^2*p21n*w1^7 + 52028789653241856*a42^2*h^2*p32n^3*s2 + 293565219397632000*a42^2*h^2*p32n^3*w1^2 + 560032110850867200*a42^2*h^2*p32n^2*s2*w1^3 - 71948569796812800*a42^2*h^2*p32n^2*w1^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 121 through 130. -/
private abbrev order72Part07SpeedT_chunk13
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 412505133501726720*a42^2*h^2*p32n*s2*w1^6 - 213056036834659200*a42^2*h^2*p32n*w1^8 + 61271017128921600*a42^2*h^2*s2*w1^9 - 37752848938022400*a42^2*h^2*w1^11 - 117064776719794176*a42^2*h*lambda*p1*p21n*w1 + 243884951499571200*a42^2*h*lambda*p1*p32n*w1^2 + 129507425634263040*a42^2*h*lambda*p1*w1^5 - 123226080757678080*a42^2*h*p0*p1 + 136575572839759872*a42^2*h*p0*u2*w1^2 - 98580864606142464*a42^2*h*p1*p21n*s2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 131 through 140. -/
private abbrev order72Part07SpeedT_chunk14
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 227625954732933120*a42^2*h*p1*p21n*w1^2 + 195107961199656960*a42^2*h*p1*p32n^2 + 312172737919451136*a42^2*h*p1*p32n*s2*w1 + 180655519629312000*a42^2*h*p1*p32n*w1^3 + 280016055425433600*a42^2*h*p1*s2*w1^4 - 131905711294156800*a42^2*h*p1*w1^6 - 43129128265187328*a42^2*h*p21n^2*u2 + 273151145679519744*a42^2*h*p21n*p32n*u2*w1 + 245014048497254400*a42^2*h*p21n*u2*w1^4 - 284532443416166400*a42^2*h*p32n^2*u2*w1^2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 141 through 150. -/
private abbrev order72Part07SpeedT_chunk15
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 302183993146613760*a42^2*h*p32n*u2*w1^5 - 6161304037883904*a42^2*h*q1*w1^2 - 52637373806209920*a42^2*h*u2*w1^8 + 18483912113651712*a42^2*lambda*p1^2 + 28436787867156480*a42^2*p0*q53 + 102688400631398400*a42^2*p1^2*w1 - 86258256530374656*a42^2*p1*p32n*u2 - 189688295610777600*a42^2*p1*u2*w1^3 + 97553980599828480*a42^2*p21n*q53*w1^2 - 30806520189419520*a42^2*p32n^2*q53

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 151 through 160. -/
private abbrev order72Part07SpeedT_chunk16
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 11374715146862592*a42^2*p32n*q2 - 135491639721984000*a42^2*p32n*q53*w1^3 + 13007197413310464*a42^2*q2*w1^3 - 35974284898406400*a42^2*q53*w1^6 + 68248290881175552*a42*b63*h*p0*p32n + 78043184479862784*a42*b63*h*p0*w1^3 - 73935648454606848*a42*b63*h*p21n^2*w1 + 234129553439588352*a42*b63*h*p21n*p32n*w1^2 + 84004816627630080*a42*b63*h*p21n*w1^5 - 24645216151535616*a42*b63*h*p32n^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 161 through 170. -/
private abbrev order72Part07SpeedT_chunk17
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 162589967666380800*a42*b63*h*p32n^2*w1^3 - 86338283756175360*a42*b63*h*p32n*w1^6 - 10026166439278080*a42*b63*h*w1^9 + 68248290881175552*a42*b63*p1*p21n - 147871296909213696*a42*b63*p1*p32n*w1 - 81294983833190400*a42*b63*p1*w1^4 - 17062072720293888*a42*h^2*lambda*p0^2 - 117064776719794176*a42*h^2*lambda*p0*p21n*w1^2 + 36967824227303424*a42*h^2*lambda*p0*p32n^2 + 162589967666380800*a42*h^2*lambda*p0*p32n*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 171 through 180. -/
private abbrev order72Part07SpeedT_chunk18
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 43169141878087680*a42*h^2*lambda*p0*w1^6 + 12322608075767808*a42*h^2*lambda*p21n^3 - 117064776719794176*a42*h^2*lambda*p21n^2*p32n*w1 - 105006020784537600*a42*h^2*lambda*p21n^2*w1^4 + 243884951499571200*a42*h^2*lambda*p21n*p32n^2*w1^2 + 259014851268526080*a42*h^2*lambda*p21n*p32n*w1^5 + 45117748976751360*a42*h^2*lambda*p21n*w1^8 - 9755398059982848*a42*h^2*lambda*p32n^4 - 140008027712716800*a42*h^2*lambda*p32n^3*w1^3 - 154689425063147520*a42*h^2*lambda*p32n^2*w1^6

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 181 through 190. -/
private abbrev order72Part07SpeedT_chunk19
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 45953262846691200*a42*h^2*lambda*p32n*w1^9 - 3952251373199220*a42*h^2*lambda*w1^12 - 37915717156208640*a42*h^2*p0^2*w1 - 246452161515356160*a42*h^2*p0*p21n*p32n - 197161729212284928*a42*h^2*p0*p21n*s2*w1 + 43357324711034880*a42*h^2*p0*p21n*w1^3 + 205376801262796800*a42*h^2*p0*p32n^2*w1 + 312172737919451136*a42*h^2*p0*p32n*s2*w1^2 - 112909699768320000*a42*h^2*p0*p32n*w1^4 + 112006422170173440*a42*h^2*p0*s2*w1^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 191 through 200. -/
private abbrev order72Part07SpeedT_chunk20
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 68522447425536000*a42*h^2*p0*w1^7 + 68458933754265600*a42*h^2*p21n^3*w1 - 98580864606142464*a42*h^2*p21n^2*p32n*s2 - 227625954732933120*a42*h^2*p21n^2*p32n*w1^2 - 216786623555174400*a42*h^2*p21n^2*s2*w1^3 + 93338685141811200*a42*h^2*p21n^2*w1^5 + 130071974133104640*a42*h^2*p21n*p32n^3 + 312172737919451136*a42*h^2*p21n*p32n^2*s2*w1 + 180655519629312000*a42*h^2*p21n*p32n^2*w1^3 + 560032110850867200*a42*h^2*p21n*p32n*s2*w1^4

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 201 through 210. -/
private abbrev order72Part07SpeedT_chunk21
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 263811422588313600*a42*h^2*p21n*p32n*w1^6 + 117858609571921920*a42*h^2*p21n*s2*w1^7 - 72411202061452800*a42*h^2*p21n*w1^9 - 86714649422069760*a42*h^2*p32n^4*w1 - 216786623555174400*a42*h^2*p32n^3*s2*w1^2 - 19445559404544000*a42*h^2*p32n^3*w1^4 - 345353135024701440*a42*h^2*p32n^2*s2*w1^5 + 171877138959052800*a42*h^2*p32n^2*w1^7 - 120313997271336960*a42*h^2*p32n*s2*w1^8 + 74035812364113600*a42*h^2*p32n*w1^10

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 211 through 220. -/
private abbrev order72Part07SpeedT_chunk22
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 11325854681406720*a42*h^2*s2*w1^11 + 7431583778665200*a42*h^2*w1^13 + 73935648454606848*a42*h*lambda*p0*p1*w1 + 73935648454606848*a42*h*lambda*p1*p21n*p32n + 162589967666380800*a42*h*lambda*p1*p21n*w1^3 - 117064776719794176*a42*h*lambda*p1*p32n^2*w1 - 210012041569075200*a42*h*lambda*p1*p32n*w1^4 - 44196978589470720*a42*h*lambda*p1*w1^7 + 90997721174900736*a42*h*p0*p1*s2 + 20537680126279680*a42*h*p0*p1*w1^2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 221 through 230. -/
private abbrev order72Part07SpeedT_chunk23
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 79623006028038144*a42*h*p0*p21n*u2 - 172516513060749312*a42*h*p0*p32n*u2*w1 - 94844147805388800*a42*h*p0*u2*w1^4 - 123226080757678080*a42*h*p1*p21n^2 + 410753602525593600*a42*h*p1*p21n*p32n*w1 + 312172737919451136*a42*h*p1*p21n*s2*w1^2 - 112909699768320000*a42*h*p1*p21n*w1^4 - 98580864606142464*a42*h*p1*p32n^2*s2 - 227625954732933120*a42*h*p1*p32n^2*w1^2 - 433573247110348800*a42*h*p1*p32n*s2*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 231 through 240. -/
private abbrev order72Part07SpeedT_chunk24
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 186677370283622400*a42*h*p1*p32n*w1^5 - 115117711674900480*a42*h*p1*s2*w1^6 + 70592396358182400*a42*h*p1*w1^8 + 136575572839759872*a42*h*p21n^2*u2*w1^2 - 86258256530374656*a42*h*p21n*p32n^2*u2 - 379376591221555200*a42*h*p21n*p32n*u2*w1^3 - 9749755840167936*a42*h*p21n*q1 - 100727997715537920*a42*h*p21n*u2*w1^6 + 91050381893173248*a42*h*p32n^3*u2*w1 + 245014048497254400*a42*h*p32n^2*u2*w1^4

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 241 through 250. -/
private abbrev order72Part07SpeedT_chunk25
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 11374715146862592*a42*h*p32n*q1*w1 + 103126283375431680*a42*h*p32n*u2*w1^7 + 3251799353327616*a42*h*q1*w1^4 + 10722427997561280*a42*h*u2*w1^10 - 58532388359897088*a42*lambda*p1^2*w1^2 - 61613040378839040*a42*p0*q53*w1^2 - 123226080757678080*a42*p1^2*p32n - 98580864606142464*a42*p1^2*s2*w1 + 21678662355517440*a42*p1^2*w1^3 - 172516513060749312*a42*p1*p21n*u2*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 251 through 260. -/
private abbrev order72Part07SpeedT_chunk26
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 273151145679519744*a42*p1*p32n*u2*w1^2 + 98005619398901760*a42*p1*u2*w1^5 + 28436787867156480*a42*p21n^2*q53 - 123226080757678080*a42*p21n*p32n*q53*w1 + 22749430293725184*a42*p21n*q2*w1 - 67745819860992000*a42*p21n*q53*w1^4 + 97553980599828480*a42*p32n^2*q53*w1^2 - 24645216151535616*a42*p32n*q2*w1^2 + 70004013856358400*a42*p32n*q53*w1^5 - 5419665588879360*a42*q2*w1^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 261 through 270. -/
private abbrev order72Part07SpeedT_chunk27
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 9207703872806400*a42*q53*w1^8 + 68248290881175552*b63*h*p0*p21n*w1 - 73935648454606848*b63*h*p0*p32n*w1^2 - 16258996766638080*b63*h*p0*w1^5 + 34124145440587776*b63*h*p21n^2*p32n + 39021592239931392*b63*h*p21n^2*w1^3 - 73935648454606848*b63*h*p21n*p32n^2*w1 - 81294983833190400*b63*h*p21n*p32n*w1^4 - 12334040536596480*b63*h*p21n*w1^7 + 39021592239931392*b63*h*p32n^3*w1^2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 271 through 280. -/
private abbrev order72Part07SpeedT_chunk28
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 42002408313815040*b63*h*p32n^2*w1^5 + 11049244647367680*b63*h*p32n*w1^8 + 835513869939840*b63*h*w1^11 - 58498535041007616*b63*p0*p1 - 73935648454606848*b63*p1*p21n*w1^2 + 34124145440587776*b63*p1*p32n^2 + 78043184479862784*b63*p1*p32n*w1^3 + 14000802771271680*b63*p1*w1^6 + 18483912113651712*h^2*lambda*p0^2*w1^2 - 17062072720293888*h^2*lambda*p0*p21n^2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 281 through 290. -/
private abbrev order72Part07SpeedT_chunk29
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 73935648454606848*h^2*lambda*p0*p21n*p32n*w1 + 40647491916595200*h^2*lambda*p0*p21n*w1^4 - 58532388359897088*h^2*lambda*p0*p32n^2*w1^2 - 42002408313815040*h^2*lambda*p0*p32n*w1^5 - 5524622323683840*h^2*lambda*p0*w1^8 - 19510796119965696*h^2*lambda*p21n^3*w1^2 + 18483912113651712*h^2*lambda*p21n^2*p32n^2 + 81294983833190400*h^2*lambda*p21n^2*p32n*w1^3 + 21584570939043840*h^2*lambda*p21n^2*w1^6 - 39021592239931392*h^2*lambda*p21n*p32n^3*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 291 through 300. -/
private abbrev order72Part07SpeedT_chunk30
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 105006020784537600*h^2*lambda*p21n*p32n^2*w1^4 - 44196978589470720*h^2*lambda*p21n*p32n*w1^7 - 4595326284669120*h^2*lambda*p21n*w1^10 + 20323745958297600*h^2*lambda*p32n^4*w1^2 + 43169141878087680*h^2*lambda*p32n^3*w1^5 + 22558874488375680*h^2*lambda*p32n^2*w1^8 + 4247195505527520*h^2*lambda*p32n*w1^11 + 264207280442805*h^2*lambda*w1^14 + 56873575734312960*h^2*p0^2*p32n + 45498860587450368*h^2*p0^2*s2*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 301 through 310. -/
private abbrev order72Part07SpeedT_chunk31
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 27383573501706240*h^2*p0^2*w1^3 - 37915717156208640*h^2*p0*p21n^2*w1 + 90997721174900736*h^2*p0*p21n*p32n*s2 + 20537680126279680*h^2*p0*p21n*p32n*w1^2 + 104057579306483712*h^2*p0*p21n*s2*w1^3 - 63229431870259200*h^2*p0*p21n*w1^5 - 41075360252559360*h^2*p0*p32n^3 - 98580864606142464*h^2*p0*p32n^2*s2*w1 + 21678662355517440*h^2*p0*p32n^2*w1^3 - 108393311777587200*h^2*p0*p32n*s2*w1^4

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 311 through 320. -/
private abbrev order72Part07SpeedT_chunk32
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 66114901975449600*h^2*p0*p32n*w1^6 - 16445387382128640*h^2*p0*s2*w1^7 + 10912834219622400*h^2*p0*w1^9 - 41075360252559360*h^2*p21n^3*p32n - 32860288202047488*h^2*p21n^3*s2*w1 + 7226220785172480*h^2*p21n^3*w1^3 + 102688400631398400*h^2*p21n^2*p32n^2*w1 + 156086368959725568*h^2*p21n^2*p32n*s2*w1^2 - 56454849884160000*h^2*p21n^2*p32n*w1^4 + 56003211085086720*h^2*p21n^2*s2*w1^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 321 through 330. -/
private abbrev order72Part07SpeedT_chunk33
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 34261223712768000*h^2*p21n^2*w1^7 - 32860288202047488*h^2*p21n*p32n^3*s2 - 75875318244311040*h^2*p21n*p32n^3*w1^2 - 216786623555174400*h^2*p21n*p32n^2*s2*w1^3 + 93338685141811200*h^2*p21n*p32n^2*w1^5 - 115117711674900480*h^2*p21n*p32n*s2*w1^6 + 70592396358182400*h^2*p21n*p32n*w1^8 - 13368221919037440*h^2*p21n*s2*w1^9 + 8819313071587200*h^2*p21n*w1^11 + 6503598706655232*h^2*p32n^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 331 through 340. -/
private abbrev order72Part07SpeedT_chunk34
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 26014394826620928*h^2*p32n^4*s2*w1 + 15054626635776000*h^2*p32n^4*w1^3 + 93338685141811200*h^2*p32n^3*s2*w1^4 - 43968570431385600*h^2*p32n^3*w1^6 + 58929304785960960*h^2*p32n^2*s2*w1^7 - 36205601030726400*h^2*p32n^2*w1^9 + 12254203425784320*h^2*p32n*s2*w1^10 - 8061806283640200*h^2*p32n*w1^12 + 810718230399840*h^2*s2*w1^13 - 547985470548040*h^2*w1^15

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 341 through 350. -/
private abbrev order72Part07SpeedT_chunk35
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 34124145440587776*h*lambda*p0*p1*p32n - 39021592239931392*h*lambda*p0*p1*w1^3 + 36967824227303424*h*lambda*p1*p21n^2*w1 - 117064776719794176*h*lambda*p1*p21n*p32n*w1^2 - 42002408313815040*h*lambda*p1*p21n*w1^5 + 12322608075767808*h*lambda*p1*p32n^3 + 81294983833190400*h*lambda*p1*p32n^2*w1^3 + 43169141878087680*h*lambda*p1*p32n*w1^6 + 5013083219639040*h*lambda*p1*w1^9 - 34124145440587776*h*p0^2*u2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 351 through 360. -/
private abbrev order72Part07SpeedT_chunk36
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 113747151468625920*h*p0*p1*p21n - 75831434312417280*h*p0*p1*p32n*w1 - 98580864606142464*h*p0*p1*s2*w1^2 + 59616321477672960*h*p0*p1*w1^4 - 86258256530374656*h*p0*p21n*u2*w1^2 + 39811503014019072*h*p0*p32n^2*u2 + 91050381893173248*h*p0*p32n*u2*w1^3 + 58498535041007616*h*p0*q1 + 16334269899816960*h*p0*u2*w1^6 + 45498860587450368*h*p1*p21n^2*s2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 361 through 370. -/
private abbrev order72Part07SpeedT_chunk37
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 10268840063139840*h*p1*p21n^2*w1^2 - 123226080757678080*h*p1*p21n*p32n^2 - 197161729212284928*h*p1*p21n*p32n*s2*w1 + 43357324711034880*h*p1*p21n*p32n*w1^3 - 108393311777587200*h*p1*p21n*s2*w1^4 + 66114901975449600*h*p1*p21n*w1^6 + 68458933754265600*h*p1*p32n^3*w1 + 156086368959725568*h*p1*p32n^2*s2*w1^2 - 56454849884160000*h*p1*p32n^2*w1^4 + 112006422170173440*h*p1*p32n*s2*w1^5

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 371 through 380. -/
private abbrev order72Part07SpeedT_chunk38
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 68522447425536000*h*p1*p32n*w1^7 + 14732326196490240*h*p1*s2*w1^8 - 9747661815964800*h*p1*w1^10 + 13270501004673024*h*p21n^3*u2 - 86258256530374656*h*p21n^2*p32n*u2*w1 - 47422073902694400*h*p21n^2*u2*w1^4 + 136575572839759872*h*p21n*p32n^2*u2*w1^2 + 98005619398901760*h*p21n*p32n*u2*w1^5 + 5687357573431296*h*p21n*q1*w1^2 + 12890785421928960*h*p21n*u2*w1^8

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 381 through 390. -/
private abbrev order72Part07SpeedT_chunk39
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 7188188044197888*h*p32n^4*u2 - 63229431870259200*h*p32n^3*u2*w1^3 - 4874877920083968*h*p32n^2*q1 - 50363998857768960*h*p32n^2*u2*w1^6 - 4107536025255936*h*p32n*q1*w1^3 - 11697194179157760*h*p32n*u2*w1^9 - 451638799073280*h*q1*w1^6 - 825843570519240*h*u2*w1^12 - 17062072720293888*lambda*p1^2*p21n + 36967824227303424*lambda*p1^2*p32n*w1

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 391 through 400. -/
private abbrev order72Part07SpeedT_chunk40
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 20323745958297600*lambda*p1^2*w1^4 + 79623006028038144*p0*p1*u2*w1 - 48748779200839680*p0*p21n*q53 + 56873575734312960*p0*p32n*q53*w1 - 19499511680335872*p0*q2*w1 + 16258996766638080*p0*q53*w1^4 - 37915717156208640*p1^2*p21n*w1 + 45498860587450368*p1^2*p32n*s2 + 10268840063139840*p1^2*p32n*w1^2 + 52028789653241856*p1^2*s2*w1^3

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 401 through 410. -/
private abbrev order72Part07SpeedT_chunk41
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc - 31614715935129600*p1^2*w1^5 + 79623006028038144*p1*p21n*p32n*u2 + 91050381893173248*p1*p21n*u2*w1^3 - 86258256530374656*p1*p32n^2*u2*w1 - 94844147805388800*p1*p32n*u2*w1^4 - 9749755840167936*p1*q1*w1 - 14389713959362560*p1*u2*w1^7 - 30806520189419520*p21n^2*q53*w1^2 + 28436787867156480*p21n*p32n^2*q53 - 19499511680335872*p21n*p32n*q2

set_option maxHeartbeats 64000000 in
/-- Reducible accumulator step for monomials 411 through 420. -/
private abbrev order72Part07SpeedT_chunk42
    (acc : R)
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  acc + 65035987066552320*p21n*p32n*q53*w1^3 - 8215072050511872*p21n*q2*w1^3 + 11667335642726400*p21n*q53*w1^6 - 20537680126279680*p32n^3*q53*w1 + 11374715146862592*p32n^2*q2*w1 - 33872909930496000*p32n^2*q53*w1^4 + 6503598706655232*p32n*q2*w1^4 - 10278367113830400*p32n*q53*w1^7 + 666704893870080*q2*w1^7 - 835513869939840*q53*w1^10

set_option maxHeartbeats 64000000 in
/-- Remaining factor after `h^3` is removed on the `p32 = h · p32n`,
`p21 = h · p21n` substitution. -/
def degreeZeroPostCollapseP32P21ZeroOrderThreePlus610
    (h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda : R) : R :=
  order72Part07SpeedT_chunk42
    (order72Part07SpeedT_chunk41
    (order72Part07SpeedT_chunk40
    (order72Part07SpeedT_chunk39
    (order72Part07SpeedT_chunk38
    (order72Part07SpeedT_chunk37
    (order72Part07SpeedT_chunk36
    (order72Part07SpeedT_chunk35
    (order72Part07SpeedT_chunk34
    (order72Part07SpeedT_chunk33
    (order72Part07SpeedT_chunk32
    (order72Part07SpeedT_chunk31
    (order72Part07SpeedT_chunk30
    (order72Part07SpeedT_chunk29
    (order72Part07SpeedT_chunk28
    (order72Part07SpeedT_chunk27
    (order72Part07SpeedT_chunk26
    (order72Part07SpeedT_chunk25
    (order72Part07SpeedT_chunk24
    (order72Part07SpeedT_chunk23
    (order72Part07SpeedT_chunk22
    (order72Part07SpeedT_chunk21
    (order72Part07SpeedT_chunk20
    (order72Part07SpeedT_chunk19
    (order72Part07SpeedT_chunk18
    (order72Part07SpeedT_chunk17
    (order72Part07SpeedT_chunk16
    (order72Part07SpeedT_chunk15
    (order72Part07SpeedT_chunk14
    (order72Part07SpeedT_chunk13
    (order72Part07SpeedT_chunk12
    (order72Part07SpeedT_chunk11
    (order72Part07SpeedT_chunk10
    (order72Part07SpeedT_chunk09
    (order72Part07SpeedT_chunk08
    (order72Part07SpeedT_chunk07
    (order72Part07SpeedT_chunk06
    (order72Part07SpeedT_chunk05
    (order72Part07SpeedT_chunk04
    (order72Part07SpeedT_chunk03
    (order72Part07SpeedT_chunk02
    (order72Part07SpeedT_chunk01 h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda) h w1 a42 p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 lambda

-- Eagerly realize the owner equation before independent downstream consumers.
#print axioms degreeZeroPostCollapseP32P21ZeroOrderThreePlus610.eq_1
...
/-- Combined order-`72` mixin on `p32 = h · p32n`, `q41 = h · q41n`,
`q3 = h · q3n`. -/
def degreeZeroPostCollapseP32Q41Q3ZeroOrderThreeHead610
    (w1 a42 p32n p21 p1 p0 s2 u2 b63 q53 q41n q3n q2 lambda : R) : R :=
  -20537680126279680*a42^3*p21*q53 + 22749430293725184*a42^2*p1*q41n - 61613040378839040*a42^2*p1*q53*w1 - 43129128265187328*a42^2*p21^2*u2 + 17062072720293888*a42^2*p21*q3n - 49290432303071232*a42^2*p21*q41n*w1 + 97553980599828480*a42^2*p21*q53*w1^2 + 68248290881175552*a42*b63*p1*p21 - 73935648454606848*a42*b63*p21^2*w1 + 12322608075767808*a42*lambda*p21^3 + 39811503014019072*a42*p1^2*u2 - 123226080757678080*a42*p1*p21^2 - 172516513060749312*a42*p1*p21*u2*w1 + 56873575734312960*a42*p1*p32n*q53 - 19499511680335872*a42*p1*q2 + 34124145440587776*a42*p1*q3n*w1 - 49290432303071232*a42*p1*q41n*w1^2 + 65035987066552320*a42*p1*q53*w1^3 + 68458933754265600*a42*p21^3*w1 + 136575572839759872*a42*p21^2*u2*w1^2 + 45498860587450368*a42*p21*p32n*q41n - 123226080757678080*a42*p21*p32n*q53*w1 + 22749430293725184*a42*p21*q2*w1 - 36967824227303424*a42*p21*q3n*w1^2 + 52028789653241856*a42*p21*q41n*w1^3 - 67745819860992000*a42*p21*q53*w1^4 + 34124145440587776*b63*p1^2*w1 - 73935648454606848*b63*p1*p21*w1^2 + 34124145440587776*b63*p21^2*p32n + 39021592239931392*b63*p21^2*w1^3 - 17062072720293888*lambda*p1^2*p21 + 36967824227303424*lambda*p1*p21^2*w1 - 19510796119965696*lambda*p21^3*w1^2 - 48748779200839680*p0*p21*q53 + 18957858578104320*p1^3 - 37915717156208640*p1^2*p21*w1 - 43129128265187328*p1^2*u2*w1^2 + 45498860587450368*p1*p21^2*s2 + 10268840063139840*p1*p21^2*w1^2 + 79623006028038144*p1*p21*p32n*u2 + 91050381893173248*p1*p21*u2*w1^3 - 29249267520503808*p1*p32n*q3n + 45498860587450368*p1*p32n*q41n*w1 - 61613040378839040*p1*p32n*q53*w1^2 + 11374715146862592*p1*q2*w1^2 - 12322608075767808*p1*q3n*w1^3 + 13007197413310464*p1*q41n*w1^4 - 13549163972198400*p1*q53*w1^5 - 41075360252559360*p21^3*p32n - 32860288202047488*p21^3*s2*w1 + 7226220785172480*p21^3*w1^3 - 86258256530374656*p21^2*p32n*u2*w1 - 47422073902694400*p21^2*u2*w1^4 + 28436787867156480*p21*p32n^2*q53 - 19499511680335872*p21*p32n*q2 + 34124145440587776*p21*p32n*q3n*w1 - 49290432303071232*p21*p32n*q41n*w1^2 + 65035987066552320*p21*p32n*q53*w1^3 - 8215072050511872*p21*q2*w1^3 + 9755398059982848*p21*q3n*w1^4 - 10839331177758720*p21*q41n*w1^5 + 11667335642726400*p21*q53*w1^6
...
theorem degreeZeroPostCollapseP32P21P1ZeroOrderThreeHead610_eval
    (w1 a42 p32n p21n p1n p0 q41 q3 : k[X]) (a : k) :
    (degreeZeroPostCollapseP32P21P1ZeroOrderThreeHead610 w1 a42 p32n
        p21n p1n p0 q41 q3).eval a =
  ...
  simp only [degreeZeroPostCollapseP32P21P1ZeroOrderThreeHead610,
...
theorem degreeZeroPostCollapseP32P21P1ZeroOrderThreePlus610_eval
    ...
    (degreeZeroPostCollapseP32P21P1ZeroOrderThreePlus610 h w1 a42 p32n
      ...
      degreeZeroPostCollapseP32P21P1ZeroOrderThreePlus610 (h.eval a)
        (w1.eval a) (a42.eval a) (p32n.eval a) (p21n.eval a)
        (p1n.eval a) (p0.eval a) (s2.eval a) (u2.eval a) (b63.eval a)
        (q53.eval a) (q41.eval a) (q3.eval a) (q2.eval a) (q1.eval a)
        lambda := by
...
theorem degreeZeroPostCollapseP32P21ZeroOrderThreePlus610_eval
    ...
    (degreeZeroPostCollapseP32P21ZeroOrderThreePlus610 h w1 a42 p32n
        ...
        (Polynomial.C lambda)).eval a =
      degreeZeroPostCollapseP32P21ZeroOrderThreePlus610 (h.eval a)
        (w1.eval a) (a42.eval a) (p32n.eval a) (p21n.eval a)
...
theorem degreeZeroPostCollapseP32Q41Q3ZeroOrderThreePlus610_eval
    ...
    (degreeZeroPostCollapseP32Q41Q3ZeroOrderThreePlus610 h w1 a42 p32n
        ...
        (Polynomial.C lambda)).eval a =
      degreeZeroPostCollapseP32Q41Q3ZeroOrderThreePlus610 (h.eval a)
        (w1.eval a) (a42.eval a) (p32n.eval a) (p21.eval a) (p1.eval a)
...
set_option maxHeartbeats 800000000 in
/-- On `p32(a) = p21(a) = 0` with vanishing order-`71` head, pole-three
forces the next Taylor of that head plus the order-`72` mixin to
vanish. -/
theorem degreeZeroPostCollapseP32P21ZeroOrderThreeHead610_zero_of_primitiveDeriv
    (h0 w1 a42 p32 p21 p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 : k[X])
    (lambda j a : k) (hh0 : h0 ≠ 0) (hdegree : h0.natDegree = 1)
    (hroot : h0.eval a = 0) (hp32 : p32.eval a = 0)
    (hp21 : p21.eval a = 0)
    ...
    ∃ p32n p21n o71n : k[X],
      p32 = h0 * p32n ∧ p21 = h0 * p21n ∧
        ...
        o71n.eval a +
            degreeZeroPostCollapseP32P21ZeroOrderThreeHead610
              (w1.eval a) (a42.eval a) (p32n.eval a) (p21n.eval a)
              (p1.eval a) (p0.eval a) (u2.eval a) (b63.eval a)
              (q53.eval a) (q41.eval a) (q3.eval a) (q2.eval a) =
          0 := by
  let hRF : RatFunc k := algebraMap k[X] (RatFunc k) h0
  let quotient : k[X] := degreeZeroPostCollapseJetQuotient610 h0 w1 a42
    p32 p21 p1 p0 s2 u2 b63 q53 q41 q3 q2 q1 (Polynomial.C lambda)
  ...
  have hident :
      Q2 =
        degreeZeroPostCollapseP32P21ZeroOrderTwoHead610 w1 a42 p32n
          ...
          h0 ^ 2 *
            degreeZeroPostCollapseP32P21ZeroOrderThreePlus610 h0 w1 a42
              p32n p21n p1 p0 s2 u2 b63 q53 q41 q3 q2 q1
              (Polynomial.C lambda) := by
    apply mul_left_cancel₀ hh0
    apply mul_left_cancel₀ hh0
    calc
  ...
  have ho71zero :
      (degreeZeroPostCollapseP32P21ZeroOrderTwoHead610 w1 a42 p32n p21n
          p1 q53 q41 q3).eval a = 0 := by
    rw [← hQ2eval]
    exact hQ2zero
  obtain ⟨o71n, ho71eq⟩ := linearPolynomial_dvd_of_eval_eq_zero_610 h0
    (degreeZeroPostCollapseP32P21ZeroOrderTwoHead610 w1 a42 p32n p21n
      p1 q53 q41 q3) a hdegree hroot ho71zero
  have hQ3ident :
      Q3 =
        o71n +
          degreeZeroPostCollapseP32P21ZeroOrderThreeHead610 w1 a42 p32n
    ...
    calc
      h0 * Q3 = Q2 := hQ2eq.symm
      _ = degreeZeroPostCollapseP32P21ZeroOrderTwoHead610 w1 a42 p32n
            p21n p1 q53 q41 q3 +
          h0 *
            degreeZeroPostCollapseP32P21ZeroOrderThreeHead610 w1 a42
              p32n p21n p1 p0 u2 b63 q53 q41 q3 q2 +
  ...
  have hQ3eval :
      Q3.eval a =
        o71n.eval a +
          degreeZeroPostCollapseP32P21ZeroOrderThreeHead610 (w1.eval a)
            (a42.eval a) (p32n.eval a) (p21n.eval a) (p1.eval a)
            (p0.eval a) (u2.eval a) (b63.eval a) (q53.eval a)
            (q41.eval a) (q3.eval a) (q2.eval a) := by
    rw [hQ3ident]
    simp only [Polynomial.eval_add, Polynomial.eval_mul, hroot,
      degreeZeroPostCollapseP32P21ZeroOrderThreeHead610_eval]
    ring
  refine ⟨p32n, p21n, o71n, hp32eq, hp21eq, ho71eq, ?_⟩
  rw [← hQ3eval]
  exact hQ3zero
...
theorem degreeZeroPostCollapseQ41ZeroMixedOrderOne610_zero_of_source
    (p q : k[X][X]) (H h0 : k[X]) (j lambda a : k)
    (w1 a42 p32 p21 s2 u2 b63 q53 q41 : k[X])
    (hp : p.natDegree = 6) (hq : q.natDegree = 10)
    (hh0 : h0 ≠ 0) (hh0degree : h0.natDegree = 1) (hH : H = h0 ^ 2)
