import LowScale68SecondaryFirstGapBoundaryFace

/-! # Closure of the first-gap boundary `2g = n`

The classified first-load wall has zero leading load and an attained residual
gap.  This module extracts its row-two and row-one residual faces, forces the
balanced chamber, excludes that chamber by its nonzero row-one coefficient,
and closes the residual double face.  Together these cases prove that the
canonical expanded lower system cannot lie on `2g = n`.
-/
...
section FirstGapBoundaryClosure68
...
theorem firstGap_natDegree_mul_derivative_lt68
    (p q : k[X]) (u v : ℕ)
...
theorem firstGap_natDegree_derivative_mul_lt68
    (p q : k[X]) (u v : ℕ)
...
set_option maxHeartbeats 2000000 in
theorem secondaryLoadInvariantFourPolynomial68_degree_lt_cubicFace_of_firstLoadWall
    (beta gamma delta epsilon zeta : k) (A B c D e : k[X])
    (n g h : ℕ) (hg : 0 < g) (hgh : g < h) (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (hD : D.natDegree ≤ 5 * n - g)
...
set_option maxHeartbeats 2000000 in
theorem secondaryLoadInvariantThreePolynomial68_degree_lt_cubicFace_of_firstLoadWall
    (beta gamma delta epsilon zeta : k) (A B c D e : k[X])
    (n g h : ℕ) (hg : 0 < g) (hgh : g < h) (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_Q_degree_lt68_of_firstLoadWall
    (A B c d e : k[X]) (n g : ℕ)
    (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have h1 := firstGap_natDegree_mul_derivative_lt68 A
    (residualIncidenceQ68 B c d e) (2 * n) (9 * n - 3 * g) hA hv hQ
  have h2 := firstGap_natDegree_derivative_mul_lt68 A
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_Bd_degree_le68_of_firstLoadWall
    (B d : k[X]) (n g h : ℕ)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_BcCore_degree_le68_of_firstLoadWall
    (A B c : k[X]) (n g : ℕ)
    (hg : 0 < g) (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwoInner_de_degree_le68_of_firstLoadWall
    (d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g) (hwall : 2 * g = n)
    (hd : d.natDegree ≤ 5 * n - h)
    (he : e.natDegree ≤ 6 * n - h) :
...
theorem residualRowTwo_coeff_leftChamber68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (hd : d.natDegree ≤ 5 * n - h)
  ...
  have hidx : 11 * n - 3 * g - 1 < idx := by
    dsimp [idx]
    omega
  have hQdeg := residualRowTwoInner_Q_degree_lt68_of_firstLoadWall A B c d e n g hwall hA hQ
  have hAQ : (A * derivative Q).natDegree < idx := hQdeg.1.trans hidx
  have hAQ' : (derivative A * Q).natDegree < idx := hQdeg.2.trans hidx
  have hcore := residualRowTwoInner_BcCore_degree_le68_of_firstLoadWall A B c n g hg hwall hA hB hc
  ...
  have hBd := residualRowTwoInner_Bd_degree_le68_of_firstLoadWall B d n g h hg hgh hh hwall hB hd
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwo_leftChamber_ne_zero68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowTwoPolynomial68 A B c d e).coeff
        (11 * n - 2 * h - 1) ≠ 0 := by
  rw [residualRowTwo_coeff_leftChamber68_of_firstLoadWall A B c d e n g h hg hgh hh hwall hleft
    hA hB hc hd he hQ]
...
set_option maxHeartbeats 4000000 in
theorem residualRowTwo_coeff_rightChamber68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hright : 3 * g < 2 * h)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (hd : d.natDegree ≤ 5 * n - h)
  ...
  have hBd' : (derivative (B ^ 2 * d)).natDegree < idx := by
    dsimp [idx]
    omega
  have hde := residualRowTwoInner_de_degree_le68_of_firstLoadWall d e n g h hg hgh hh hwall hd he
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwo_rightChamber_ne_zero68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hright : 3 * g < 2 * h)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowTwoPolynomial68 A B c d e).coeff
        (11 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowTwo_coeff_rightChamber68_of_firstLoadWall A B c d e n g h hg hgh hh hwall hright
...
set_option maxHeartbeats 2000000 in
theorem residualBalancedRowTwoInner_Q_degree_lt68_of_firstLoadWall
    (A B c d e : k[X]) (n g : ℕ)
    (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
...
set_option maxHeartbeats 2000000 in
theorem residualBalancedRowTwoInner_Bd_degree_le68_of_firstLoadWall
    (B d : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g) (hwall : 2 * g = n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hd : d.natDegree ≤ 5 * n - h) :
...
theorem residualRowTwo_coeff_balancedChamber68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
    (hd : d.natDegree ≤ 5 * n - h)
  ...
  have hQdeg := residualBalancedRowTwoInner_Q_degree_lt68_of_firstLoadWall A B c d e n g hwall hA hQ
  have hAQ : (A * derivative Q).natDegree < idx := by
    dsimp [idx]
    exact hQdeg.1
  have hAQ' : (derivative A * Q).natDegree < idx := by
    dsimp [idx]
    exact hQdeg.2
  have hBd := residualBalancedRowTwoInner_Bd_degree_le68_of_firstLoadWall B d n g h hg hgh hh hwall hB hd
  have hBd' : (derivative (B ^ 2 * d)).natDegree < idx := by
    dsimp [idx]
    omega
  have hB2deg : (B ^ 2).natDegree ≤ 6 * n - 2 * g := by
...
theorem residualRowTwo_balanced_coeff_eq_zero_iff68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  rw [residualRowTwo_coeff_balancedChamber68_of_firstLoadWall A B c d e n g h hg hgh hh hwall
...
theorem residualRowTwo_add_load_eq_zero_imp_balancedRelation68_of_firstLoadWall
  ...
  have hcoeff :
    ...
    exact h
  exact (residualRowTwo_balanced_coeff_eq_zero_iff68_of_firstLoadWall A B c d e n g h hg hgh hh
    hwall hbalanced hA hB hc hd he hQ hdisc).1 hcoeff

theorem residualRowTwo_eq_zero_imp_balancedRelation68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
...
theorem residualRowOne_coeff_balancedChamber68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hI3low : (A * derivative I3).natDegree < idx := by
    ...
    have h := firstGap_natDegree_mul_derivative_lt68 A I3
...
set_option maxHeartbeats 2000000 in
theorem residualRowOne_coeff_balancedChamber_eq68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  rw [residualRowOne_coeff_balancedChamber68_of_firstLoadWall A B c d e n g h hg hgh hh hwall
...
theorem residualRowOne_balanced_coeff_ne_zero68_of_firstLoadWall
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowOnePolynomial68 A B c d e).coeff
        (12 * n - 3 * g - 1) ≠ 0 := by
  rw [residualRowOne_coeff_balancedChamber_eq68_of_firstLoadWall A B c d e n g h hg hgh hh
    hwall hbalanced hA hB hcdeg hd he hI3 hc0 hdisc hinc hrel]
  have hcast4 : (((4 * n - g : ℕ) : k)) =
      (4 : k) * (n : k) - (g : k) := by
    rw [Nat.cast_sub (by omega : g ≤ 4 * n)]
    push_cast
...
theorem residualRowOne_add_load_eq_zero_imp_false68_of_firstLoadWall
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hbalanced : 2 * h = 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hcoeff :
    ...
    rw [coeff_add, coeff_zero, coeff_eq_zero_of_natDegree_lt hload,
      add_zero] at h
    exact h
  exact residualRowOne_balanced_coeff_ne_zero68_of_firstLoadWall A B c d e n g h hg hgh hh
    hwall hbalanced hA hB hcdeg hd he hI3 hc0 hdisc hinc hrel hcoeff

set_option maxHeartbeats 2000000 in
theorem residualRowTwo_not_leftChamber68_of_firstLoadWall
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
  ...
  exact residualRowTwo_leftChamber_ne_zero68_of_firstLoadWall A B c d e n g h
    hg hgh hh hwall hleft hA hB hc hd he hQ hd0 he0 hcoeff0

set_option maxHeartbeats 2000000 in
theorem residualRowTwo_not_rightChamber68_of_firstLoadWall
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n) (hright : 3 * g < 2 * h)
    (hA : A.natDegree ≤ 2 * n)
  ...
  exact residualRowTwo_rightChamber_ne_zero68_of_firstLoadWall A B c d e n g h
    hg hgh hh hwall hright hA hB hc hd he hQ hdisc ha0 hb0 hcoeff0

set_option maxHeartbeats 2000000 in
theorem residualSelectedGap_eq_balanced68_of_firstLoadWall
    (A B c d e load : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  · exact (residualRowTwo_not_leftChamber68_of_firstLoadWall A B c d e load n g h
      hg hgh hh hwall hleft hA hB hc hd he hQ hload hsum hd0 he0).elim
  · exact heq
  · exact (residualRowTwo_not_rightChamber68_of_firstLoadWall A B c d e load n g h
      hg hgh hh hwall hright hA hB hc hd he hQ hload hsum hdisc hb0 hc0).elim
...
theorem secondaryResidualDoubleFace68_impossible_of_firstLoadWall
  ...
  exact secondaryResidualTiedDoubleFace68_impossible_of_firstLoadWall
    n g a b c d e ha hb hc hn hwall hface
...
theorem polynomialSecondaryResidualDoubleFace68_of_firstLoadWall
  ...
  have hinv := polynomialSecondaryResidualDoubleInvariants68_of_firstLoadWall
    beta gamma delta epsilon zeta i4 i3 A B c d e n g hg hwall
  ...
  rw [hcoords.t_eq, hcoords.u_eq, hcoords.v_eq,
    ...
    secondaryResidualRowOnePolynomial68_coeff_double_of_firstLoadWall A B c d e n g
  ...
  rw [hcoords.u_eq, hcoords.v_eq, cubicRowZeroPolynomial68_split,
    ...
    secondaryResidualRowZeroPolynomial68_coeff_double_of_firstLoadWall A B c d e n g
      hg hwall hA hB hc hd he,
    coeff_eq_zero_of_natDegree_lt
...
set_option maxHeartbeats 2000000 in
theorem residualSelectedGap_eq_balanced68_of_rowTwoSystem_of_firstLoadWall
    (alpha beta gamma delta epsilon zeta eta : k)
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hwall : 2 * g = n)
  ...
  exact residualSelectedGap_eq_balanced68_of_firstLoadWall A B c d e
    (cubicLoadRowTwoPolynomial68 0 alpha beta gamma delta epsilon zeta eta
      A B c ((1 / 3 : k) • (A * B) + d) e)
    n g h hg hgh hh hwall hA hB hc hd he hQ hload hsum hdisc hb0 hc0 hd0 he0

set_option maxHeartbeats 3000000 in
theorem secondaryResidualIncidenceDefectPolynomial68_degree_lt_cubicFace_of_firstLoadWall
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    omega
  have hload :=
    secondaryLoadInvariantFourPolynomial68_degree_lt_cubicFace_of_firstLoadWall
      beta gamma delta epsilon zeta A B c D e n g h hg hgh hwall
      hA hB hc hD he
  have hsplit := hi4
...
set_option maxHeartbeats 2000000 in
theorem secondaryResidualInvariantThreePolynomial68_degree_lt_cubicFace_of_firstLoadWall
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    omega
  have hload :=
    secondaryLoadInvariantThreePolynomial68_degree_lt_cubicFace_of_firstLoadWall
      beta gamma delta epsilon zeta A B c D e n g h hg hgh hwall
      hA hB hc hD he
  have hsplit := hi3
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_firstLoadWallResidualDoubleFace68
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_firstGapBoundary_impossible68
    (l alpha beta gamma delta epsilon zeta eta terminal : k)
    (A B C0 D E : k[X]) (hterminal : terminal ≠ 0)
    (hsys : IntegratedPolynomialLowerSystem68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E)
  ...
  change 2 * g = n at hwall
  have hgap :=
    maximalExpandedIntegratedPolynomialLowerSystem_firstLoadWallResidualGap68
      l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
      hterminal hsys (by
        simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g] using hwall)
  change l = 0 ∧
  ...
  by_cases hh : h < 2 * g
  · have hface :=
      maximalExpandedIntegratedPolynomialLowerSystem_firstLoadWallResidualMiddleFace68
    ...
    have hQ :
      ...
      have hq :=
        secondaryResidualIncidenceDefectPolynomial68_degree_lt_cubicFace_of_firstLoadWall
          beta gamma delta epsilon zeta i4 Ae Be ce d ee n g h
          hg0 hgh hwall hA hB hcdeg hbounds.1 hbounds.2 hi4c
    ...
    have hload2 :
        (cubicLoadRowTwoPolynomial68 0 alpha beta gamma delta epsilon zeta eta
          Ae Be ce ((1 / 3 : k) • (Ae * Be) + d) ee).natDegree <
            11 * n - 3 * g - 1 :=
      cubicLoadRowTwoPolynomial68_degree_lt_cubicFace_of_firstLoadWall
        alpha beta gamma delta epsilon zeta eta Ae Be ce d ee n g h
        hg0 hgh hwall hA hB hcdeg hbounds.1 hbounds.2
    ...
    have hrowTwo :
      ...
      exact h2e
    have hbalanced :=
      residualSelectedGap_eq_balanced68_of_rowTwoSystem_of_firstLoadWall
        alpha beta gamma delta epsilon zeta eta Ae Be ce d ee n g h
        hg0 hgh hh hwall hA hB hcdeg hbounds.1 hbounds.2 hQ hload2 hrowTwo
    ...
    have hrel :=
      residualRowTwo_add_load_eq_zero_imp_balancedRelation68_of_firstLoadWall
        Ae Be ce d ee
        (cubicLoadRowTwoPolynomial68 0 alpha beta gamma delta epsilon zeta eta
          Ae Be ce ((1 / 3 : k) • (Ae * Be) + d) ee)
        n g h hg0 hgh hh hwall hbalanced hA hB hcdeg hbounds.1 hbounds.2
        hQb hclass.2.2.2.2 hload2 hsum2
    have hI3deg :=
      secondaryResidualInvariantThreePolynomial68_degree_lt_cubicFace_of_firstLoadWall
        beta gamma delta epsilon zeta i3 Ae Be ce d ee n g h
        hg0 hgh hwall hA hB hcdeg hbounds.1 hbounds.2 hi3c
    have h1e : lowerRowOnePolynomial68
        (integratedTPolynomial68 l alpha beta gamma epsilon Ae Be Ce De Ee)
        (integratedUPolynomial68 l alpha beta gamma delta zeta Ae Be Ce De Ee)
        (integratedVPolynomial68 l alpha beta gamma delta epsilon eta
    ...
    have hload1 :=
      cubicLoadRowOnePolynomial68_degree_lt_cubicFace_of_firstLoadWall
        alpha beta gamma delta epsilon zeta eta Ae Be ce d ee n g h
        hg0 hgh hwall hA hB hcdeg hbounds.1 hbounds.2
    exact residualRowOne_add_load_eq_zero_imp_false68_of_firstLoadWall
      Ae Be ce d ee
  ...
  · have hdouble : d.natDegree ≤ 5 * n - 2 * g ∧
      ...
      constructor <;> omega
    have hface :=
      maximalExpandedIntegratedPolynomialLowerSystem_firstLoadWallResidualDoubleFace68
        l alpha beta gamma delta epsilon zeta eta terminal A B C0 D E
        hterminal hsys (by
          simpa only [n, Ae, Be, Ce, ce, De, Ee, ee, g] using hwall)
        (by
    ...
    exact secondaryResidualDoubleFace68_impossible_of_firstLoadWall n g
      (Ae.coeff (2 * n)) (Be.coeff (3 * n - g))
      (ce.coeff (4 * n - g)) (d.coeff (5 * n - 2 * g))
      (ee.coeff (6 * n - 2 * g)) ha hsupport hn hwall hface.2

end FirstGapBoundaryClosure68

#print axioms firstGap_natDegree_mul_derivative_lt68
...
#print axioms residualSelectedGap_eq_balanced68_of_firstLoadWall
#print axioms residualRowOne_add_load_eq_zero_imp_false68_of_firstLoadWall
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_firstLoadWallResidualDoubleFace68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_firstGapBoundary_impossible68
