...
theorem quarticRefinedBCDEFG102L2810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest6006810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest6006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz0 (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) hz0zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := kappaQuarticChamberFace6006810_coeff_top hBne hCne hFne hGne (A := A) (D := D) (E := E) (by omega) (by omega)
  ...
  have hr1 : (muQuarticChamberRest6003810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest6003810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hz2zeta : zeta = 0 ∨ (3 * A.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * B.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree ∧ E.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr2 : (nuQuarticChamberRest6006810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + B.natDegree + 2 * C.natDegree :=
    nuQuarticChamberRest6006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) hz2zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := nuQuarticChamberFace6006810_coeff_top hAne hBne hCne hDne hFne hGne (E := E) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hnu]
    omega
  rw [degreeZeroNuQuartic810_eq_face6006_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr2,
    add_zero] at hq2
  have hin2 : (15 / 1024 : k) * A.leadingCoeff * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 128 : k) * A.leadingCoeff * B.leadingCoeff * G.leadingCoeff + (-5 / 128 : k) * A.leadingCoeff * C.leadingCoeff * F.leadingCoeff + (-15 / 128 : k) * C.leadingCoeff ^ 2 * D.leadingCoeff + (5 / 16 : k) * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct2.symm.trans hq2
  ...
  have hz3delta : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ 3 * B.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr3 : (xiQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree :=
    xiQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct3 := xiQuarticChamberFace6004810_coeff_top hAne hBne hCne hDne hFne (E := E) (G := G) (by omega) (by omega)
  ...
  have hz4zeta : zeta = 0 ∨ (4 * A.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + C.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ A.natDegree + 2 * B.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ B.natDegree + D.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * C.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ G.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr4 : (omicronQuarticChamberRest6006810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree :=
    omicronQuarticChamberRest6006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct4 := omicronQuarticChamberFace6006810_coeff_top hAne hBne hCne hDne hFne hGne (E := E) (by omega) (by omega) (by omega) (by omega)
  have hq4 : (degreeZeroOmicronQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [homi]
    omega
  rw [degreeZeroOmicronQuartic810_eq_face6006_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr4,
    add_zero] at hq4
  have hin4 : (15 / 16384 : k) * A.leadingCoeff ^ 2 * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 2048 : k) * A.leadingCoeff ^ 2 * B.leadingCoeff * G.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 2 * C.leadingCoeff * F.leadingCoeff + (15 / 1024 : k) * A.leadingCoeff * C.leadingCoeff ^ 2 * D.leadingCoeff + (-5 / 128 : k) * A.leadingCoeff * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct4.symm.trans hq4
  ...
  have hr5 : (piQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz5 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz5l hz5beta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hz6zeta : zeta = 0 ∨ (5 * A.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 3 * A.natDegree + C.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + E.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * B.natDegree + C.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ B.natDegree + F.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ C.natDegree + E.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * D.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr6 : (primitiveQuarticChamberRest6006810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree :=
    primitiveQuarticChamberRest6006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  have hct6 := primitiveQuarticChamberFace6006810_coeff_top hAne hBne hCne hDne hFne hGne (E := E) (by omega) (by omega) (by omega) (by omega)
  have hq6 : (degreeZeroPrimitiveQuartic810 l beta gamma delta epsilon zeta eta theta
    ...
    rw [hprim]
    omega
  rw [degreeZeroPrimitiveQuartic810_eq_face6006_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr6,
    add_zero] at hq6
  have hin6 : (15 / 16384 : k) * A.leadingCoeff ^ 3 * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 2048 : k) * A.leadingCoeff ^ 3 * B.leadingCoeff * G.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 3 * C.leadingCoeff * F.leadingCoeff + (15 / 2048 : k) * A.leadingCoeff ^ 2 * C.leadingCoeff ^ 2 * D.leadingCoeff + (-5 / 256 : k) * A.leadingCoeff ^ 2 * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct6.symm.trans hq6
  ...
  have hr7 : (n2QuarticChamberRest6000810 l beta gamma delta epsilon zeta eta theta
    ...
    n2QuarticChamberRest6000810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz7 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz7l hz7beta (Or.inr (by omega)) hz7delta (Or.inr (by omega)) hz7zeta (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hr8 : (n3QuarticChamberRest6000810 l beta gamma delta epsilon zeta eta theta
    ...
    n3QuarticChamberRest6000810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz8 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz8l hz8beta (Or.inr (by omega)) hz8delta (Or.inr (by omega)) hz8zeta (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hz9l : l = 0 ∨ (8 * A.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 6 * A.natDegree + C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 5 * A.natDegree + 2 * B.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 5 * A.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 4 * A.natDegree + B.natDegree + D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 4 * A.natDegree + 2 * C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * B.natDegree + C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + 4 * B.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 4 * A.natDegree + G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 3 * A.natDegree + C.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 3 * A.natDegree + 2 * D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + B.natDegree + C.natDegree + D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + 3 * C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + 3 * B.natDegree + D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + 2 * C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 4 * B.natDegree + C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + C.natDegree + G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + D.natDegree + F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * A.natDegree + 2 * E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + 2 * B.natDegree + G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + C.natDegree + F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + D.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + 2 * C.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + C.natDegree + 2 * D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 3 * B.natDegree + F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * B.natDegree + C.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * B.natDegree + 2 * D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ B.natDegree + 2 * C.natDegree + D.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 4 * C.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ A.natDegree + 2 * F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ B.natDegree + D.natDegree + G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ B.natDegree + E.natDegree + F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * C.natDegree + G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ C.natDegree + D.natDegree + F.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ C.natDegree + 2 * E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * D.natDegree + E.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree ∧ 2 * G.natDegree < 2 * A.natDegree + 2 * C.natDegree + D.natDegree) := by
    rcases h5bl with h | h | h | h | h | h | h | h | h | h | h | h | h | h | h
    · exact Or.inl h
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  ...
  have hr9 : (n4QuarticChamberRest6000810 l beta gamma delta epsilon zeta eta theta
    ...
    n4QuarticChamberRest6000810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz9 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz9l hz9beta (Or.inr (by omega)) hz9delta (Or.inr (by omega)) hz9zeta (Or.inr (by omega)) (Or.inr (by omega))
  ...
  exact quarticUnownedSystemBCDEFG102L2810_cert A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hin5 hin6 hin7 hin8 hin9 hCc hDc hFc
...
theorem quarticRefinedBCDEFG102L5810_impossible
  ...
  have hz0zeta : zeta = 0 ∨ (2 * A.natDegree < B.natDegree + 2 * C.natDegree ∧ C.natDegree < B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr0 : (kappaQuarticChamberRest6008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < B.natDegree + 2 * C.natDegree :=
    kappaQuarticChamberRest6008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  have hct0 := kappaQuarticChamberFace6008810_coeff_top hBne hCne hDne hEne hFne hGne (A := A) (by omega) (by omega) (by omega)
  have hq0 : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (B.natDegree + 2 * C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hkap]
    omega
  rw [degreeZeroKappaQuartic810_eq_face6008_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr0,
    add_zero] at hq0
  have hin0 : (-15 / 128 : k) * B.leadingCoeff * C.leadingCoeff ^ 2 + (5 / 16 : k) * B.leadingCoeff * G.leadingCoeff + (5 / 16 : k) * C.leadingCoeff * F.leadingCoeff + (5 / 16 : k) * D.leadingCoeff * E.leadingCoeff = 0 :=
    hct0.symm.trans hq0
  have hdp1 : 0 < A.natDegree + 2 * D.natDegree := by
    omega
  have hdz1 : 0 < A.natDegree + 2 * D.natDegree := by omega
  ...
  have hz2zeta : zeta = 0 ∨ (3 * A.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * B.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree ∧ E.natDegree < A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr2 : (nuQuarticChamberRest6008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + B.natDegree + 2 * C.natDegree :=
    nuQuarticChamberRest6008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz2 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) hz2zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := nuQuarticChamberFace6008810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + B.natDegree + 2 * C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hnu]
    omega
  rw [degreeZeroNuQuartic810_eq_face6008_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr2,
    add_zero] at hq2
  have hin2 : (15 / 1024 : k) * A.leadingCoeff * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 128 : k) * A.leadingCoeff * B.leadingCoeff * G.leadingCoeff + (-5 / 128 : k) * A.leadingCoeff * C.leadingCoeff * F.leadingCoeff + (-5 / 128 : k) * A.leadingCoeff * D.leadingCoeff * E.leadingCoeff + (-15 / 128 : k) * C.leadingCoeff ^ 2 * D.leadingCoeff + (5 / 16 : k) * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct2.symm.trans hq2
  have hdp3 : 0 < A.natDegree + B.natDegree + C.natDegree + D.natDegree := by
    omega
  have hdz3 : 0 < A.natDegree + B.natDegree + C.natDegree + D.natDegree := by omega
  ...
  have hz3delta : delta = 0 ∨ (2 * A.natDegree + D.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ A.natDegree + B.natDegree + C.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ 3 * B.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ A.natDegree + F.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ B.natDegree + E.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree ∧ C.natDegree + D.natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr3 : (xiQuarticChamberRest6006810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + B.natDegree + C.natDegree + D.natDegree :=
    xiQuarticChamberRest6006810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct3 := xiQuarticChamberFace6006810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega)
  have hq3 : (degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (A.natDegree + B.natDegree + C.natDegree + D.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hxiDeg]
    omega
  rw [degreeZeroXiQuartic810_eq_face6006_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr3,
    add_zero] at hq3
  have hin3 : (15 / 256 : k) * A.leadingCoeff * B.leadingCoeff * C.leadingCoeff * D.leadingCoeff + (-5 / 64 : k) * A.leadingCoeff * D.leadingCoeff * F.leadingCoeff + (-15 / 128 : k) * C.leadingCoeff ^ 2 * E.leadingCoeff + (-15 / 128 : k) * C.leadingCoeff * D.leadingCoeff ^ 2 + (5 / 16 : k) * E.leadingCoeff * G.leadingCoeff = 0 :=
    hct3.symm.trans hq3
  have hdp4 : 0 < 2 * A.natDegree + B.natDegree + 2 * C.natDegree := by
    omega
  have hdz4 : 0 < 2 * A.natDegree + B.natDegree + 2 * C.natDegree := by omega
  ...
  have hz4zeta : zeta = 0 ∨ (4 * A.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + C.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ A.natDegree + 2 * B.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ B.natDegree + D.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * C.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ G.natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr4 : (omicronQuarticChamberRest6008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 2 * A.natDegree + B.natDegree + 2 * C.natDegree :=
    omicronQuarticChamberRest6008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz4 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz4l hz4beta (Or.inr (by omega)) hz4delta (Or.inr (by omega)) hz4zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct4 := omicronQuarticChamberFace6008810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq4 : (degreeZeroOmicronQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + B.natDegree + 2 * C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [homi]
    omega
  rw [degreeZeroOmicronQuartic810_eq_face6008_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr4,
    add_zero] at hq4
  have hin4 : (15 / 16384 : k) * A.leadingCoeff ^ 2 * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 2048 : k) * A.leadingCoeff ^ 2 * B.leadingCoeff * G.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 2 * C.leadingCoeff * F.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 2 * D.leadingCoeff * E.leadingCoeff + (15 / 1024 : k) * A.leadingCoeff * C.leadingCoeff ^ 2 * D.leadingCoeff + (-5 / 128 : k) * A.leadingCoeff * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct4.symm.trans hq4
  have hdp5 : 0 < A.natDegree + C.natDegree + 2 * D.natDegree := by
    omega
  have hdz5 : 0 < A.natDegree + C.natDegree + 2 * D.natDegree := by omega
  ...
  have hz6zeta : zeta = 0 ∨ (5 * A.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 3 * A.natDegree + C.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * A.natDegree + E.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ A.natDegree + B.natDegree + D.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * B.natDegree + C.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ B.natDegree + F.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ C.natDegree + E.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree ∧ 2 * D.natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree) := by
    ...
    · exact Or.inr (by omega)
    · exact Or.inr (by omega)
  have hr6 : (primitiveQuarticChamberRest6008810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < 3 * A.natDegree + B.natDegree + 2 * C.natDegree :=
    primitiveQuarticChamberRest6008810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz6 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz6l hz6beta (Or.inr (by omega)) hz6delta (Or.inr (by omega)) hz6zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct6 := primitiveQuarticChamberFace6008810_coeff_top hAne hBne hCne hDne hEne hFne hGne (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq6 : (degreeZeroPrimitiveQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (3 * A.natDegree + B.natDegree + 2 * C.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
    rw [hprim]
    omega
  rw [degreeZeroPrimitiveQuartic810_eq_face6008_add_rest,
    coeff_add, coeff_eq_zero_of_natDegree_lt hr6,
    add_zero] at hq6
  have hin6 : (15 / 16384 : k) * A.leadingCoeff ^ 3 * B.leadingCoeff * C.leadingCoeff ^ 2 + (-5 / 2048 : k) * A.leadingCoeff ^ 3 * B.leadingCoeff * G.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 3 * C.leadingCoeff * F.leadingCoeff + (-5 / 2048 : k) * A.leadingCoeff ^ 3 * D.leadingCoeff * E.leadingCoeff + (15 / 2048 : k) * A.leadingCoeff ^ 2 * C.leadingCoeff ^ 2 * D.leadingCoeff + (-5 / 256 : k) * A.leadingCoeff ^ 2 * D.leadingCoeff * G.leadingCoeff = 0 :=
    hct6.symm.trans hq6
  have hdp7 : A.natDegree < 2 * C.natDegree + D.natDegree := by
    omega
  have hdz7 : 0 < 2 * C.natDegree + D.natDegree := by omega
  ...
  exact quarticUnownedSystemBCDEFG102L5810_cert A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hin5 hin6 hin7 hin8 hin9 hDc hGc
