<!-- Historical development log, moved out of README.md on 2026-09-12. It records intermediate states of the project and is NOT the current statement of scope; formalization.yaml and README.md are authoritative. -->
...
`LowScale410ScaleZeroBetaCubicHighCTie.lean`,
`LowScale410ScaleZeroBetaCubicBalancedWall.lean`,
`LowScale410ScaleZeroCubicDeletedEarlyLoad.lean`,
...
`LowScale410ScaleZeroA4BU2Tie.lean`,
`LowScale410ScaleZeroFinalAB3BU2Elimination.lean`,
`LowScale410ScaleZeroNonzeroGammaCone.lean`,
...
`LowScale410ScaleZeroGammaUZeroBoundaryElimination.lean`,
...
`LowScale410ScaleZeroGammaDescendedCoreTieElimination.lean`,
`LowScale410ScaleZeroGammaFullCoreTieScalarPacket.lean`,
`LowScale410ScaleZeroGammaFullCoreScalarLeaves.lean`,
`LowScale410ScaleZeroGammaPrincipalWallElimination.lean`,
`LowScale410ScaleZeroDeltaLaterFirstFace.lean`,
`LowScale410ScaleZeroDeltaLaterCoordinates.lean`,
`LowScale410ScaleZeroDeltaLaterAZero.lean`,
`LowScale410ScaleZeroDeltaLaterFixedTie.lean`,
`LowScale410ScaleZeroDeltaLaterEnvelopeFan.lean`,
`LowScale410ScaleZeroDeltaLaterElimination.lean`,
`LowScale410ScaleZeroGammaOffTieEnvelopeFan.lean`,
`LowScale410ScaleZeroGammaAZeroAndCollapsedFan.lean`,
`LowScale410ScaleZeroGammaConstantBAndExtremeCone.lean`,
`LowScale410ScaleZeroGammaConstantUAndHighBFan.lean`,
`LowScale410ScaleZeroGammaHighBFirstInvariantRays.lean`,
`LowScale410ScaleZeroGammaHighBDeltaA4RaysElimination.lean`,
`LowScale410ScaleZeroGammaHighBCommonDeltaElimination.lean`,
`LowScale410ScaleZeroGammaHighBDeltaZeroStrata.lean`,
`LowScale410ScaleZeroGammaHighBThetaElimination.lean`,
`LowScale410ScaleZeroGammaHighUConeElimination.lean`,
`LowScale410ScaleZeroGammaFirstConeElimination.lean`,
`LowScale410ScaleZeroGammaFinalConeElimination.lean`,
...
`LowScale410ScaleTwoSixthFace.lean`,
`LowScale410ScaleTwoSeventhFace.lean`,
`LowScale410ScaleTwoEighthFace.lean`,
...
`LowScale610ScaleZeroFifthDefect.lean`,
`LowScale610ScaleZeroSixthDefect.lean`,
...
`LowScale810ScaleZeroFourthDefect.lean`,
`LowScale810ScaleZeroFifthDefect.lean`,
...
`LowScale810ScaleTwoSixthFace.lean`,
`LowScale810ScaleTwoSeventhFace.lean`,
`LowScale810ScaleTwoSeventhPacket.lean`,
`LowScale810ScaleTwoEighthFace.lean`,
`LowScale810ScaleTwoNinthFace.lean`,
...
`LowScale68ScaleTwoAlignedNonsquareDegreeNine.lean`,
`LowScale68ScaleTwoAlignedNonsquareDegreeEight.lean`,
`LowScale68ScaleTwoAlignedNonsquareIntegratedQ.lean`,
`LowScale68ScaleTwoAlignedNonsquareIntegratedR.lean`,
`LowScale68ScaleTwoAlignedNonsquareIntegratedSNext.lean`,
`LowScale68ScaleTwoAlignedNonsquareIntegratedSAssembly.lean`,
`LowScale68ScaleTwoAlignedNonsquareDegreeSix.lean`,
`LowScale68ScaleTwoAlignedNonsquareDegreeFive.lean`,
...
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroFZero.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroBNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroCNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroGNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroRefinedFaces.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroRefinedFZero.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroRefinedGZero.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroRefinedGZeroFNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroDoubleGainNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroTripleGainNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroQuadrupleGainNext.lean`,
`LowScale68ScaleTwoAlignedSquareRhoOneCubicExceptionalDoubleZeroQuintupleGainNext.lean`,
...
`LowScale68SecondaryLaterDeepThreeRadiusZeroResidualAlgebra.lean`,
`LowScale68SecondaryLaterDeepThreeRadiusZeroResidualLoad.lean`,
`LowScale68SecondaryLaterDeepThreeRadiusZeroResidualLoadAssembly.lean`,
`LowScale68SecondaryLaterDeepThreeRadiusZeroResidualSource.lean`,
...
`LowScale68SecondaryLaterDeepThreeRadiusMiddleBalancedRowOne.lean`,
...
`LowScale68SecondaryLaterDeepLowerOpenMiddleSevenSumRowTwo.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleFiveSumRowTwo.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleOrdinaryRight.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleOrdinaryLeft.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleOrdinaryBalanced.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleBalancedRowOne.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighDelta.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighZeta.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighBalancedRowOne.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighBalancedSixToSeven.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighZetaZeroEndgame.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighSevenWalls.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighLeftSevenRowOne.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighRightSevenRowOne.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighCoincidentSevenEndgame.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighRightFiveWall.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighLeftFiveWall.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighCoincidentFiveWall.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighCoincidentFiveDeltaZero.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighCoincidentFiveDeltaLoad.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighCoincidentFiveRowZeroEndgame.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighRightFiveRowZeroEndgame.lean`,
`LowScale68SecondaryLaterDeepLowerOpenMiddleHighLeftFiveRowZeroEndgame.lean`,
