...
set_option maxHeartbeats 2000000 in
theorem cubicLoadRowOnePolynomial68_degree_lt_residualDouble_of_twoGap
    (l alpha beta gamma delta epsilon zeta eta : k)
    (A B c D e : k[X]) (n g : ℕ)
    (hg : 0 < g) (hsmall : 2 * g < n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hloads := cubicLoadPolynomials68_degreeBounds
    l alpha beta gamma delta epsilon zeta eta A B c D e n g
    (by omega) hg hsmall hA hB hc hD he'
  have hTl : Tl.natDegree ≤ 5 * n - g := by
    simpa only [Tl] using hloads.2.1
  have hUl : Ul.natDegree ≤ 6 * n := by
    simpa only [Ul] using hloads.2.2.1
...
set_option maxHeartbeats 2000000 in
theorem cubicLoadRowZeroPolynomial68_degree_lt_residualDouble_of_l_eq_zero
    (alpha beta gamma delta epsilon zeta eta : k)
    (A B c D e : k[X]) (n g : ℕ)
    (hg : 0 < g) (hsmall : 2 * g < n)
    (hA : A.natDegree ≤ 2 * n)
...
set_option maxHeartbeats 2000000 in
theorem cubicFirstIntegralThreePolynomial68_coeff_residualMiddle_of_twoGap
    (l beta gamma delta epsilon zeta : k) (A B c d e : k[X])
    (n g h : ℕ) (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hsmall : 2 * g < n)
    (hA : A.natDegree ≤ 2 * n)
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    compute_degree
    omega
  have hload := secondaryLoadInvariantThreePolynomial68_degree_lt_middle_of_twoGap
  ...
  rw [cubicFirstIntegralThreePolynomial68_secondaryLoadSplit,
    ...
    coeff_add,
    secondaryResidualInvariantThreePolynomial68_coeff_middle_of_twoGap A B c d e
      n g h hg hgh hh hsmall hA hB hc hd he,
    coeff_eq_zero_of_natDegree_lt hload, add_zero]

set_option maxHeartbeats 2000000 in
theorem cubicFirstIntegralFourPolynomial68_coeff_residualDouble_of_l_eq_zero
    (beta gamma delta epsilon zeta : k) (A B c d e : k[X])
    (n g : ℕ) (hg : 0 < g) (hsmall : 2 * g < n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
  ...
  have hD : D.natDegree ≤ 5 * n - g := by
    ...
    compute_degree
    omega
  have hload := secondaryLoadInvariantFourPolynomial68_degree_lt_double_of_l_eq_zero
  ...
  rw [cubicFirstIntegralFourPolynomial68_secondaryLoadSplit,
    show cubicFirstIntegralFourPolynomial68 0 0 0 0 0 0 A B c D e =
      ...
      simpa only [D] using
        cubicFirstIntegralFourPolynomial68_residualCoordinates A B c d e,
    coeff_add,
    secondaryResidualInvariantFourPolynomial68_coeff_double_of_twoGap B c d e
...
theorem secondaryResidualRowZeroPolynomial68_coeff_double_of_twoGap
    (A B c d e : k[X]) (n g : ℕ) (hg : 0 < g) (hsmall : 2 * g < n)
    (hA : A.natDegree ≤ 2 * n)
    (hB : B.natDegree ≤ 3 * n - g)
    (hc : c.natDegree ≤ 4 * n - g)
...
set_option maxHeartbeats 4000000 in
theorem maximalExpandedIntegratedPolynomialLowerSystem_secondaryResidualMiddleFace68_of_l_eq_zero
  ...
  rw [hCrec, hErec, firstIntegralThreePolynomial68_cubicCoordinates,
    hDrec] at hi3c
  exact polynomialSecondaryResidualBetweenFace68_of_l_eq_zero
    beta gamma delta epsilon zeta i4 i3 Ae Be ce d ee n g h
    hg hgh hh hsmall hA hB hc hmiddle.1 hmiddle.2 hi4c hi3c

set_option maxHeartbeats 5000000 in
theorem maximalExpandedIntegratedPolynomialLowerSystem_secondaryResidualDouble68_of_l_eq_zero
    (alpha beta gamma delta epsilon zeta eta terminal : k)
  ...
  have h0target : (lowerRowZeroPolynomial68
    ...
    have hn10 : 10 ≤ n := by
      ...
      · have : 0 < E.natDegree := by omega
        omega
    have hidx : 59 < 13 * n - 3 * g - 1 := by
      have : 3 * g < 2 * n := by omega
      omega
  ...
  exact polynomialSecondaryResidualDoubleFace68_of_l_eq_zero
...
set_option maxHeartbeats 2000000 in
theorem residualRowTwo_leftChamber_ne_zero68_of_twoGap
    (A B c d e : k[X]) (n g h : ℕ)
    (hg : 0 < g) (hgh : g < h) (hh : h < 2 * g)
    (hsmall : 2 * g < n) (hleft : 2 * h < 3 * g)
    (hA : A.natDegree ≤ 2 * n)
    ...
    (secondaryResidualRowTwoPolynomial68 A B c d e).coeff
        (11 * n - 2 * h - 1) ≠ 0 := by
  rw [residualRowTwo_coeff_leftChamber68_of_twoGap A B c d e n g h hg hgh hh hsmall hleft
    hA hB hc hd he hQ]
