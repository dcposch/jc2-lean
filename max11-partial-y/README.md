...
- `LowScale46LocalChart.lean` verifies all four full cleared equations in the
  ...
  Extracting those equations from the polynomial system and eliminating this
  residual face and the other gap chambers remain open, as does the scale-two
  pole/degree analysis.
...
defect radius; the abstract small-gap face is also classified.  Polynomial
face extraction, the residual small-gap face, the other gap chambers, and the
...
`LowScale68SecondaryFace.lean`, and
`Max11Assembly.lean`
