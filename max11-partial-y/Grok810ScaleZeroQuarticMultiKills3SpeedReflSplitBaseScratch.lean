import Grok810ScaleZeroQuarticMultiKills2Scratch
import Max11SpeedReflectDegLibScratch

/-! # Quartic Stage A multi-cone certificates (part 3: 5-letter cones ABCDE–ABCFG) -/
...
def kappaQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (5 / 512 : k) • (A * B ^ 3)
  - (15 / 128 : k) • (B ^ 2 * D)
  - (15 / 128 : k) • (B * C ^ 2)
  + (5 / 16 : k) • (D * E)
...
set_option maxHeartbeats 16000000 in
def degreeZeroKappaQuarticNoABCDE810
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroKappaQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      kappaQuarticFaceABCDE810 A B C D E F G +
        degreeZeroKappaQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroKappaQuartic810, kappaQuarticFaceABCDE810, degreeZeroKappaQuarticNoABCDE810]
  all_goals module

theorem kappaQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    (hCne : C ≠ 0)
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (kappaQuarticFaceABCDE810 A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) =
      (1 / 512 : k) * kappaQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [kappaQuarticFaceABCDE810, kappaQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
...
set_option maxHeartbeats 16000000 in
def muQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * C)
  + (35 / 2048 : k) • B ^ 4
  - (5 / 128 : k) • (A * D ^ 2)
  - (15 / 128 : k) • (B ^ 2 * E)
...
set_option maxHeartbeats 16000000 in
def degreeZeroMuQuarticNoABCDE810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 64 : k)) • (A * B * F)
  + (5 / 16 : k) • (C * G)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroMuQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      muQuarticFaceABCDE810 A B C D E F G +
        degreeZeroMuQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroMuQuartic810, muQuarticFaceABCDE810, degreeZeroMuQuarticNoABCDE810]
  all_goals module

theorem muQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (muQuarticFaceABCDE810 A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      (1 / 2048 : k) * muQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [muQuarticFaceABCDE810, muQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
...
set_option maxHeartbeats 16000000 in
def nuQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 4096 : k)) • (A ^ 2 * B ^ 3)
  + (45 / 1024 : k) • (A * B ^ 2 * D)
  + (15 / 1024 : k) • (A * B * C ^ 2)
  + (35 / 512 : k) • (B ^ 3 * C)
...
set_option maxHeartbeats 32000000 in
def degreeZeroNuQuarticNoABCDE810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 128 : k)) • (A * B * G)
  - (5 / 128 : k) • (A * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroNuQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      nuQuarticFaceABCDE810 A B C D E F G +
        degreeZeroNuQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroNuQuartic810, nuQuarticFaceABCDE810, degreeZeroNuQuarticNoABCDE810]
  all_goals module

theorem nuQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (nuQuarticFaceABCDE810 A B C D E F G).coeff (2 * A.natDegree + 3 * B.natDegree) =
      (1 / 4096 : k) * nuQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [nuQuarticFaceABCDE810, nuQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
...
set_option maxHeartbeats 16000000 in
def xiQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 2048 : k)) • (A * B ^ 4)
  + (15 / 512 : k) • (A * B ^ 2 * E)
  + (15 / 256 : k) • (A * B * C * D)
  + (55 / 1024 : k) • (B ^ 3 * D)
...
set_option maxHeartbeats 32000000 in
def degreeZeroXiQuarticNoABCDE810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 64 : k)) • (A * D * F)
  - (5 / 64 : k) • (B ^ 2 * G)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroXiQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      xiQuarticFaceABCDE810 A B C D E F G +
        degreeZeroXiQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroXiQuartic810, xiQuarticFaceABCDE810, degreeZeroXiQuarticNoABCDE810]
  all_goals module

theorem xiQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (xiQuarticFaceABCDE810 A B C D E F G).coeff (A.natDegree + 4 * B.natDegree) =
      (1 / 2048 : k) * xiQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [xiQuarticFaceABCDE810, xiQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
...
set_option maxHeartbeats 16000000 in
def omicronQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 65536 : k)) • (A ^ 3 * B ^ 3)
...
set_option maxHeartbeats 32000000 in
def degreeZeroOmicronQuarticNoABCDE810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 2048 : k)) • (A ^ 2 * B * G)
  - (5 / 2048 : k) • (A ^ 2 * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroOmicronQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroOmicronQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      omicronQuarticFaceABCDE810 A B C D E F G +
        degreeZeroOmicronQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroOmicronQuartic810, omicronQuarticFaceABCDE810, degreeZeroOmicronQuarticNoABCDE810]
  all_goals module

theorem omicronQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (omicronQuarticFaceABCDE810 A B C D E F G).coeff (3 * A.natDegree + 3 * B.natDegree) =
      (1 / 65536 : k) * omicronQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [omicronQuarticFaceABCDE810, omicronQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  ...
  rw [hcf_A3B3, hcf_A2B2D, hcf_A2BC2, hcf_A2DE, hcf_AB3C, hcf_ABCE, hcf_ABD2, hcf_AC2D, hcf_B5, hcf_B3E, hcf_B2CD, hcf_BC3, hcf_BE2, hcf_CDE, hcf_D3]
  ring

set_option maxHeartbeats 16000000 in
def piQuarticFaceABCDE810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 4096 : k) • (A ^ 2 * B ^ 4)
  - (15 / 128 : k) • (A * B ^ 3 * D)
  - (45 / 512 : k) • (A * B ^ 2 * C ^ 2)
  - (35 / 256 : k) • (B ^ 4 * C)
...
set_option maxHeartbeats 32000000 in
def degreeZeroPiQuarticNoABCDE810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (5 / 64 : k) • (A * B ^ 2 * G)
  + (5 / 32 : k) • (A * B * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroPiQuartic810_eq_ABCDE_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      piQuarticFaceABCDE810 A B C D E F G +
        degreeZeroPiQuarticNoABCDE810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroPiQuartic810, piBaseGroupQuartic810,
    ...
    piThetaGroupQuartic810, piQuarticFaceABCDE810, degreeZeroPiQuarticNoABCDE810]
  all_goals module

theorem piQuarticFaceABCDE810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDE810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hEne : E ≠ 0)
    : (piQuarticFaceABCDE810 A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) =
      (1 / 4096 : k) * piQuarticInnerABCDE810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hEpos, hAB, hAC, hAD, hAE, hFlt, hGlt⟩
  simp only [piQuarticFaceABCDE810, piQuarticInnerABCDE810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  ...
  rw [hcf_A2B4, hcf_AB3D, hcf_AB2C2, hcf_ABDE, hcf_ACD2, hcf_B4C, hcf_B2CE, hcf_B2D2, hcf_BC2D, hcf_C4, hcf_CE2, hcf_D2E]
  ring
...
set_option maxHeartbeats 16000000 in
def kappaQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (5 / 512 : k) • (A * B ^ 3)
  - (15 / 128 : k) • (B ^ 2 * D)
  - (15 / 128 : k) • (B * C ^ 2)
  + (5 / 16 : k) • (C * F)
...
set_option maxHeartbeats 16000000 in
def degreeZeroKappaQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (5 / 16 : k) • (B * G)
  + (5 / 16 : k) • (D * E)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroKappaQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      kappaQuarticFaceABCDF810 A B C D E F G +
        degreeZeroKappaQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroKappaQuartic810, kappaQuarticFaceABCDF810, degreeZeroKappaQuarticNoABCDF810]
  all_goals module

theorem kappaQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    (hCne : C ≠ 0)
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (kappaQuarticFaceABCDF810 A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) =
      (1 / 512 : k) * kappaQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [kappaQuarticFaceABCDF810, kappaQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB3 : ((A * B ^ 3)).natDegree = A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 3 hBne), natDegree_pow]
  have hcf_AB3 : ((A * B ^ 3)).coeff (A.natDegree + 3 * B.natDegree) =
  ...
  rw [hcf_AB3, hcf_B2D, hcf_BC2, hcf_CF]
  ring

set_option maxHeartbeats 16000000 in
def muQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * C)
  + (35 / 2048 : k) • B ^ 4
  - (5 / 64 : k) • (A * B * F)
  - (5 / 128 : k) • (A * D ^ 2)
...
set_option maxHeartbeats 16000000 in
def degreeZeroMuQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 128 : k)) • (B ^ 2 * E)
  + (5 / 16 : k) • (C * G)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroMuQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      muQuarticFaceABCDF810 A B C D E F G +
        degreeZeroMuQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroMuQuartic810, muQuarticFaceABCDF810, degreeZeroMuQuarticNoABCDF810]
  all_goals module

theorem muQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (muQuarticFaceABCDF810 A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      (1 / 2048 : k) * muQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [muQuarticFaceABCDF810, muQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB2C : ((A * B ^ 2 * C)).natDegree = A.natDegree + 2 * B.natDegree + C.natDegree := by
    rw [natDegree_mul (mul_ne_zero hAne (pow_ne_zero 2 hBne)) hCne, natDegree_mul hAne (pow_ne_zero 2 hBne), natDegree_pow]
  have hcf_AB2C : ((A * B ^ 2 * C)).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
  ...
  rw [hcf_AB2C, hcf_ABF, hcf_AD2, hcf_B4, hcf_BCD, hcf_C3, hcf_DF]
  ring

set_option maxHeartbeats 16000000 in
def nuQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 4096 : k)) • (A ^ 2 * B ^ 3)
  + (45 / 1024 : k) • (A * B ^ 2 * D)
  + (15 / 1024 : k) • (A * B * C ^ 2)
  + (35 / 512 : k) • (B ^ 3 * C)
...
set_option maxHeartbeats 32000000 in
def degreeZeroNuQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 128 : k)) • (A * B * G)
  - (5 / 128 : k) • (A * D * E)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroNuQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      nuQuarticFaceABCDF810 A B C D E F G +
        degreeZeroNuQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroNuQuartic810, nuQuarticFaceABCDF810, degreeZeroNuQuarticNoABCDF810]
  all_goals module

theorem nuQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (nuQuarticFaceABCDF810 A B C D E F G).coeff (2 * A.natDegree + 3 * B.natDegree) =
      (1 / 4096 : k) * nuQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [nuQuarticFaceABCDF810, nuQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A2B3 : ((A ^ 2 * B ^ 3)).natDegree = 2 * A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 2 hAne) (pow_ne_zero 3 hBne), natDegree_pow, natDegree_pow]
  have hcf_A2B3 : ((A ^ 2 * B ^ 3)).coeff (2 * A.natDegree + 3 * B.natDegree) =
  ...
  have hcf_C2D : ((C ^ 2 * D)).coeff (2 * A.natDegree + 3 * B.natDegree) =
      C.leadingCoeff ^ 2 * D.leadingCoeff := by
    rw [← hdeg_C2D, coeff_natDegree, leadingCoeff_mul, leadingCoeff_pow]
  rw [hcf_A2B3, hcf_AB2D, hcf_ABC2, hcf_ACF, hcf_B3C, hcf_B2F, hcf_BD2, hcf_C2D]
  ring

set_option maxHeartbeats 16000000 in
def xiQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 2048 : k)) • (A * B ^ 4)
  + (15 / 256 : k) • (A * B * C * D)
  + (55 / 1024 : k) • (B ^ 3 * D)
  + (45 / 512 : k) • (B ^ 2 * C ^ 2)
...
set_option maxHeartbeats 32000000 in
def degreeZeroXiQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * E)
  - (5 / 64 : k) • (B ^ 2 * G)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroXiQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      xiQuarticFaceABCDF810 A B C D E F G +
        degreeZeroXiQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroXiQuartic810, xiQuarticFaceABCDF810, degreeZeroXiQuarticNoABCDF810]
  all_goals module

theorem xiQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (xiQuarticFaceABCDF810 A B C D E F G).coeff (A.natDegree + 4 * B.natDegree) =
      (1 / 2048 : k) * xiQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [xiQuarticFaceABCDF810, xiQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB4 : ((A * B ^ 4)).natDegree = A.natDegree + 4 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 4 hBne), natDegree_pow]
  have hcf_AB4 : ((A * B ^ 4)).coeff (A.natDegree + 4 * B.natDegree) =
  ...
  rw [hcf_AB4, hcf_ABCD, hcf_ADF, hcf_B3D, hcf_B2C2, hcf_BCF, hcf_CD2, hcf_F2]
  ring

set_option maxHeartbeats 16000000 in
def omicronQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 65536 : k)) • (A ^ 3 * B ^ 3)
  - (45 / 16384 : k) • (A ^ 2 * B ^ 2 * D)
  + (15 / 16384 : k) • (A ^ 2 * B * C ^ 2)
  - (35 / 2048 : k) • (A * B ^ 3 * C)
...
set_option maxHeartbeats 32000000 in
def degreeZeroOmicronQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 2048 : k)) • (A ^ 2 * B * G)
  - (5 / 2048 : k) • (A ^ 2 * D * E)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroOmicronQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroOmicronQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      omicronQuarticFaceABCDF810 A B C D E F G +
        degreeZeroOmicronQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroOmicronQuartic810, omicronQuarticFaceABCDF810, degreeZeroOmicronQuarticNoABCDF810]
  all_goals module

theorem omicronQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (omicronQuarticFaceABCDF810 A B C D E F G).coeff (3 * A.natDegree + 3 * B.natDegree) =
      (1 / 65536 : k) * omicronQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [omicronQuarticFaceABCDF810, omicronQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A3B3 : ((A ^ 3 * B ^ 3)).natDegree = 3 * A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 3 hAne) (pow_ne_zero 3 hBne), natDegree_pow, natDegree_pow]
  have hcf_A3B3 : ((A ^ 3 * B ^ 3)).coeff (3 * A.natDegree + 3 * B.natDegree) =
  ...
  have hcf_D3 : (D ^ 3).coeff (3 * A.natDegree + 3 * B.natDegree) =
      D.leadingCoeff ^ 3 := by
    rw [← hdeg_D3, coeff_natDegree, leadingCoeff_pow]
  rw [hcf_A3B3, hcf_A2B2D, hcf_A2BC2, hcf_A2CF, hcf_AB3C, hcf_AB2F, hcf_ABD2, hcf_AC2D, hcf_B5, hcf_B2CD, hcf_BC3, hcf_BDF, hcf_C2F, hcf_D3]
  ring

set_option maxHeartbeats 16000000 in
def piQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 4096 : k) • (A ^ 2 * B ^ 4)
  - (15 / 128 : k) • (A * B ^ 3 * D)
  - (45 / 512 : k) • (A * B ^ 2 * C ^ 2)
  - (35 / 256 : k) • (B ^ 4 * C)
...
set_option maxHeartbeats 32000000 in
def degreeZeroPiQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (5 / 64 : k) • (A * B ^ 2 * G)
  + (5 / 16 : k) • (A * B * D * E)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroPiQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      piQuarticFaceABCDF810 A B C D E F G +
        degreeZeroPiQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroPiQuartic810, piBaseGroupQuartic810,
    piBetaGroupQuartic810, piGammaGroupQuartic810, piDeltaGroupQuartic810,
    piEpsilonGroupQuartic810, piZetaGroupQuartic810, piEtaGroupQuartic810,
    piThetaGroupQuartic810, piQuarticFaceABCDF810, degreeZeroPiQuarticNoABCDF810]
  all_goals module

theorem piQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (piQuarticFaceABCDF810 A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) =
      (1 / 4096 : k) * piQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [piQuarticFaceABCDF810, piQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A2B4 : ((A ^ 2 * B ^ 4)).natDegree = 2 * A.natDegree + 4 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 2 hAne) (pow_ne_zero 4 hBne), natDegree_pow, natDegree_pow]
  have hcf_A2B4 : ((A ^ 2 * B ^ 4)).coeff (2 * A.natDegree + 4 * B.natDegree) =
  ...
  rw [hcf_A2B4, hcf_AB3D, hcf_AB2C2, hcf_ABCF, hcf_ACD2, hcf_AF2, hcf_B4C, hcf_B3F, hcf_B2D2, hcf_BC2D, hcf_C4, hcf_CDF]
  ring

set_option maxHeartbeats 16000000 in
def primitiveQuarticFaceABCDF810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 65536 : k)) • (A ^ 4 * B ^ 3)
...
set_option maxHeartbeats 32000000 in
def degreeZeroPrimitiveQuarticNoABCDF810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 2048 : k)) • (A ^ 3 * B * G)
  - (5 / 2048 : k) • (A ^ 3 * D * E)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroPrimitiveQuartic810_eq_ABCDF_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroPrimitiveQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      primitiveQuarticFaceABCDF810 A B C D E F G +
        degreeZeroPrimitiveQuarticNoABCDF810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroPrimitiveQuartic810, rhoBaseGroupQuartic810,
    ...
    rhoThetaGroupQuartic810, primitiveQuarticFaceABCDF810, degreeZeroPrimitiveQuarticNoABCDF810]
  all_goals module

theorem primitiveQuarticFaceABCDF810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCDF810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hDne : D ≠ 0)
    (hFne : F ≠ 0)
    : (primitiveQuarticFaceABCDF810 A B C D E F G).coeff (4 * A.natDegree + 3 * B.natDegree) =
      (1 / 65536 : k) * primitiveQuarticInnerABCDF810 A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff F.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hDpos, hFpos, hAB, hAC, hAD, hAF, hElt, hGlt⟩
  simp only [primitiveQuarticFaceABCDF810, primitiveQuarticInnerABCDF810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  ...
  rw [hcf_A4B3, hcf_A3B2D, hcf_A3BC2, hcf_A3CF, hcf_A2B3C, hcf_A2B2F, hcf_A2BD2, hcf_A2C2D, hcf_AB5, hcf_AB2CD, hcf_ABC3, hcf_ABDF, hcf_AD3, hcf_B4D, hcf_B3C2, hcf_B2CF, hcf_BCD2, hcf_BF2, hcf_C3D, hcf_D2F]
  ring

def kappaQuarticInnerABCDG810 (a b c d g : k) : k :=
  5 * a * b ^ 3 + (-60 : k) * b ^ 2 * d + (-60 : k) * b * c ^ 2 + 160 * b * g

def muQuarticInnerABCDG810 (a b c d g : k) : k :=
  60 * a * b ^ 2 * c + (-80 : k) * a * d ^ 2 + 35 * b ^ 4 + (-480 : k) * b * c * d + (-80 : k) * c ^ 3 + 640 * c * g

def nuQuarticInnerABCDG810 (a b c d g : k) : k :=
  (-5 : k) * a ^ 2 * b ^ 3 + 180 * a * b ^ 2 * d + 60 * a * b * c ^ 2 + (-160 : k) * a * b * g + 280 * b ^ 3 * c + (-480 : k) * b * d ^ 2 + (-480 : k) * c ^ 2 * d + 1280 * d * g

def xiQuarticInnerABCDG810 (a b c d g : k) : k :=
  (-15 : k) * a * b ^ 4 + 120 * a * b * c * d + 110 * b ^ 3 * d + 180 * b ^ 2 * c ^ 2 + (-160 : k) * b ^ 2 * g + (-240 : k) * c * d ^ 2
...
set_option maxHeartbeats 16000000 in
def kappaQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (5 / 512 : k) • (A * B ^ 3)
  - (15 / 128 : k) • (B * C ^ 2)
  + (5 / 16 : k) • (B * G)

set_option maxHeartbeats 16000000 in
def degreeZeroKappaQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 128 : k)) • (B ^ 2 * D)
  + (5 / 16 : k) • (C * F)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroKappaQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      kappaQuarticFaceABCEG810 A B C D E F G +
        degreeZeroKappaQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroKappaQuartic810, kappaQuarticFaceABCEG810, degreeZeroKappaQuarticNoABCEG810]
  all_goals module

theorem kappaQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    (hCne : C ≠ 0)
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (kappaQuarticFaceABCEG810 A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) =
      (1 / 512 : k) * kappaQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [kappaQuarticFaceABCEG810, kappaQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB3 : ((A * B ^ 3)).natDegree = A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 3 hBne), natDegree_pow]
  have hcf_AB3 : ((A * B ^ 3)).coeff (A.natDegree + 3 * B.natDegree) =
...
set_option maxHeartbeats 16000000 in
def muQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * C)
  + (35 / 2048 : k) • B ^ 4
  - (15 / 128 : k) • (B ^ 2 * E)
  - (5 / 128 : k) • C ^ 3
...
set_option maxHeartbeats 16000000 in
def degreeZeroMuQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 64 : k)) • (A * B * F)
  - (5 / 128 : k) • (A * D ^ 2)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroMuQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      muQuarticFaceABCEG810 A B C D E F G +
        degreeZeroMuQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroMuQuartic810, muQuarticFaceABCEG810, degreeZeroMuQuarticNoABCEG810]
  all_goals module

theorem muQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (muQuarticFaceABCEG810 A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      (1 / 2048 : k) * muQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [muQuarticFaceABCEG810, muQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB2C : ((A * B ^ 2 * C)).natDegree = A.natDegree + 2 * B.natDegree + C.natDegree := by
    rw [natDegree_mul (mul_ne_zero hAne (pow_ne_zero 2 hBne)) hCne, natDegree_mul hAne (pow_ne_zero 2 hBne), natDegree_pow]
  have hcf_AB2C : ((A * B ^ 2 * C)).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
  ...
  have hcf_E2 : (E ^ 2).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      E.leadingCoeff ^ 2 := by
    rw [← hdeg_E2, coeff_natDegree, leadingCoeff_pow]
  rw [hcf_AB2C, hcf_B4, hcf_B2E, hcf_C3, hcf_CG, hcf_E2]
  ring

set_option maxHeartbeats 16000000 in
def nuQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 4096 : k)) • (A ^ 2 * B ^ 3)
  + (15 / 1024 : k) • (A * B * C ^ 2)
  + (35 / 512 : k) • (B ^ 3 * C)
  - (5 / 128 : k) • (A * B * G)
...
set_option maxHeartbeats 32000000 in
def degreeZeroNuQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (45 / 1024 : k) • (A * B ^ 2 * D)
  - (5 / 128 : k) • (A * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroNuQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      nuQuarticFaceABCEG810 A B C D E F G +
        degreeZeroNuQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroNuQuartic810, nuQuarticFaceABCEG810, degreeZeroNuQuarticNoABCEG810]
  all_goals module

theorem nuQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (nuQuarticFaceABCEG810 A B C D E F G).coeff (2 * A.natDegree + 3 * B.natDegree) =
      (1 / 4096 : k) * nuQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [nuQuarticFaceABCEG810, nuQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A2B3 : ((A ^ 2 * B ^ 3)).natDegree = 2 * A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 2 hAne) (pow_ne_zero 3 hBne), natDegree_pow, natDegree_pow]
  have hcf_A2B3 : ((A ^ 2 * B ^ 3)).coeff (2 * A.natDegree + 3 * B.natDegree) =
  ...
  have hcf_BCE : ((B * C * E)).coeff (2 * A.natDegree + 3 * B.natDegree) =
      B.leadingCoeff * C.leadingCoeff * E.leadingCoeff := by
    rw [← hdeg_BCE, coeff_natDegree, leadingCoeff_mul, leadingCoeff_mul]
  rw [hcf_A2B3, hcf_ABC2, hcf_ABG, hcf_B3C, hcf_BCE]
  ring

set_option maxHeartbeats 16000000 in
def xiQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 2048 : k)) • (A * B ^ 4)
  + (15 / 512 : k) • (A * B ^ 2 * E)
  + (45 / 512 : k) • (B ^ 2 * C ^ 2)
  - (5 / 64 : k) • (B ^ 2 * G)
...
set_option maxHeartbeats 32000000 in
def degreeZeroXiQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (15 / 256 : k) • (A * B * C * D)
  + (55 / 1024 : k) • (B ^ 3 * D)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroXiQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      xiQuarticFaceABCEG810 A B C D E F G +
        degreeZeroXiQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroXiQuartic810, xiQuarticFaceABCEG810, degreeZeroXiQuarticNoABCEG810]
  all_goals module

theorem xiQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (xiQuarticFaceABCEG810 A B C D E F G).coeff (A.natDegree + 4 * B.natDegree) =
      (1 / 2048 : k) * xiQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [xiQuarticFaceABCEG810, xiQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB4 : ((A * B ^ 4)).natDegree = A.natDegree + 4 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 4 hBne), natDegree_pow]
  have hcf_AB4 : ((A * B ^ 4)).coeff (A.natDegree + 4 * B.natDegree) =
  ...
  rw [hcf_AB4, hcf_AB2E, hcf_B2C2, hcf_B2G, hcf_C2E, hcf_EG]
  ring

set_option maxHeartbeats 16000000 in
def omicronQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 65536 : k)) • (A ^ 3 * B ^ 3)
  + (15 / 16384 : k) • (A ^ 2 * B * C ^ 2)
  - (35 / 2048 : k) • (A * B ^ 3 * C)
  - (21 / 4096 : k) • B ^ 5
...
set_option maxHeartbeats 32000000 in
def degreeZeroOmicronQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(45 / 16384 : k)) • (A ^ 2 * B ^ 2 * D)
  - (5 / 2048 : k) • (A ^ 2 * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroOmicronQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroOmicronQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      omicronQuarticFaceABCEG810 A B C D E F G +
        degreeZeroOmicronQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroOmicronQuartic810, omicronQuarticFaceABCEG810, degreeZeroOmicronQuarticNoABCEG810]
  all_goals module

theorem omicronQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (omicronQuarticFaceABCEG810 A B C D E F G).coeff (3 * A.natDegree + 3 * B.natDegree) =
      (1 / 65536 : k) * omicronQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [omicronQuarticFaceABCEG810, omicronQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A3B3 : ((A ^ 3 * B ^ 3)).natDegree = 3 * A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 3 hAne) (pow_ne_zero 3 hBne), natDegree_pow, natDegree_pow]
  have hcf_A3B3 : ((A ^ 3 * B ^ 3)).coeff (3 * A.natDegree + 3 * B.natDegree) =
  ...
  have hcf_BE2 : ((B * E ^ 2)).coeff (3 * A.natDegree + 3 * B.natDegree) =
      B.leadingCoeff * E.leadingCoeff ^ 2 := by
    rw [← hdeg_BE2, coeff_natDegree, leadingCoeff_mul, leadingCoeff_pow]
  rw [hcf_A3B3, hcf_A2BC2, hcf_A2BG, hcf_AB3C, hcf_ABCE, hcf_B5, hcf_B3E, hcf_BC3, hcf_BCG, hcf_BE2]
  ring

set_option maxHeartbeats 16000000 in
def piQuarticFaceABCEG810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 4096 : k) • (A ^ 2 * B ^ 4)
  - (45 / 512 : k) • (A * B ^ 2 * C ^ 2)
  - (35 / 256 : k) • (B ^ 4 * C)
  + (5 / 64 : k) • (A * B ^ 2 * G)
...
set_option maxHeartbeats 32000000 in
def degreeZeroPiQuarticNoABCEG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 128 : k)) • (A * B ^ 3 * D)
  + (5 / 32 : k) • (A * B * C * F)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroPiQuartic810_eq_ABCEG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      piQuarticFaceABCEG810 A B C D E F G +
        degreeZeroPiQuarticNoABCEG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroPiQuartic810, piBaseGroupQuartic810,
    piBetaGroupQuartic810, piGammaGroupQuartic810, piDeltaGroupQuartic810,
    piEpsilonGroupQuartic810, piZetaGroupQuartic810, piEtaGroupQuartic810,
    piThetaGroupQuartic810, piQuarticFaceABCEG810, degreeZeroPiQuarticNoABCEG810]
  all_goals module

theorem piQuarticFaceABCEG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCEG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hEne : E ≠ 0)
    (hGne : G ≠ 0)
    : (piQuarticFaceABCEG810 A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) =
      (1 / 4096 : k) * piQuarticInnerABCEG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff E.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hEpos, hGpos, hAB, hAC, hAE, hAG, hDlt, hFlt⟩
  simp only [piQuarticFaceABCEG810, piQuarticInnerABCEG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A2B4 : ((A ^ 2 * B ^ 4)).natDegree = 2 * A.natDegree + 4 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 2 hAne) (pow_ne_zero 4 hBne), natDegree_pow, natDegree_pow]
  have hcf_A2B4 : ((A ^ 2 * B ^ 4)).coeff (2 * A.natDegree + 4 * B.natDegree) =
  ...
  have hcf_G2 : (G ^ 2).coeff (2 * A.natDegree + 4 * B.natDegree) =
      G.leadingCoeff ^ 2 := by
    rw [← hdeg_G2, coeff_natDegree, leadingCoeff_pow]
  rw [hcf_A2B4, hcf_AB2C2, hcf_AB2G, hcf_B4C, hcf_B2CE, hcf_C4, hcf_C2G, hcf_CE2, hcf_G2]
  ring
...
set_option maxHeartbeats 16000000 in
def kappaQuarticFaceABCFG810 (A B C D E F G : k[X]) : k[X] :=
  (5 / 512 : k) • (A * B ^ 3)
  - (15 / 128 : k) • (B * C ^ 2)
  + (5 / 16 : k) • (B * G)
  + (5 / 16 : k) • (C * F)
...
set_option maxHeartbeats 16000000 in
def degreeZeroKappaQuarticNoABCFG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 128 : k)) • (B ^ 2 * D)
  + (5 / 16 : k) • (D * E)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroKappaQuartic810_eq_ABCFG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      kappaQuarticFaceABCFG810 A B C D E F G +
        degreeZeroKappaQuarticNoABCFG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroKappaQuartic810, kappaQuarticFaceABCFG810, degreeZeroKappaQuarticNoABCFG810]
  all_goals module

theorem kappaQuarticFaceABCFG810_coeff_top
    {A B C D E F G : k[X]}
    ...
    (hFne : F ≠ 0)
    (hGne : G ≠ 0)
    : (kappaQuarticFaceABCFG810 A B C D E F G).coeff (A.natDegree + 3 * B.natDegree) =
      (1 / 512 : k) * kappaQuarticInnerABCFG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff F.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hFpos, hGpos, hAB, hAC, hAF, hAG, hDlt, hElt⟩
  simp only [kappaQuarticFaceABCFG810, kappaQuarticInnerABCFG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB3 : ((A * B ^ 3)).natDegree = A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 3 hBne), natDegree_pow]
  have hcf_AB3 : ((A * B ^ 3)).coeff (A.natDegree + 3 * B.natDegree) =
...
set_option maxHeartbeats 16000000 in
def muQuarticFaceABCFG810 (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * C)
  + (35 / 2048 : k) • B ^ 4
  - (5 / 64 : k) • (A * B * F)
  - (5 / 128 : k) • C ^ 3
...
set_option maxHeartbeats 16000000 in
def degreeZeroMuQuarticNoABCFG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 128 : k)) • (A * D ^ 2)
  - (15 / 128 : k) • (B ^ 2 * E)
...
set_option maxHeartbeats 16000000 in
theorem degreeZeroMuQuartic810_eq_ABCFG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      muQuarticFaceABCFG810 A B C D E F G +
        degreeZeroMuQuarticNoABCFG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroMuQuartic810, muQuarticFaceABCFG810, degreeZeroMuQuarticNoABCFG810]
  all_goals module

theorem muQuarticFaceABCFG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCFG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hFne : F ≠ 0)
    (hGne : G ≠ 0)
    : (muQuarticFaceABCFG810 A B C D E F G).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      (1 / 2048 : k) * muQuarticInnerABCFG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff F.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hFpos, hGpos, hAB, hAC, hAF, hAG, hDlt, hElt⟩
  simp only [muQuarticFaceABCFG810, muQuarticInnerABCFG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB2C : ((A * B ^ 2 * C)).natDegree = A.natDegree + 2 * B.natDegree + C.natDegree := by
    rw [natDegree_mul (mul_ne_zero hAne (pow_ne_zero 2 hBne)) hCne, natDegree_mul hAne (pow_ne_zero 2 hBne), natDegree_pow]
  have hcf_AB2C : ((A * B ^ 2 * C)).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
  ...
  have hcf_CG : ((C * G)).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) =
      C.leadingCoeff * G.leadingCoeff := by
    rw [← hdeg_CG, coeff_natDegree, leadingCoeff_mul]
  rw [hcf_AB2C, hcf_ABF, hcf_B4, hcf_C3, hcf_CG]
  ring

set_option maxHeartbeats 16000000 in
def nuQuarticFaceABCFG810 (A B C D E F G : k[X]) : k[X] :=
  (-(5 / 4096 : k)) • (A ^ 2 * B ^ 3)
  + (15 / 1024 : k) • (A * B * C ^ 2)
  + (35 / 512 : k) • (B ^ 3 * C)
  - (5 / 128 : k) • (A * B * G)
...
set_option maxHeartbeats 32000000 in
def degreeZeroNuQuarticNoABCFG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (45 / 1024 : k) • (A * B ^ 2 * D)
  - (5 / 128 : k) • (A * D * E)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroNuQuartic810_eq_ABCFG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroNuQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      nuQuarticFaceABCFG810 A B C D E F G +
        degreeZeroNuQuarticNoABCFG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroNuQuartic810, nuQuarticFaceABCFG810, degreeZeroNuQuarticNoABCFG810]
  all_goals module

theorem nuQuarticFaceABCFG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCFG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hFne : F ≠ 0)
    (hGne : G ≠ 0)
    : (nuQuarticFaceABCFG810 A B C D E F G).coeff (2 * A.natDegree + 3 * B.natDegree) =
      (1 / 4096 : k) * nuQuarticInnerABCFG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff F.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hFpos, hGpos, hAB, hAC, hAF, hAG, hDlt, hElt⟩
  simp only [nuQuarticFaceABCFG810, nuQuarticInnerABCFG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_A2B3 : ((A ^ 2 * B ^ 3)).natDegree = 2 * A.natDegree + 3 * B.natDegree := by
    rw [natDegree_mul (pow_ne_zero 2 hAne) (pow_ne_zero 3 hBne), natDegree_pow, natDegree_pow]
  have hcf_A2B3 : ((A ^ 2 * B ^ 3)).coeff (2 * A.natDegree + 3 * B.natDegree) =
  ...
  have hcf_B2F : ((B ^ 2 * F)).coeff (2 * A.natDegree + 3 * B.natDegree) =
      B.leadingCoeff ^ 2 * F.leadingCoeff := by
    rw [← hdeg_B2F, coeff_natDegree, leadingCoeff_mul, leadingCoeff_pow]
  rw [hcf_A2B3, hcf_ABC2, hcf_ABG, hcf_ACF, hcf_B3C, hcf_B2F]
  ring

set_option maxHeartbeats 16000000 in
def xiQuarticFaceABCFG810 (A B C D E F G : k[X]) : k[X] :=
  (-(15 / 2048 : k)) • (A * B ^ 4)
  + (45 / 512 : k) • (B ^ 2 * C ^ 2)
  - (5 / 64 : k) • (B ^ 2 * G)
  - (25 / 128 : k) • (B * C * F)
...
set_option maxHeartbeats 32000000 in
def degreeZeroXiQuarticNoABCFG810
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) : k[X] :=
  (15 / 512 : k) • (A * B ^ 2 * E)
  + (15 / 256 : k) • (A * B * C * D)
...
set_option maxHeartbeats 32000000 in
theorem degreeZeroXiQuartic810_eq_ABCFG_add_rest
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X]) :
    degreeZeroXiQuartic810 l beta gamma delta epsilon zeta eta theta A B C D E F G =
      xiQuarticFaceABCFG810 A B C D E F G +
        degreeZeroXiQuarticNoABCFG810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G := by
  simp only [degreeZeroXiQuartic810, xiQuarticFaceABCFG810, degreeZeroXiQuarticNoABCFG810]
  all_goals module

theorem xiQuarticFaceABCFG810_coeff_top
    {A B C D E F G : k[X]}
    (hcone : QuarticRatioConeABCFG810 A B C D E F G)
    (hAne : A ≠ 0)
    (hBne : B ≠ 0)
    ...
    (hFne : F ≠ 0)
    (hGne : G ≠ 0)
    : (xiQuarticFaceABCFG810 A B C D E F G).coeff (A.natDegree + 4 * B.natDegree) =
      (1 / 2048 : k) * xiQuarticInnerABCFG810 A.leadingCoeff B.leadingCoeff C.leadingCoeff F.leadingCoeff G.leadingCoeff := by
  rcases hcone with ⟨hApos, hBpos, hCpos, hFpos, hGpos, hAB, hAC, hAF, hAG, hDlt, hElt⟩
  simp only [xiQuarticFaceABCFG810, xiQuarticInnerABCFG810, coeff_add, coeff_sub, coeff_smul,
    smul_eq_mul]
  have hdeg_AB4 : ((A * B ^ 4)).natDegree = A.natDegree + 4 * B.natDegree := by
    rw [natDegree_mul hAne (pow_ne_zero 4 hBne), natDegree_pow]
  have hcf_AB4 : ((A * B ^ 4)).coeff (A.natDegree + 4 * B.natDegree) =
  ...
  have hcf_F2 : (F ^ 2).coeff (A.natDegree + 4 * B.natDegree) =
      F.leadingCoeff ^ 2 := by
    rw [← hdeg_F2, coeff_natDegree, leadingCoeff_pow]
  rw [hcf_AB4, hcf_B2C2, hcf_B2G, hcf_BCF, hcf_F2]
  ring
