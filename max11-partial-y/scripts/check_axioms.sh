...
THEOREMS="$BASE_THEOREMS $ROUTE_THEOREMS $DEGREE_THEOREMS $HISTORY_THEOREMS $HISTORY_DEGREE_THEOREMS $TOTAL_DEGREE_THEOREMS $COPRIME_DEGREE_THEOREMS $ENDPOINT_GCD_THEOREMS $LOW_SCALE_THEOREMS $LOW_SCALE_46_ROW_THEOREMS $LOW_SCALE_46_NORMAL_FORM_THEOREMS $LOW_SCALE_46_CURVE_THEOREMS $LOW_SCALE_46_LOCAL_CHART_THEOREMS $LOW_SCALE_46_ALIGNED_CHART_THEOREMS $LOW_SCALE_46_DEGREE_CONE_THEOREMS $LOW_SCALE_46_DEPRESSION_THEOREMS $LOW_SCALE_46_INTEGRALITY_THEOREMS $LOW_SCALE_46_NEWTON_FACE_THEOREMS $LOW_SCALE_46_POLYNOMIAL_ENDGAME_THEOREMS $LOW_SCALE_46_FINITE_POLE_THEOREMS $LOW_SCALE_46_ALIGNED_FINITE_POLE_THEOREMS $ASSEMBLY_THEOREMS"
