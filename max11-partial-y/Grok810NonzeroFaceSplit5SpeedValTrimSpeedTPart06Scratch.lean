...
theorem nonzeroFace5SpeedT_block20_eq_expansion
  ...
  unfold degreeZeroCompactBlock20Expansion810 Max11ReflectVal.polyR Max11ReflectVal.monoR
  dsimp only [List.zipWith, List.prod, List.sum, List.foldr, List.foldl]
  simp only [pow_zero, pow_one, one_mul, mul_one, degreeZeroCompactBlock20_810,
...
theorem nonzeroFace5SpeedT_block21_eq_expansion
  ...
  unfold degreeZeroCompactBlock21Expansion810 Max11ReflectVal.polyR Max11ReflectVal.monoR
  dsimp only [List.zipWith, List.prod, List.sum, List.foldr, List.foldl]
  simp only [pow_zero, pow_one, one_mul, mul_one, degreeZeroCompactBlock21_810,
    degreeZeroCompactToSourceIntegerScale810, degreeZeroLBar810, degreeZeroABar810, degreeZeroBBar810, degreeZeroCBar810, degreeZeroDBar810, degreeZeroEBar810, degreeZeroFBar810, degreeZeroGBar810, degreeZeroPBar810, degreeZeroQBar810, degreeZeroRBar810, degreeZeroSBar810, degreeZeroTBar810, degreeZeroUBar810, degreeZeroVBar810, degreeZeroWBar810]
  ring
...
theorem nonzeroFace5SpeedT_block22_eq_expansion
  ...
  unfold degreeZeroCompactBlock22Expansion810 Max11ReflectVal.polyR Max11ReflectVal.monoR
  dsimp only [List.zipWith, List.prod, List.sum, List.foldr, List.foldl]
  simp only [pow_zero, pow_one, one_mul, mul_one, degreeZeroCompactBlock22_810,
    degreeZeroCompactToSourceIntegerScale810, degreeZeroLBar810, degreeZeroABar810, degreeZeroBBar810, degreeZeroCBar810, degreeZeroDBar810, degreeZeroEBar810, degreeZeroFBar810, degreeZeroGBar810, degreeZeroPBar810, degreeZeroQBar810, degreeZeroRBar810, degreeZeroSBar810, degreeZeroTBar810, degreeZeroUBar810, degreeZeroVBar810, degreeZeroWBar810]
  ring
...
theorem nonzeroFace5SpeedT_block23_eq_expansion
  ...
  unfold degreeZeroCompactBlock23Expansion810 Max11ReflectVal.polyR Max11ReflectVal.monoR
  dsimp only [List.zipWith, List.prod, List.sum, List.foldr, List.foldl]
  simp only [pow_zero, pow_one, one_mul, mul_one, degreeZeroCompactBlock23_810,
    degreeZeroCompactToSourceIntegerScale810, degreeZeroLBar810, degreeZeroABar810, degreeZeroBBar810, degreeZeroCBar810, degreeZeroDBar810, degreeZeroEBar810, degreeZeroFBar810, degreeZeroGBar810, degreeZeroPBar810, degreeZeroQBar810, degreeZeroRBar810, degreeZeroSBar810, degreeZeroTBar810, degreeZeroUBar810, degreeZeroVBar810, degreeZeroWBar810]
  ring
