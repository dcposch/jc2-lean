import Sol68ScaleTwoIntegratedBoundaryScratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowOne_zero_scratch
  ...
  have hboundary :=
    T0.integratedLocalRowTwoBoundaryData_scratch hp hH hp6
  ...
  have hface := lowerRowOneHahn68_coeff_neg61_scratch
...
theorem lowerRowZeroHahn68_coeff_neg66_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowZero_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T0 : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  have hface := lowerRowZeroHahn68_coeff_neg66_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.localCubicCore_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T0 : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  · exact T0.topRowFour_zero_scratch hp hH hp6
  · exact T0.topRowThree_zero_scratch hp hH hp6
  · exact T0.topRowTwo_zero_scratch hp hH hp6
  · exact T0.topRowOne_zero_scratch hp hH hp6
  · exact T0.topRowZero_zero_scratch hp hH hp6
...
Newton box. -/
theorem SquareConstantLIntegratedLocalRootData68.source_p5_root_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T0 : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  obtain ⟨c, hc, hAco, hBco, hCco, hDco, hEco⟩ :=
    T0.coordinateInitialCoeffs_scratch hp hH hp6
  have hb := (T0.localCubicCore_scratch hp hH hp6).1
  have hBroot :
...
theorem SquareConstantLIntegratedLocalRootData68.source_scale_dvd_p5_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T0 : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  have hp5root : (p.coeff 5).IsRoot a := by
    dsimp only [a]
    exact T0.source_p5_root_zero_scratch hp hH hp6
...
#print axioms SquareConstantLIntegratedLocalRootData68.topRowOne_zero_scratch
#print axioms lowerRowZeroHahn68_coeff_neg66_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowZero_zero_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.localCubicCore_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.source_p5_root_zero_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.source_scale_dvd_p5_scratch
