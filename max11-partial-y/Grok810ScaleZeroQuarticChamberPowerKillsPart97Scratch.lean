...
theorem quarticChamberBDEFG12810_impossible
  ...
  have hct0 := kappaQuarticChamberFace7810_coeff_top_S18 hAne hBne hGne (C := C) (D := D) (E := E) (F := F) (by omega)
  ...
  have hct1 := xiQuarticChamberFace19810_coeff_top_S18 hAne hBne hEne hGne (C := C) (D := D) (F := F) (by omega)
