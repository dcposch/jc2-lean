...
theorem piQuarticChamberFace6810_coeff_top_S06
  ...
  simp only [piQuarticPowerInnerS06810]
  ring
...
theorem muQuarticChamberFace14810_coeff_top_S07
  ...
  have hc3 : (C ^ 3).coeff (A.natDegree + 2 * B.natDegree + C.natDegree) = C.leadingCoeff ^ 3 := by
    ...
    simp only [leadingCoeff_mul, leadingCoeff_pow]
  rw [hc0, hc1, hc2, hc3]
  simp only [muQuarticPowerInnerS07810]
  ring
...
theorem piQuarticChamberFace8810_coeff_top_S08
  ...
  have hc5 : (G ^ 2).coeff (2 * A.natDegree + 4 * B.natDegree) = G.leadingCoeff ^ 2 := by
    ...
    simp only [leadingCoeff_mul, leadingCoeff_pow]
  rw [hc0, hc1, hc2, hc3, hc4, hc5]
  simp only [piQuarticPowerInnerS08810]
  ring
...
theorem xiQuarticChamberFace20810_coeff_top_S15
  ...
  have hc1 : ((C ^ 2 * E)).coeff (A.natDegree + D.natDegree + F.natDegree) = C.leadingCoeff ^ 2 * E.leadingCoeff := by
    ...
    simp only [leadingCoeff_mul, leadingCoeff_pow]
  rw [hc0, hc1]
  simp only [xiQuarticPowerInnerS15810]
  ring
...
theorem quarticChamberBCEG5810_impossible
  ...
  have hr2 : (piQuarticChamberRest8810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest8810_natDegree_lt_of_live_BCEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hDz hFz (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace8810_coeff_top_S08 hAne hBne hCne hGne (D := D) (E := E) (F := F) (by omega) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
...
theorem quarticChamberBCDFG6810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest16810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest16810_natDegree_lt_of_live_BCDFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hEz (by omega) (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta (Or.inr (by omega)) hz0zeta (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hr2 : (piQuarticChamberRest14810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest14810_natDegree_lt_of_live_BCDFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hEz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
