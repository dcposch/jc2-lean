...
theorem quarticRefinedBCDEFG102L14810_impossible
  ...
  have hct0 := muQuarticChamberFace9003810_coeff_top hAne hCne hDne hGne (B := B) (E := E) (F := F) (by omega) (by omega)
  ...
  have hct1 := piQuarticChamberFace9003810_coeff_top hAne hCne hDne hGne (B := B) (E := E) (F := F) (by omega) (by omega) (by omega)
  ...
  have hct2 := n2QuarticChamberFace9003810_coeff_top hCne hDne hGne (A := A) (B := B) (E := E) (F := F) (by omega)
