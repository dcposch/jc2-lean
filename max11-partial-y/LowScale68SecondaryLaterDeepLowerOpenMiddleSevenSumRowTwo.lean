import LowScale68SecondaryLaterDeepLowerOpenMiddleSevenSum

/-! # Row two deletes the exceptional `zeta` load on `g+h=7n` -/
...
section LaterDeepLowerOpenMiddleSevenSumRowTwo68
...
theorem fiveRadiusReducedRowTwoRestPolynomial68_degree_lt_middleSevenSum
...
theorem derivative_quarterSquare_add_coeff_middleSevenSum68
    (A c : k[X]) (n g : ℕ) (hn : 0 < n) (hg : 0 < g)
...
theorem fiveRadiusReducedRowTwo_forces_zeta_at_middleSevenSum68
  ...
  rw [fiveRadiusReducedRowTwoPolynomial68_eq_rest_add, coeff_add,
    coeff_eq_zero_of_natDegree_lt
      (fiveRadiusReducedRowTwoRestPolynomial68_degree_lt_middleSevenSum
        gamma epsilon i4 A B c d e n g h hn hgh hh hopen hwall
        hA hB hc hd he),
...
theorem maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleSevenSumOrdinary68
  ...
  rw [selected.1, selected.2.1, hdelta] at hrow
  have hred := fiveRadiusReducedRowTwoPolynomial68_eq_zero
    alpha gamma epsilon zeta eta i4 Ae Be ce d ee hi4c hrow
  have hzeta := fiveRadiusReducedRowTwo_forces_zeta_at_middleSevenSum68
  ...
  exact ⟨hdelta, hzeta, classified.1, classified.2.1,
    classified.2.2.1, classified.2.2.2.1, classified.2.2.2.2⟩

#print axioms fiveRadiusReducedRowTwoRestPolynomial68_degree_lt_middleSevenSum
#print axioms derivative_quarterSquare_add_coeff_middleSevenSum68
#print axioms fiveRadiusReducedRowTwo_forces_zeta_at_middleSevenSum68
#print axioms maximalExpandedIntegratedPolynomialLowerSystem_laterDeepLowerOpenMiddleSevenSumOrdinary68

end LaterDeepLowerOpenMiddleSevenSumRowTwo68
