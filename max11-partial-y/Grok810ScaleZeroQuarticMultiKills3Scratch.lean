...
theorem degreeZeroKappaQuarticNoABCDE810_natDegree_lt
  ...
  simp only [degreeZeroKappaQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCDE810_natDegree_lt
  ...
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroMuQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCDE810_natDegree_lt
  ...
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroNuQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCDE810_natDegree_lt
  ...
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroXiQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCDE810_natDegree_lt
  ...
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroOmicronQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCDE810_natDegree_lt
  ...
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroPiQuarticNoABCDE810]
  compute_degree
  omega
...
theorem degreeZeroKappaQuarticNoABCDF810_natDegree_lt
  ...
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroKappaQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroMuQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroNuQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroXiQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroOmicronQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroPiQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroPrimitiveQuarticNoABCDF810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroPrimitiveQuarticNoABCDF810]
  compute_degree
  omega
...
theorem degreeZeroKappaQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroKappaQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroMuQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroNuQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroXiQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroOmicronQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCDG810_natDegree_lt
  ...
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroPiQuarticNoABCDG810]
  compute_degree
  omega
...
theorem degreeZeroKappaQuarticNoABCEF810_natDegree_lt
  ...
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroKappaQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroMuQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroNuQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroXiQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroOmicronQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroPiQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroPrimitiveQuarticNoABCEF810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hG1 : G.natDegree + 1 ≤ 4 * A.natDegree := Nat.succ_le_of_lt hGlt
  simp only [degreeZeroPrimitiveQuarticNoABCEF810]
  compute_degree
  omega
...
theorem degreeZeroKappaQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroKappaQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroMuQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroNuQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroXiQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroOmicronQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCEG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hF1 : 2 * F.natDegree + 1 ≤ 7 * A.natDegree := Nat.succ_le_of_lt hFlt
  simp only [degreeZeroPiQuarticNoABCEG810]
  compute_degree
  omega
...
theorem degreeZeroKappaQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroKappaQuarticNoABCFG810]
  compute_degree
  omega
...
theorem degreeZeroMuQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroMuQuarticNoABCFG810]
  compute_degree
  omega
...
theorem degreeZeroNuQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroNuQuarticNoABCFG810]
  compute_degree
  omega
...
theorem degreeZeroXiQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroXiQuarticNoABCFG810]
  compute_degree
  omega
...
theorem degreeZeroOmicronQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroOmicronQuarticNoABCFG810]
  compute_degree
  omega
...
theorem degreeZeroPiQuarticNoABCFG810_natDegree_lt
  ...
  have hD1 : 2 * D.natDegree + 1 ≤ 5 * A.natDegree := Nat.succ_le_of_lt hDlt
  have hE1 : E.natDegree + 1 ≤ 3 * A.natDegree := Nat.succ_le_of_lt hElt
  simp only [degreeZeroPiQuarticNoABCFG810]
  compute_degree
  omega
