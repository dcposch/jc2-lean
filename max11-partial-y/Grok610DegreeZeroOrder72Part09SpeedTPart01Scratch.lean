import Grok610DegreeZeroOrder72Part09SpeedTScratch
...
/-- Compatibility check using the existing evaluation theorem's unchanged proof. -/
private theorem order72Part09SpeedTEvalCompat
