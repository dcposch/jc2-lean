...
theorem quarticChamberBDEFG43810_impossible
  ...
  have hrest : (xiQuarticChamberRest10810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest10810_natDegree_lt_of_live_BDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdpos hCz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hzl hzbeta (Or.inr ⟨by omega, by omega, by omega⟩) hzdelta (Or.inr ⟨by omega, by omega, by omega⟩) (Or.inr ⟨by omega, by omega⟩) (Or.inr ⟨by omega, by omega⟩) (Or.inr (by omega))
