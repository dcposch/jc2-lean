...
def omicronResidual810
    (L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 V0 W0 : F) : F := by
  refine ?_ - (5 / 32 : F) * B * D0 * F0
    - (5 / 64 : F) * B * E0 ^ 2
    - (5 / 64 : F) * C0 ^ 2 * F0
    - (25 / 128 : F) * C0 * D0 * E0
    - (5 / 128 : F) * D0 ^ 3
    + (5 / 16 : F) * F0 * G0
  refine ?_ + (15 / 64 : F) * A * B * C0 * E0
    + (135 / 1024 : F) * A * B * D0 ^ 2
  ...
  refine ?_ - (945 / 65536 : F) * L * A * B ^ 4
    ...
    - (27 / 1024 : F) * L * B ^ 2 * G0
  refine ?_ + (19845 / 2097152 : F) * L * A ^ 5 * C0
  ...
  refine ?_ + (21 / 256 : F) * betaResidual810 L A B Q * B * C0 * D0
  ...
  refine ?_ - (261 / 2048 : F) * gammaResidual810 L A B C0 P R * A ^ 2 * B * C0
  ...
  refine ?_ - (45 / 512 : F) * deltaResidual810 L A B C0 D0 P Q S0 * A ^ 2 * B ^ 2
  ...
  refine ?_ + (1 / 32 : F) * epsilonResidual810 L A B C0 D0 E0 P Q R T0 * B ^ 3
  ...
  refine ?_ - (9 / 64 : F) * zetaResidual810 L A B C0 D0 E0 F0 P Q R S0 U0 * B * D0
  ...
  exact (1 / 8 : F) * thetaResidual810 L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 W0 * E0
...
def localClearedFifteenthDefectBlock0_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (1781077928509440 : R) * h ^ 32 * a7 ^ 9 * a5 ^ 2
  ...
  refine ?_ - (3324678799884288 : R) * h ^ 30 * a7 ^ 9 * a5 * b7
  ...
  refine ?_ + (3116886374891520 : R) * h ^ 22 * a7 ^ 10 * a6 * b7
...
def localClearedFifteenthDefectBlock1_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (81386925906198528 : R) * h ^ 46 * a7 ^ 5 * a6 ^ 2 * a5 * b7
  ...
  refine ?_ - (3321915343110144 : R) * h ^ 46 * a7 ^ 7 * a4 * b6
  ...
  refine ?_ + (992441432801280 : R) * h ^ 40 * a7 ^ 9 * a2
  ...
  exact (32665500873916416 : R) * h ^ 38 * a7 ^ 7 * a6 * a4 * b8
...
def localClearedFifteenthDefectBlock2_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (15198305491353600 : R) * h ^ 54 * a7 ^ 4 * a6 ^ 3 * b5
  ...
  refine ?_ + (4863457757233152 : R) * h ^ 54 * a7 ^ 6 * a1 * b8
  ...
  refine ?_ + (67822438255165440 : R) * h ^ 48 * a7 ^ 5 * a6 ^ 3 * a4
  ...
  exact - (32155102422761472 : R) * h ^ 47 * a7 ^ 6 * a6 * a5 ^ 2 * lambda
...
def localClearedFifteenthDefectBlock3_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (113103668772864 : R) * h ^ 62 * a7 ^ 6 * b1
  ...
  refine ?_ - (27356949884436480 : R) * h ^ 56 * a7 ^ 5 * a6 * a5 * a3
  ...
  refine ?_ + (8720027775664128 : R) * h ^ 55 * a7 ^ 5 * a5 ^ 3 * lambda
  ...
  exact (145903732716994560 : R) * h ^ 54 * a7 ^ 3 * a6 ^ 2 * a5 ^ 2 * b8
...
def localClearedFifteenthDefectBlock4_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (27144880505487360 : R) * h ^ 62 * a7 * a6 ^ 4 * a4 * b8
  ...
  refine ?_ - (54289761010974720 : R) * h ^ 62 * a7 ^ 3 * a5 ^ 2 * a4 * b8
  ...
  refine ?_ - (9048293501829120 : R) * h ^ 62 * a7 ^ 3 * a6 ^ 3 * b4
  ...
  exact - (16965550315929600 : R) * h ^ 62 * a7 ^ 4 * a6 * a4 * b5
...
def localClearedFifteenthDefectBlock5_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (1551136028884992 : R) * h ^ 70 * a7 ^ 4 * a5 * b2
  ...
  refine ?_ + (67862201263718400 : R) * h ^ 64 * a7 ^ 3 * a6 ^ 2 * a4 ^ 2
  ...
  refine ?_ - (1696555031592960 : R) * h ^ 64 * a7 ^ 5 * a5 * a1
  ...
  exact - (20517712413327360 : R) * h ^ 63 * a7 ^ 4 * a6 * a4 ^ 2 * lambda
...
def localClearedFifteenthDefectBlock6_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (18613632346619904 : R) * h ^ 70 * a7 * a6 ^ 3 * a4 * b6
  ...
  refine ?_ + (65147713213169664 : R) * h ^ 70 * a7 ^ 2 * a6 * a5 * a3 * b7
  ...
  refine ?_ + (24818176462159872 : R) * h ^ 70 * a7 ^ 3 * a4 * a2 * b8
  ...
  exact (18613632346619904 : R) * h ^ 70 * a7 ^ 3 * a6 * a2 * b6
...
def localClearedFifteenthDefectBlock7_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (31022720577699840 : R) * h ^ 72 * a7 ^ 3 * a6 * a5 * a1
  ...
  refine ?_ + (3817248821084160 : R) * h ^ 71 * a7 ^ 2 * a5 ^ 4 * lambda
  ...
  refine ?_ + (3817248821084160 : R) * h ^ 71 * a7 ^ 4 * a3 ^ 2 * lambda
  ...
  exact (775568014442496 : R) * h ^ 70 * a6 ^ 5 * b5
...
def localClearedFifteenthDefectBlock8_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (16545450974773248 : R) * h ^ 78 * a7 ^ 2 * a4 * a3 * b6
  ...
  refine ?_ - (13787875812311040 : R) * h ^ 78 * a7 ^ 2 * a6 * a2 * b5
  ...
  refine ?_ - (919191720820736 : R) * h ^ 78 * a7 ^ 3 * a5 * b1
  ...
  exact - (98884921841418240 : R) * h ^ 72 * a7 ^ 2 * a6 * a5 * a4 ^ 2
...
def localClearedFifteenthDefectBlock9_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (5515150324924416 : R) * h ^ 78 * a6 * a5 ^ 3 * b6
  ...
  refine ?_ - (4595958604103680 : R) * h ^ 78 * a6 ^ 3 * a4 * b5
  ...
  refine ?_ - (22060601299697664 : R) * h ^ 78 * a7 * a6 * a3 ^ 2 * b8
  ...
  exact - (19303026137235456 : R) * h ^ 78 * a7 * a6 ^ 2 * a1 * b7
...
def localClearedFifteenthDefectBlock10_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (20681813718466560 : R) * h ^ 80 * a7 * a6 * a4 ^ 3
  ...
  refine ?_ + (15511360288849920 : R) * h ^ 80 * a7 ^ 2 * a5 ^ 2 * a1
  ...
  refine ?_ - (20940336389947392 : R) * h ^ 79 * a7 * a6 * a5 * a4 ^ 2 * lambda
  ...
  exact - (20940336389947392 : R) * h ^ 79 * a7 ^ 2 * a6 * a5 * a1 * lambda
...
def localClearedFifteenthDefectBlock11_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (5805421394657280 : R) * h ^ 86 * a6 ^ 2 * a2 * b5
  ...
  refine ?_ + (16255179905040384 : R) * h ^ 86 * a7 * a4 * a1 * b7
  ...
  refine ?_ + (13933011347177472 : R) * h ^ 86 * a7 * a6 * a0 * b6
  ...
  exact (1161084278931456 : R) * h ^ 86 * a7 ^ 2 * a4 * b1
...
def localClearedFifteenthDefectBlock12_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (6204544115539968 : R) * h ^ 87 * a6 * a5 ^ 2 * a2 * lambda
  ...
  refine ?_ + (12409088231079936 : R) * h ^ 87 * a7 * a6 * a4 * a1 * lambda
  ...
  refine ?_ + (6966505673588736 : R) * h ^ 86 * a5 * a4 ^ 2 * b6
  ...
  exact (13933011347177472 : R) * h ^ 86 * a6 * a4 * a3 * b6
...
def localClearedFifteenthDefectBlock13_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ - (2533274790395904 : R) * h ^ 94 * a4 ^ 2 * b3
  ...
  refine ?_ - (3377699720527872 : R) * h ^ 94 * a6 * a3 * b2
  ...
  refine ?_ - (27575751624622080 : R) * h ^ 88 * a6 * a5 * a3 ^ 2
  ...
  exact - (14513553486643200 : R) * h ^ 88 * a7 * a5 ^ 2 * a0
...
def localClearedFifteenthDefectBlock14_810
    {R : Type*} [CommRing R]
    (h a7 a6 a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3 b2 b1 lambda : R) : R := by
  refine ?_ + (3870280929771520 : R) * h ^ 96 * a3 ^ 3
  ...
  refine ?_ - (2612439627595776 : R) * h ^ 95 * a4 * a3 ^ 2 * lambda
  ...
  exact - (13510798882111488 : R) * h ^ 94 * a2 * a1 * b8
