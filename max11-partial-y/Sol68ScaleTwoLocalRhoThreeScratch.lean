import Sol68ScaleTwoLocalRhoFourScratch
...
theorem algebraMap_cancel_factoredClearing_scratch
...
theorem SquareConstantLIntegratedSourceData68.clearedCoordinatesRhoThree_scratch
  ...
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · exact algebraMap_cancel_factoredClearing_scratch h0 _ A3 S.A 2 3 2
      hh0 hfA hA
  · exact algebraMap_cancel_factoredClearing_scratch h0 _ B3 S.B 2 3 3
      hh0 hfB hB
  · exact algebraMap_cancel_factoredClearing_scratch h0 _ C3 S.C0 2 3 4
      hh0 hfC hC
  · exact algebraMap_cancel_factoredClearing_scratch h0 _ D3 S.D 2 3 5
      hh0 hfD hD
  · exact algebraMap_cancel_factoredClearing_scratch h0 _ E3 S.E 2 3 6
      hh0 hfE hE

theorem SquareConstantLIntegratedLocalRootData68.coordinateOrderBoundsRhoThree_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinatesRhoThree_scratch hp T.scale_ne_zero hH hp6 hp5
  exact ⟨
...
theorem SquareConstantLIntegratedLocalRootData68.coordinateInitialCoeffsRhoThree_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) (hp5 : p.coeff 5 = h0 ^ 2 * g) :
  ...
  obtain ⟨c, hc, hsingle⟩ := ratFuncAtHahn68_linearRoot_eq_single_scratch
    h0 T.root T.scale_degree T.root_eq
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinatesRhoThree_scratch hp T.scale_ne_zero hH hp6 hp5
  exact ⟨c, hc,
    localHahn_coeff_neg_of_cleared_scratch T.root c h0
...
theorem firstIntegralFourHigherHahn68_coeff_at_rho_scratch
    (rho : ℚ) (hrho : 0 < rho)
  ...
  have hzero (c : k) (aA aB aC aD aE : ℕ)
    ...
    exact weightedMonomial68_orderTop_gt_scratch c A B C0 D E
...
theorem firstIntegralFourTopFaceHahn68_coeff_at_rho_scratch
...
theorem firstIntegralFour68_coeff_at_rho_scratch
    (rho : ℚ) (hrho : 0 < rho)
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-2 * rho) : WithTop ℚ) ≤ A.orderTop)
  ...
  rw [firstIntegralFour68_eq_localFaces_scratch, HahnSeries.coeff_add,
    firstIntegralFourTopFaceHahn68_coeff_at_rho_scratch rho A B C0 D E
      hA hB hC hD hE,
    firstIntegralFourHigherHahn68_coeff_at_rho_scratch rho hrho
      L beta gamma delta epsilon zeta A B C0 D E hA hB hC hD hE,
    add_zero]

theorem SquareConstantLIntegratedLocalRootData68.topRowFourRhoThree_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) (hp5 : p.coeff 5 = h0 ^ 2 * g) :
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ := T.coordinateOrderBoundsRhoThree_scratch
    hp hH hp6 hp5
  ...
  rw [hconst] at hcoeff
  have hface := firstIntegralFour68_coeff_at_rho_scratch 3 (by norm_num)
...
theorem SquareConstantLIntegratedLocalRootData68.source_scale_cube_dvd_p5_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) : h0 ^ 3 ∣ p.coeff 5 := by
  obtain ⟨g, hp5⟩ := T.source_scale_sq_dvd_p5_scratch hp hH hp6
  have htop := T.topRowFourRhoThree_zero_scratch hp hH hp6 hp5
  obtain ⟨c, hc, hAco, hBco, hCco, hDco, hEco⟩ :=
    T.coordinateInitialCoeffsRhoThree_scratch hp hH hp6 hp5
...
#print axioms SquareConstantLIntegratedSourceData68.clearedCoordinatesRhoThree_scratch
#print axioms firstIntegralFour68_coeff_at_rho_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowFourRhoThree_zero_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.source_scale_cube_dvd_p5_scratch
