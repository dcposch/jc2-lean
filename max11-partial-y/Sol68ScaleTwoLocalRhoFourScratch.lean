import Sol68ScaleTwoLocalRowOneZeroScratch
...
theorem algebraMap_rhoFour_of_factoredClearing_scratch
...
theorem SquareConstantLIntegratedSourceData68.clearedCoordinatesRhoFour_scratch
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    S.clearedCoordinates_scratch hp hh0 hH hp6
  ...
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · exact algebraMap_rhoFour_of_factoredClearing_scratch h0 _ A4 S.A 2
      hh0 hfA hA
  · exact algebraMap_rhoFour_of_factoredClearing_scratch h0 _ B4 S.B 3
      hh0 hfB hB
  · exact algebraMap_rhoFour_of_factoredClearing_scratch h0 _ C4 S.C0 4
      hh0 hfC hC
  · exact algebraMap_rhoFour_of_factoredClearing_scratch h0 _ D4 S.D 5
      hh0 hfD hD
  · exact algebraMap_rhoFour_of_factoredClearing_scratch h0 _ E4 S.E 6
      hh0 hfE hE

/-- Improved local order box after `p₅ = h g`. -/
theorem SquareConstantLIntegratedLocalRootData68.coordinateOrderBoundsRhoFour_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinatesRhoFour_scratch hp T.scale_ne_zero hH hp6 hp5
  exact ⟨
    localHahn_orderTop_ge_of_cleared_scratch T.root h0
...
theorem SquareConstantLIntegratedLocalRootData68.coordinateInitialCoeffsRhoFour_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) (hp5 : p.coeff 5 = h0 * g) :
  ...
  obtain ⟨c, hc, hsingle⟩ :=
    ratFuncAtHahn68_linearRoot_eq_single_scratch
      h0 T.root T.scale_degree T.root_eq
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinatesRhoFour_scratch hp T.scale_ne_zero hH hp6 hp5
  refine ⟨c, hc, ?_, ?_, ?_, ?_, ?_⟩
  · exact localHahn_coeff_neg_of_cleared_scratch T.root c h0
...
theorem firstIntegralFourHigherHahn68_coeff_neg36_scratch
  ...
  have hzero (c : k) (aA aB aC aD aE : ℕ)
    ...
    have h := weightedMonomial68_orderTop_gt_scratch c A B C0 D E
...
theorem firstIntegralFourTopFaceHahn68_coeff_neg36_scratch
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-8 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-12 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    (hC : (↑(-16 : ℚ) : WithTop ℚ) ≤ C0.orderTop)
  ...
  have hE4 : (↑(-6 * (4 : ℚ)) : WithTop ℚ) ≤ E.orderTop := by
    norm_num
    exact hE
  have h1 := weightedMonomial68_coeff_at_weight_scratch
    (-8 / 27 : k) A B C0 D E 0 3 0 0 0 4 hA4 hB4 hC4 hD4 hE4
  have h2 := weightedMonomial68_coeff_at_weight_scratch
    (-8 / 9 : k) A B C0 D E 2 0 0 1 0 4 hA4 hB4 hC4 hD4 hE4
  have h3 := weightedMonomial68_coeff_at_weight_scratch
    (8 / 3 : k) A B C0 D E 0 1 0 0 1 4 hA4 hB4 hC4 hD4 hE4
  have h4 := weightedMonomial68_coeff_at_weight_scratch
    (8 / 3 : k) A B C0 D E 0 0 1 1 0 4 hA4 hB4 hC4 hD4 hE4
  have h5 := weightedMonomial68_coeff_at_weight_scratch
    (40 / 81 : k) A B C0 D E 3 1 0 0 0 4 hA4 hB4 hC4 hD4 hE4
  have h6 := weightedMonomial68_coeff_at_weight_scratch
...
theorem firstIntegralFour68_coeff_neg36_scratch
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-8 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-12 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    ...
    (firstIntegralFour68 (HahnSeries.C L) A B C0 D E
      ...
      (8 / 81 : k) * topRowFour68 (A.coeff (-8 : ℚ))
        (B.coeff (-12 : ℚ)) (C0.coeff (-16 : ℚ))
        (D.coeff (-20 : ℚ)) (E.coeff (-24 : ℚ)) := by
  rw [firstIntegralFour68_eq_localFaces_scratch, HahnSeries.coeff_add,
    firstIntegralFourTopFaceHahn68_coeff_neg36_scratch A B C0 D E
      hA hB hC hD hE,
    firstIntegralFourHigherHahn68_coeff_neg36_scratch
      L beta gamma delta epsilon zeta A B C0 D E hA hB hC hD hE,
    add_zero]

theorem SquareConstantLIntegratedLocalRootData68.topRowFourRhoFour_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H g : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) (hp5 : p.coeff 5 = h0 * g) :
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.coordinateOrderBoundsRhoFour_scratch hp hH hp6 hp5
  ...
  rw [hconst] at hcoeff
  have hface := firstIntegralFour68_coeff_neg36_scratch
...
unique root. -/
theorem linearPolynomial_dvd_of_eval_eq_zero_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.source_scale_sq_dvd_p5_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) : h0 ^ 2 ∣ p.coeff 5 := by
  obtain ⟨g, hp5⟩ := T.source_scale_dvd_p5_scratch hp hH hp6
  have htop := T.topRowFourRhoFour_zero_scratch hp hH hp6 hp5
  obtain ⟨c, hc, hAco, hBco, hCco, hDco, hEco⟩ :=
    T.coordinateInitialCoeffsRhoFour_scratch hp hH hp6 hp5
  ...
  have hgdiv : h0 ∣ g := linearPolynomial_dvd_of_eval_eq_zero_scratch
...
#print axioms SquareConstantLIntegratedSourceData68.clearedCoordinatesRhoFour_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateOrderBoundsRhoFour_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateInitialCoeffsRhoFour_scratch
#print axioms firstIntegralFour68_coeff_neg36_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowFourRhoFour_zero_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.source_scale_sq_dvd_p5_scratch
