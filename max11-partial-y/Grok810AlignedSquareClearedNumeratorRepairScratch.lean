...
theorem alignedSquareClearedNumerator810_eq_scaledSourcePrimitive
  ...
  have hextra :
    ...
    rw [alignedSquareClearedIntegerScale810_eq_grouped_mul, mul_comm]
  rw [hsrc, ← hexp, hwt', hcr, ← hpeel]
  rw [mul_left_comm (alignedSquareCompactToSourceIntegerScale810 : F)]
  rw [← mul_assoc (alignedSquareCompactToSourceIntegerScale810 : F)]
  rw [hextra]
