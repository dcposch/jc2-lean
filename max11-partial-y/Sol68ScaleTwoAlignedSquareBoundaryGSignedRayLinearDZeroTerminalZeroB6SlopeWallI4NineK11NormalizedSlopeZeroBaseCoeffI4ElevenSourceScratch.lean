import Sol68ScaleTwoAlignedSquareBoundaryGSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI3ElevenC13TransportScratch

/-! # Exact source-backed `I4(11)` after the `C[12]` transport -/
...
section AlignedSquareBoundaryGSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI4ElevenSource68

variable {k : Type*} [Field k] [CharZero k] [IsAlgClosed k]

def rhoOne_boundaryG_i4elevenFactoredSourceRow68
  ...
  (rhoOneI4ZeroFactored68 (HahnSeries.C T.source.gamma)
    (HahnSeries.C T.source.epsilon) B C F G).coeff 11

omit [IsAlgClosed k] in
theorem ratFunc_boundaryG_i4eleven_factored68
    ...
    (rhoOneI4ZeroFactored68 (HahnSeries.C gamma)
      ...
      (ratFuncAtHahn46 root F) (ratFuncAtHahn46 root G)).coeff 11 = 0 := by
  ...
  have hc := congrArg (fun X : HahnSeries ℚ k => X.coeff 11) hi4H'
  simpa [HahnSeries.C_apply] using hc

theorem SquareZeroLIntegratedLocalRootData68.rhoOne_boundaryG_i4eleven_factored_source68
    {p q : k[X][X]} {j : k} {h0 g u : k[X]}
    (T : SquareZeroLIntegratedLocalRootData68 p q j h0)
    (Q : RhoOneAlignedSquareGNegTwoBoundaryQuadraticResidual68 T g u) :
    rhoOne_boundaryG_i4elevenFactoredSourceRow68 T = 0 := by
  have Qc := Q
  ...
  have hrow := ratFunc_boundaryG_i4eleven_factored68 T.root T.source.gamma
    T.source.epsilon i4 B C F G hi4f
  rw [hCmap, hFmap, hGmap] at hrow
  exact hrow

def RhoOneAlignedSquareGNegTwoSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI4ElevenSource68
    {p q : k[X][X]} {j : k} {h0 : k[X]}
    (T : SquareZeroLIntegratedLocalRootData68 p q j h0) : Prop :=
  RhoOneAlignedSquareGNegTwoSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI3ElevenC13Transport68 T ∧
  rhoOne_boundaryG_i4elevenFactoredSourceRow68 T = 0

theorem SquareZeroLIntegratedLocalRootData68.rhoOne_boundaryG_signedRay_linear_dZero_terminal_zero_B6_slope_wall_i4nine_K11_normalized_slope_zero_Base_coeff_i4eleven_source68
    {p q : k[X][X]} {j : k} {h0 g u : k[X]}
    (T : SquareZeroLIntegratedLocalRootData68 p q j h0)
    (Q : RhoOneAlignedSquareGNegTwoBoundaryQuadraticResidual68 T g u)
    (R : RhoOneAlignedSquareGNegTwoSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI3ElevenC13Transport68 T) :
    RhoOneAlignedSquareGNegTwoSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI4ElevenSource68 T := by
  exact ⟨R, T.rhoOne_boundaryG_i4eleven_factored_source68 Q⟩

end AlignedSquareBoundaryGSignedRayLinearDZeroTerminalZeroB6SlopeWallI4NineK11NormalizedSlopeZeroBaseCoeffI4ElevenSource68
