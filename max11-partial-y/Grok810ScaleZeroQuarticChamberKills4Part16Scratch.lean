...
theorem quarticChamberBCEG18810_impossible
  ...
  have hr0 : (kappaQuarticChamberRest10810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest10810_natDegree_lt_of_live_BCEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hDz hFz (by omega) hz0l hz0beta (Or.inr (by omega)) hz0delta hz0zeta (Or.inr (by omega)) (Or.inr (by omega))
  have hct0 := kappaQuarticChamberFace10810_coeff_top hBne hCne hGne (A := A) (D := D) (E := E) (F := F) (by omega)
  ...
  have hr1 : (muQuarticChamberRest11810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest11810_natDegree_lt_of_live_BCEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hDz hFz (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := muQuarticChamberFace11810_coeff_top hCne hEne hGne (A := A) (B := B) (D := D) (F := F) (by omega) (by omega)
  ...
  have hr2 : (piQuarticChamberRest4810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest4810_natDegree_lt_of_live_BCEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hDz hFz (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace4810_coeff_top hCne hEne hGne (A := A) (B := B) (D := D) (F := F) (by omega) (by omega) (by omega)
