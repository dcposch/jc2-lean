...
theorem omicronQuarticChamberRestLF6001810_natDegree_lt_of_live_BCF
  ...
  have hpow7 : (0 : k[X]) ^ 7 = 0 := zero_pow (by decide)
  have hpow8 : (0 : k[X]) ^ 8 = 0 := zero_pow (by decide)
  simp only [omicronQuarticChamberRestLF6001810, hpow2, hpow3, hpow4, hpow5, hpow6, hpow7, hpow8, zero_mul, mul_zero, zero_smul, smul_zero, add_zero, zero_add, sub_zero, zero_sub, neg_zero, natDegree_zero]
  compute_degree
  omega
...
theorem primitiveQuarticChamberRestLF6001810PartBCF1810_natDegree_lt
  ...
  simp only [primitiveQuarticChamberRestLF6001810PartBCF1810]
  compute_degree
  omega
...
theorem primitiveQuarticChamberRestLF6001810PartBCF2810_natDegree_lt
  ...
  simp only [primitiveQuarticChamberRestLF6001810PartBCF2810]
  compute_degree
  omega
...
theorem primitiveQuarticChamberRestLF6000810PartBCG1810_natDegree_lt
  ...
  simp only [primitiveQuarticChamberRestLF6000810PartBCG1810]
  compute_degree
  omega
...
theorem primitiveQuarticChamberRestLF6000810PartBCG2810_natDegree_lt
  ...
  simp only [primitiveQuarticChamberRestLF6000810PartBCG2810]
  compute_degree
  omega
