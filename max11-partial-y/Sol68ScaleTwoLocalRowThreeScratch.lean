import Sol68ScaleTwoLocalInitialFormsScratch
...
theorem firstIntegralThree68_eq_localFaces_scratch
    (L beta gamma delta epsilon zeta : k)
...
theorem firstIntegralThreeHigherHahn68_coeff_neg50_scratch
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
...
theorem firstIntegralThreeTopFaceHahn68_coeff_neg50_scratch
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-10 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-15 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    (hC : (↑(-20 : ℚ) : WithTop ℚ) ≤ C0.orderTop)
  ...
  have h7 := weightedMonomial68_coeff_at_weight_scratch
    (20 / 27 : k) A B C0 D E 2 2 0 0 0 5 hA5 hB5 hC5 hD5 hE5
  have h8 := weightedMonomial68_coeff_at_weight_scratch
    (40 / 81 : k) A B C0 D E 3 0 1 0 0 5 hA5 hB5 hC5 hD5 hE5
  have h9 := weightedMonomial68_coeff_at_weight_scratch
...
theorem firstIntegralThree68_coeff_neg50_scratch
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-10 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-15 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    ...
    (firstIntegralThree68 (HahnSeries.C L) A B C0 D E
      ...
      (-4 / 243 : k) * topRowThree68 (A.coeff (-10 : ℚ))
        (B.coeff (-15 : ℚ)) (C0.coeff (-20 : ℚ))
        (D.coeff (-25 : ℚ)) (E.coeff (-30 : ℚ)) := by
  rw [firstIntegralThree68_eq_localFaces_scratch,
    HahnSeries.coeff_add,
    firstIntegralThreeTopFaceHahn68_coeff_neg50_scratch A B C0 D E
      hA hB hC hD hE,
    firstIntegralThreeHigherHahn68_coeff_neg50_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowThree_zero_scratch
  ...
  rw [hconst] at hcoeff
  have hface := firstIntegralThree68_coeff_neg50_scratch
...
#print axioms firstIntegralThree68_eq_localFaces_scratch
#print axioms firstIntegralThreeHigherHahn68_coeff_neg50_scratch
#print axioms firstIntegralThreeTopFaceHahn68_coeff_neg50_scratch
#print axioms firstIntegralThree68_coeff_neg50_scratch
#print axioms firstIntegralThreeLocalTopFaceRoute68_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowThree_zero_scratch
