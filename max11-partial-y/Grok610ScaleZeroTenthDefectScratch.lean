...
theorem normalized610ScaleZero_eleventhCoefficientJacobianRow
  ...
  simpa only [p, q] using eleventhCoefficientJacobianRow_610 hp hq hjac
...
theorem scaleZero_eleventhCoefficientJacobianRow_610
  ...
  have hrow := eleventhCoefficientJacobianRow_610 hp hq hjac
...
theorem localClearedEleventhDefect610_of_lambda_zero
    ...
    localClearedEleventhDefect610 h a5 a4 a3 a2 a1 a0 b8 b7 b6 b5 b4 b3
        b2 b1 0 := by
  simp only [localClearedEleventhDefect610, map_zero, Polynomial.C_0,
    mul_zero, add_zero, sub_zero, zero_mul]
...
theorem kappaResidual610_deriv_zero
  ...
  simp only [hWderiv, hPderiv, hQderiv, hRderiv, hSderiv, hTderiv, hUderiv,
    hVderiv] at hrow_red
  simp only [kappaResidual610, alphaResidual610, betaResidual610,
    gammaResidual610, deltaResidual610, epsilonResidual610,
    zetaResidual610, etaResidual610, thetaResidual610, map_sub, map_add,
    Derivation.leibniz, smul_eq_mul, h2, h3, h4, h5, h6, h7, h8, h9, h12,
    h16, h23, h32, h43, h53, h56c, h76, h109, h49, h772, h581, h736,
    h1027, h572, h527, h427, h351296, h20243, h38, h34, h316, h3128, hL,
    halpha, hbeta, hgamma, hdelta, hepsilon, hzeta, heta, htheta,
    zero_mul, add_zero, mul_zero, pow_two, pow_three, hsq, hsqB, hsqC,
    hcub, hcubB, hquar]
  simp only [hWderiv, hPderiv, hQderiv, hRderiv, hSderiv, hTderiv, hUderiv,
    hVderiv]
  ring_nf at hrow_red ⊢
