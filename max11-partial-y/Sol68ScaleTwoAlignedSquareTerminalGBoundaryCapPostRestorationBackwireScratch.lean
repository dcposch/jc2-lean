import Sol68ScaleTwoAlignedSquareTerminalGBoundaryCapPostRestorationT6RowsScratch
...
section AlignedSquareTerminalGBoundaryCapPostRestorationBackwire68

variable {k : Type*} [Field k] [CharZero k]

local instance alignedSquareCapPostRestorationBackwireHahnCharZero68 :
    CharZero (LaurentSeries k) :=
  charZero_of_injective_ringHom
    (HahnSeries.C_injective (R := k) (Γ := ℤ))

def RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationPacket68
  ...
  RhoOneDoubleZeroTerminalGBoundaryCapI4SixteenPacket68
    ...
    rhoOneCapCoordinateDefectT6Core68 B C F =
      -(2 / 3 : k) * A.coeff (-2 : ℚ) * B.coeff 11 ^ 2

def RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationResidual68
...
theorem SquareZeroLIntegratedLocalRootData68.rhoOne_exceptional_doubleZero_refinedGZero_terminalGBoundaryCapPostRestorationResidual
    [IsAlgClosed k]
  ...
  dsimp only [RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationResidual68]
  have hprevRaw :=
    T.rhoOne_exceptional_doubleZero_refinedGZero_terminalGBoundaryCapI4SixteenResidual
  ...
  · left
    ...
    have hI3nineResidual := hprev.1.1.1.1.1.1.1.1
    ...
    · rcases hboundary with ⟨hcurrent, hf2, hF3, hb4, hB5,
      ...
      have hT6 : rhoOneCapCoordinateDefectT6Core68
          (ratFuncAtHahn46 T.root T.source.B)
          (rhoOneCDefectHahn68 (ratFuncAtHahn46 T.root T.source.A)
            (ratFuncAtHahn46 T.root T.source.C0))
          (rhoOneTangentDDefectHahn68 (ratFuncAtHahn46 T.root T.source.A)
        ...
        dsimp only [rhoOneCapCoordinateDefectT6LaurentCore68] at hT6L
        dsimp only [rhoOneCapCoordinateDefectT6Core68]
        rw [hCcoeff 7 (by norm_num), hCcoeff 13 (by norm_num),
          hCcoeff 8 (by norm_num), hCcoeff 12 (by norm_num),
          hCcoeff 9 (by norm_num), hCcoeff 11 (by norm_num),
          hCcoeff 10 (by norm_num), hBcoeff 17, hFcoeff 3,
          hBcoeff 16, hFcoeff 4, hBcoeff 15, hFcoeff 5,
          hBcoeff 14, hFcoeff 6, hBcoeff 13, hFcoeff 7,
          hBcoeff 12, hFcoeff 8, hBcoeff 11, hFcoeff 9,
          hAcoeff (-2)] at hT6L
        exact hT6L
      refine ⟨i3, sold, cs, ?_⟩
      dsimp only [RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationPacket68]
      exact ⟨hpacket, hT6⟩
    · exact (hrays.1 hcoord.1).elim
  · exact Or.inr htail

end AlignedSquareTerminalGBoundaryCapPostRestorationBackwire68
