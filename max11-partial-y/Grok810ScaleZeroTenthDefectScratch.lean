...
section DepressedRow810Eleventh
...
- F R' - 2 E S' - 3 D T' - 4 C U' - 5 B V' - 6 A W'`. -/
theorem differentialJacobian_coeff_6_monicOcticDecic
    ...
    (differentialJacobian d f g).coeff 6 =
      (7 : F) * g.coeff 7 * d (f.coeff 0) +
        ...
        (2 : F) * g.coeff 2 * d (f.coeff 5) +
        g.coeff 1 * d (f.coeff 6) -
          f.coeff 1 * d (g.coeff 6) -
          (2 : F) * f.coeff 2 * d (g.coeff 5) -
          (3 : F) * f.coeff 3 * d (g.coeff 4) -
          (4 : F) * f.coeff 4 * d (g.coeff 3) -
          (5 : F) * f.coeff 5 * d (g.coeff 2) -
          (6 : F) * f.coeff 6 * d (g.coeff 1) := by
  ...
  have hmem33 : ((3, 3) : ℕ × ℕ) ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ) :=
    Finset.HasAntidiagonal.mem_antidiagonal.mpr (by norm_num)
  have hmem42 : ((4, 2) : ℕ × ℕ) ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ) :=
    Finset.HasAntidiagonal.mem_antidiagonal.mpr (by norm_num)
  have hmem51 : ((5, 1) : ℕ × ℕ) ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ) :=
    Finset.HasAntidiagonal.mem_antidiagonal.mpr (by norm_num)
  have hmem60 : ((6, 0) : ℕ × ℕ) ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ) :=
    Finset.HasAntidiagonal.mem_antidiagonal.mpr (by norm_num)
  have hfirst :
      (coefficientDeriv d f * g.derivative).coeff 6 =
        (7 : F) * g.coeff 7 * d (f.coeff 0) +
          ...
          (3 : F) * g.coeff 3 * d (f.coeff 4) +
          (2 : F) * g.coeff 2 * d (f.coeff 5) +
          g.coeff 1 * d (f.coeff 6) := by
    rw [Polynomial.coeff_mul]
    have hne06_15 : ((0, 6) : ℕ × ℕ) ≠ (1, 5) := by decide
    have hne06_24 : ((0, 6) : ℕ × ℕ) ≠ (2, 4) := by decide
    have hne06_33 : ((0, 6) : ℕ × ℕ) ≠ (3, 3) := by decide
    have hne06_42 : ((0, 6) : ℕ × ℕ) ≠ (4, 2) := by decide
    have hne06_51 : ((0, 6) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hne06_60 : ((0, 6) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hne15_24 : ((1, 5) : ℕ × ℕ) ≠ (2, 4) := by decide
    have hne15_33 : ((1, 5) : ℕ × ℕ) ≠ (3, 3) := by decide
    have hne15_42 : ((1, 5) : ℕ × ℕ) ≠ (4, 2) := by decide
    have hne15_51 : ((1, 5) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hne15_60 : ((1, 5) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hne24_33 : ((2, 4) : ℕ × ℕ) ≠ (3, 3) := by decide
    have hne24_42 : ((2, 4) : ℕ × ℕ) ≠ (4, 2) := by decide
    have hne24_51 : ((2, 4) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hne24_60 : ((2, 4) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hne33_42 : ((3, 3) : ℕ × ℕ) ≠ (4, 2) := by decide
    have hne33_51 : ((3, 3) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hne33_60 : ((3, 3) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hne42_51 : ((4, 2) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hne42_60 : ((4, 2) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hne51_60 : ((5, 1) : ℕ × ℕ) ≠ (6, 0) := by decide
    have hsubset :
        ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1), (6, 0)} : Finset (ℕ × ℕ)) ⊆
      ...
      · subst b; exact hmem42
      · subst b; exact hmem51
      · subst b; exact hmem60
    have hsum :
        (∑ p ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ),
            (coefficientDeriv d f).coeff p.1 * g.derivative.coeff p.2) =
          (∑ p ∈ ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1), (6, 0)} : Finset (ℕ × ℕ)),
      ...
      have hne60 : b ≠ (6, 0) := by
        intro hEq; subst b; exact hbnot (by simp)
      have hanti6 : (Finset.HasAntidiagonal.antidiagonal (6 : ℕ) :
          Finset (ℕ × ℕ)) =
          ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1),
            (6, 0)} : Finset (ℕ × ℕ)) := by decide
      rw [hanti6] at hb
    ...
    have hpair :
        (∑ p ∈ ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1), (6, 0)} : Finset (ℕ × ℕ)),
          ...
          (coefficientDeriv d f).coeff 0 * g.derivative.coeff 6 +
            ...
            (coefficientDeriv d f).coeff 4 * g.derivative.coeff 2 +
            (coefficientDeriv d f).coeff 5 * g.derivative.coeff 1 +
            (coefficientDeriv d f).coeff 6 * g.derivative.coeff 0 := by
      rw [Finset.sum_insert (by simp [hne06_15, hne06_24, hne06_33, hne06_42, hne06_51, hne06_60]),
        Finset.sum_insert (by simp [hne15_24, hne15_33, hne15_42, hne15_51, hne15_60]),
        Finset.sum_insert (by simp [hne24_33, hne24_42, hne24_51, hne24_60]),
        Finset.sum_insert (by simp [hne33_42, hne33_51, hne33_60]),
        Finset.sum_insert (by simp [hne42_51, hne42_60]),
        Finset.sum_insert (by simp [hne51_60]),
    ...
    have hder1g : g.derivative.coeff 1 = (2 : F) * g.coeff 2 := by
      rw [Polynomial.coeff_derivative]
      ring
    have hder0g : g.derivative.coeff 0 = g.coeff 1 := by
      rw [Polynomial.coeff_derivative]
      simp
    rw [hsum, hpair, coeff_coefficientDeriv, coeff_coefficientDeriv,
      ...
      coeff_coefficientDeriv, coeff_coefficientDeriv, hder6, hder5, hder4,
      hder3, hder2, hder1g, hder0g]
    ring
  have hsecond :
    ...
    have hne42_51 : ((4, 2) : ℕ × ℕ) ≠ (5, 1) := by decide
    have hsubset :
        ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1)} : Finset (ℕ × ℕ)) ⊆
        Finset.HasAntidiagonal.antidiagonal (6 : ℕ) := by
      intro b hb
      simp only [Finset.mem_insert, Finset.mem_singleton] at hb
    ...
    have hsum :
        (∑ p ∈ Finset.HasAntidiagonal.antidiagonal (6 : ℕ),
          ...
          (∑ p ∈ ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1)} : Finset (ℕ × ℕ)),
      ...
      · by_cases h6 : b.1 = 6
        · have hf6 : f.derivative.coeff b.1 = 0 := by
          ...
          simp [hf6]
        · have hne0 : b.1 ≠ 0 := by
            intro h0; apply hne06; ext; exact h0; omega
          have hne1 : b.1 ≠ 1 := by
            intro h1; apply hne15; ext; exact h1; omega
          have hne2 : b.1 ≠ 2 := by
            intro h2; apply hne24; ext; exact h2; omega
          have hne3 : b.1 ≠ 3 := by
            intro h3; apply hne33; ext; exact h3; omega
          have hne4 : b.1 ≠ 4 := by
            intro h4; apply hne42; ext; exact h4; omega
          have hne5 : b.1 ≠ 5 := by
            intro h5; apply hne51; ext; exact h5; omega
          omega
    have hpair :
        (∑ p ∈ ({(0, 6), (1, 5), (2, 4), (3, 3), (4, 2), (5, 1)} : Finset (ℕ × ℕ)),
            f.derivative.coeff p.1 * (coefficientDeriv d g).coeff p.2) =
          f.derivative.coeff 0 * (coefficientDeriv d g).coeff 6 +
            ...
            f.derivative.coeff 4 * (coefficientDeriv d g).coeff 2 +
            f.derivative.coeff 5 * (coefficientDeriv d g).coeff 1 := by
      rw [Finset.sum_insert (by simp [hne06_15, hne06_24, hne06_33, hne06_42, hne06_51]),
        Finset.sum_insert (by simp [hne15_24, hne15_33, hne15_42, hne15_51]),
        Finset.sum_insert (by simp [hne24_33, hne24_42, hne24_51]),
        Finset.sum_insert (by simp [hne33_42, hne33_51]),
        Finset.sum_insert (by simp [hne42_51]),
        Finset.sum_singleton]
      ring
...
theorem kappaResidual810_deriv_zero
    ...
    d (kappaResidual810 L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 V0 W0) = 0 := by
  ...
  rw [hWderiv, hPderiv, hQderiv, hRderiv, hSderiv, hTderiv, hUderiv,
    hVderiv] at hrow_red
  simp only [kappaResidual810, alphaResidual810, betaResidual810,
    gammaResidual810, deltaResidual810, epsilonResidual810,
    ...
    h811024, h932, h732, h21128, h35128, h771024, zero_mul, add_zero, mul_zero, pow_two, hsq,
    hsqB, hsqC, hsqD, hcub, hcubB, hquar, hquint]
  rw [hWderiv, hPderiv, hQderiv, hRderiv, hSderiv, hTderiv, hUderiv, hVderiv]
  linear_combination (1 / 8 : F) * hrow_red

end DepressedRow810Eleventh

section NonzeroEleventhFaceClearing810
...
theorem nonzeroFace810_eleventhDefectPowerRelation
    ...
    ∃ eta : k,
      localClearedEleventhDefect810 h0 (p.coeff 7) (p.coeff 6) (p.coeff 5)
  ...
  have hkappa0deriv :
      ratFuncDerivation68
        (kappaResidual810 (g.coeff 9) (f.coeff 6) (f.coeff 5)
          (f.coeff 4) (f.coeff 3) (f.coeff 2) (f.coeff 1) (f.coeff 0)
          (g.coeff 8) (g.coeff 7) (g.coeff 6) (g.coeff 5) (g.coeff 4)
          (g.coeff 3) (g.coeff 2) (g.coeff 1)) = 0 :=
    kappaResidual810_deriv_zero ratFuncDerivation68 (g.coeff 9)
      (f.coeff 6) (f.coeff 5) (f.coeff 4) (f.coeff 3) (f.coeff 2)
      (f.coeff 1) (f.coeff 0) (g.coeff 8) (g.coeff 7) (g.coeff 6)
      (g.coeff 5) (g.coeff 4) (g.coeff 3) (g.coeff 2) (g.coeff 1)
      hLconst halpha0 hbeta0 hgamma0 hdelta0 hepsilon0 hzeta0 heta0deriv
      htheta0deriv (by simpa using hrow8) (by simpa using hrow6)
  ...
  have hclear :
      algebraMap k[X] (RatFunc k)
          (localClearedEleventhDefect810 h0 (p.coeff 7) (p.coeff 6)
        ...
        (1099511627776 : RatFunc k) * h ^ 77 *
          kappaResidual810 (g.coeff 9) (f.coeff 6) (f.coeff 5)
            (f.coeff 4) (f.coeff 3) (f.coeff 2) (f.coeff 1) (f.coeff 0)
            (g.coeff 8) (g.coeff 7) (g.coeff 6) (g.coeff 5) (g.coeff 4)
            (g.coeff 3) (g.coeff 2) (g.coeff 1) := by
    have hF := eleventhDefect_eq_clearedKappa810 h a7 a6 a5 a4 a3 a2 a1 a0 b9
    ...
    have hg9L : g.coeff 9 =
      ...
      simp [depressedL810, octicDepressionR810, sourceToRatFunc68,
        sourceToRatFunc46, b9]
    simpa [localClearedEleventhDefect810, map_sub, map_mul, map_pow,
      map_ofNat, map_neg, map_add, RatFunc.algebraMap_C, h, a7, a6, a5,
      a4, a3, a2, a1, a0, b8, b7, b6, b5, b4, b3, b2, b1, kappaResidual810,
  ...
  have htarget :
      algebraMap k[X] (RatFunc k)
          (localClearedEleventhDefect810 h0 (p.coeff 7) (p.coeff 6)
            ...
            (q.coeff 5) (q.coeff 4) (q.coeff 3) (q.coeff 2) (q.coeff 1) lambda) =
        algebraMap k[X] (RatFunc k)
          (Polynomial.C (1099511627776 * kappa0) * h0 ^ 77) := by
    rw [hclear, hkappa0]
    simp [h, map_mul, map_pow, RatFunc.algebraMap_C, map_ofNat]
    ring
  refine ⟨1099511627776 * kappa0, ?_⟩
  exact IsFractionRing.injective k[X] (RatFunc k) htarget

end NonzeroEleventhFaceClearing810

section ScaleZeroTenthDefect810
...
theorem normalized810ScaleZero_eleventhCoefficientJacobianRow_collapsed
  ...
  simpa only [p, q] using
    scaleZero_eleventhCoefficientJacobianRow_810 hp hq hjac hHdegree
...
theorem scaleZero_monicOcticDecic_degree6Row_810
...
theorem scaleZero_kappaResidual_deriv_zero_810
    {F : Type*} [Field F] [Algebra k F] [CharZero F]
    (d : Derivation k F F)
    (L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 V0 W0 : F)
    (hL : d L = 0)
    ...
    (hrow : (7 : F) * Q * d G0 + (6 : F) * R * d F0 +
        ...
        (3 : F) * D0 * d T0 - (4 : F) * C0 * d U0 -
        (5 : F) * B * d V0 - (6 : F) * A * d W0 = 0) :
    d (kappaResidual810 L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 V0 W0) = 0 :=
  kappaResidual810_deriv_zero d L A B C0 D0 E0 F0 G0 P Q R S0 T0 U0 V0 W0
    hL halpha hbeta hgamma hdelta hepsilon hzeta heta htheta hrow8 hrow
...
constant face. -/
theorem scaleZero_tenthClearedDefect_exists_C_810
    ...
    ∃ (lambda eta : k),
      ...
      localClearedEleventhDefect810 (Polynomial.C t) (p.coeff 7) (p.coeff 6)
        ...
        Polynomial.C eta * (Polynomial.C t) ^ 77 := by
  ...
  obtain ⟨eta, heta⟩ :=
    nonzeroFace810_eleventhDefectPowerRelation p q H (Polynomial.C t) j lambda
...
theorem scaleZero_alignedTenthClearedDefect_exists_C_810
    {p q : k[X][X]} {j t : k} {H : k[X]}
    (hp : p.natDegree = 8) (hq : q.natDegree = 10)
    (hD : GCD369SourceXDeriv p * derivative q -
      derivative p * GCD369SourceXDeriv q =
  ...
  obtain ⟨eta, heta⟩ :=
    nonzeroFace810_eleventhDefectPowerRelation p q H (Polynomial.C t) j 0
...
face. -/
theorem scaleZero_nonzeroTenthClearedDefect_exists_C_810
...
theorem normalized810ScaleZero_exists_tenthClearedDefect
    {P Q : MvPolynomial (Fin 2) k} {H : k[X]}
    (hsource : Normalized810LeadingCoreSource P Q H 0) :
    ∃ (t lambda eta : k),
      t ≠ 0 ∧
      ...
      (5 : k[X]) *
        ...
        Polynomial.C lambda * (Polynomial.C t) ^ 9 ∧
      localClearedEleventhDefect810 (Polynomial.C t)
          (((Polynomial.Bivariate.equivMvPolynomial k).symm P).coeff 7)
  ...
  obtain ⟨lambda, eta, hN, hX⟩ :=
    scaleZero_tenthClearedDefect_exists_C_810 hp hq hD ht hHsq
      (by simpa only [p] using hp8) (by simpa only [q] using hq10)
...
theorem normalized810ScaleZero_tenthClearedDefect_exists_C
  ...
  obtain ⟨t, lambda, eta, ht, hHsq, _hN, hX⟩ :=
    normalized810ScaleZero_exists_tenthClearedDefect hsource
  refine ⟨t, lambda, eta * t ^ 77, ht, hHsq, ?_⟩
  have hconst :
      localClearedEleventhDefect810 (Polynomial.C t)
          (((Polynomial.Bivariate.equivMvPolynomial k).symm P).coeff 7)
          (((Polynomial.Bivariate.equivMvPolynomial k).symm P).coeff 6)
...
theorem normalized810ScaleZero_tenthClearedDefect_natDegree_le_zero
  ...
  obtain ⟨t, lambda, eta, ht, hHsq, hX⟩ :=
    normalized810ScaleZero_tenthClearedDefect_exists_C hsource
...
theorem normalized810ScaleZero_tenthClearedDefectFirstFace
    {P Q : MvPolynomial (Fin 2) k} {H : k[X]}
    (hsource : Normalized810LeadingCoreSource P Q H 0) :
    let p := (Polynomial.Bivariate.equivMvPolynomial k).symm P
    let q := (Polynomial.Bivariate.equivMvPolynomial k).symm Q
    ...
    ∃ t : k, t ≠ 0 ∧ H = (Polynomial.C t) ^ 2 ∧
      ((N = 0 ∧
          ∃ eta : k,
            localClearedEleventhDefect810 (Polynomial.C t) (p.coeff 7)
              ...
              Polynomial.C eta * (Polynomial.C t) ^ 77) ∨
...
theorem normalized810ScaleZero_tenthClearedDefectBranches
  ...
  have hX :
    ...
    exact (map_mul (Polynomial.C : k →+* k[X]) eta0 (t ^ 77)).symm
...
closed. -/
theorem normalized810ScaleZero_aligned_exists_tenthClearedDefect
    {P Q : MvPolynomial (Fin 2) k} {H : k[X]}
    (hsource : Normalized810LeadingCoreSource P Q H 0)
    (hNzero :
      (5 : k[X]) *
  ...
  have hD : GCD369SourceXDeriv p * derivative q -
    ...
    simpa only [bivariateJacobian, xderiv, GCD369SourceXDeriv] using hjac
  obtain ⟨eta, hX⟩ :=
    scaleZero_alignedTenthClearedDefect_exists_C_810 hp hq hD ht hHsq
      (by simpa only [p] using hp8) (by simpa only [q] using hq10)
...
theorem normalized810ScaleZero_nonzero_exists_tenthClearedDefect
    {P Q : MvPolynomial (Fin 2) k} {H : k[X]}
    (hsource : Normalized810LeadingCoreSource P Q H 0)
    (hNnonzero :
      (5 : k[X]) *
...
end ScaleZeroTenthDefect810


#print axioms grokScaleZero_eleventhCoefficientJacobianRow_raw_810
#print axioms scaleZero_eleventhCoefficientJacobianRow_810
#print axioms normalized810ScaleZero_eleventhCoefficientJacobianRow
#print axioms normalized810ScaleZero_eleventhCoefficientJacobianRow_collapsed
#print axioms scaleZero_monicOcticDecic_degree6Row_810
#print axioms scaleZero_kappaResidual_deriv_zero_810
#print axioms affineDepress_degreeTen_coeff1_810
#print axioms eleventhDefect_eq_clearedKappa810
#print axioms nonzeroFace810_eleventhDefectPowerRelation
#print axioms scaleZero_tenthClearedDefect_exists_C_810
#print axioms scaleZero_alignedTenthClearedDefect_exists_C_810
#print axioms scaleZero_nonzeroTenthClearedDefect_exists_C_810
#print axioms normalized810ScaleZero_exists_tenthClearedDefect
#print axioms normalized810ScaleZero_tenthClearedDefect_exists_C
#print axioms normalized810ScaleZero_tenthClearedDefect_natDegree_le_zero
#print axioms normalized810ScaleZero_tenthClearedDefectFirstFace
#print axioms normalized810ScaleZero_tenthClearedDefectBranches
#print axioms normalized810ScaleZero_aligned_exists_tenthClearedDefect
#print axioms normalized810ScaleZero_nonzero_exists_tenthClearedDefect
