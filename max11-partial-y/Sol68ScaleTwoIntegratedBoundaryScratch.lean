import Sol68ScaleTwoLocalDerivativeRowTwoScratch
...
theorem algebraMap_localClearedIntegratedS68_scratch
...
theorem algebraMap_localClearedIntegratedT68_scratch
...
theorem algebraMap_localClearedIntegratedU68_scratch
    (h0 A0 B0 C00 D0 E0 : k[X]) (A B C0 D E : RatFunc k)
...
theorem algebraMap_localClearedIntegratedV68_scratch
    (h0 A0 B0 C00 D0 E0 : k[X]) (A B C0 D E : RatFunc k)
...
theorem SquareConstantLIntegratedLocalRootData68.integratedLocalRowTwoBoundaryData_scratch
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T0.source.clearedCoordinates_scratch hp T0.scale_ne_zero hH hp6
  ...
  have hS : algebraMap k[X] (RatFunc k) S0 =
    ...
    exact algebraMap_localClearedIntegratedS68_scratch h0 A0 B0 C00 D0
  ...
  have hT : algebraMap k[X] (RatFunc k) T00 =
    ...
    exact algebraMap_localClearedIntegratedT68_scratch h0 A0 B0 C00 D0 E0
  ...
  have hU : algebraMap k[X] (RatFunc k) U0 =
    ...
    exact algebraMap_localClearedIntegratedU68_scratch h0 A0 B0 C00 D0 E0
      T0.source.A T0.source.B T0.source.C0 T0.source.D T0.source.E l
      T0.source.alpha T0.source.beta T0.source.gamma T0.source.delta
      T0.source.zeta hA hB hC hD hE
  have hV : algebraMap k[X] (RatFunc k) V0 =
      (algebraMap k[X] (RatFunc k) h0) ^ 40 * VR := by
    exact algebraMap_localClearedIntegratedV68_scratch h0 A0 B0 C00 D0 E0
      T0.source.A T0.source.B T0.source.C0 T0.source.D T0.source.E l
      T0.source.alpha T0.source.beta T0.source.gamma T0.source.delta
      T0.source.epsilon T0.source.eta hA hB hC hD hE
  obtain ⟨c, hc, hsingle, hderiv⟩ :=
    ratFuncAtHahn68_linearRoot_single_deriv_scratch
      h0 T0.root T0.scale_degree T0.root_eq
  have hAco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 A0
    T0.source.A 10 hc hsingle hA
  have hBco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 B0
    T0.source.B 15 hc hsingle hB
  have hCco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 C00
    T0.source.C0 20 hc hsingle hC
  have hDco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 D0
    T0.source.D 25 hc hsingle hD
  have hEco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 E0
    T0.source.E 30 hc hsingle hE
  have hSco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 S0
    SR 25 hc hsingle hS
  have hTco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 T00
    TR 30 hc hsingle hT
  have hUco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 U0
    UR 35 hc hsingle hU
  have hVco := localHahn_coeff_neg_of_cleared_scratch T0.root c h0 V0
    VR 40 hc hsingle hV
  have hSord := localHahn_orderTop_ge_of_cleared_scratch T0.root h0 S0 SR
    25 T0.scale_order hS
  have hTord := localHahn_orderTop_ge_of_cleared_scratch T0.root h0 T00 TR
    30 T0.scale_order hT
  have hUord := localHahn_orderTop_ge_of_cleared_scratch T0.root h0 U0 UR
    35 T0.scale_order hU
  have hVord := localHahn_orderTop_ge_of_cleared_scratch T0.root h0 V0 VR
    40 T0.scale_order hV
  have hdTord := localHahn_deriv_orderTop_ge_of_cleared_scratch T0.root h0
    T00 TR 30 T0.scale_order hT
  have hdUord := localHahn_deriv_orderTop_ge_of_cleared_scratch T0.root h0
    U0 UR 35 T0.scale_order hU
  have hdVord := localHahn_deriv_orderTop_ge_of_cleared_scratch T0.root h0
    V0 VR 40 T0.scale_order hV
  have hdTco := localHahn_deriv_coeff_neg_succ_of_cleared_scratch
    T0.root c h0 T00 TR 30 hc hsingle hderiv hT
  have hdUco := localHahn_deriv_coeff_neg_succ_of_cleared_scratch
    T0.root c h0 U0 UR 35 hc hsingle hderiv hU
  have hdVco := localHahn_deriv_coeff_neg_succ_of_cleared_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowTwo_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T0 : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  apply T0.topRowTwo_zero_of_integratedBoundary_scratch hp hH hp6
  exact T0.integratedLocalRowTwoBoundaryData_scratch hp hH hp6
...
above. -/
theorem lowerRowOneHahn68_coeff_neg61_scratch
...
#print axioms algebraMap_localClearedIntegratedS68_scratch
#print axioms algebraMap_localClearedIntegratedT68_scratch
#print axioms algebraMap_localClearedIntegratedU68_scratch
#print axioms algebraMap_localClearedIntegratedV68_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.integratedLocalRowTwoBoundaryData_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowTwo_zero_scratch
#print axioms lowerRowOneHahn68_coeff_neg61_scratch
