import Sol68ScaleTwoAlignedSquareTerminalGBoundaryCapPostRestorationEightScratch
...
section AlignedSquareTerminalGBoundaryCapPostRestorationEightBackwire68

variable {k : Type*} [Field k] [CharZero k]

local instance alignedSquareCapPostRestorationEightBackwireHahnCharZero68 :
    CharZero (LaurentSeries k) :=
  charZero_of_injective_ringHom
    (HahnSeries.C_injective (R := k) (Γ := ℤ))

def RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationEightResidual68
...
theorem SquareZeroLIntegratedLocalRootData68.rhoOne_exceptional_doubleZero_refinedGZero_terminalGBoundaryCapPostRestorationEightResidual
    [IsAlgClosed k]
  ...
  dsimp only [RhoOneDoubleZeroTerminalGBoundaryCapPostRestorationEightResidual68]
  have hprevRaw :=
    T.rhoOne_exceptional_doubleZero_refinedGZero_terminalGBoundaryCapPostRestorationSevenResidual
...
end AlignedSquareTerminalGBoundaryCapPostRestorationEightBackwire68
