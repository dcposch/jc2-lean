import Sol68ScaleTwoNonalignedInfinityScratch
...
theorem SquareConstantLIntegratedSourceData68.clearedCoordinates_scratch
...
theorem localHahn_orderTop_ge_of_cleared_scratch
...
root. -/
theorem ratFuncAtHahn68_linearRoot_eq_single_scratch
...
theorem localHahn_coeff_neg_of_cleared_scratch
...
coordinates. -/
theorem SquareConstantLIntegratedLocalRootData68.coordinateOrderBounds_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinates_scratch hp T.scale_ne_zero hH hp6
  exact ⟨
...
theorem SquareConstantLIntegratedLocalRootData68.coordinateInitialCoeffs_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  · simpa using localHahn_coeff_neg_of_cleared_scratch T.root c h0
...
theorem weightedMonomial68_coeff_at_weight_scratch
...
theorem weightedMonomial68_orderTop_gt_scratch
    (c : k) (A B C0 D E : HahnSeries ℚ k)
...
theorem firstIntegralFour68_eq_localFaces_scratch
    (L beta gamma delta epsilon zeta : k)
...
local exponent `-45`. -/
theorem firstIntegralFourHigherHahn68_coeff_neg45_scratch
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
...
theorem firstIntegralFourTopFaceHahn68_coeff_neg45_scratch
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-10 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-15 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    (hC : (↑(-20 : ℚ) : WithTop ℚ) ≤ C0.orderTop)
...
theorem firstIntegralFour68_coeff_neg45_scratch
    (L beta gamma delta epsilon zeta : k)
    (A B C0 D E : HahnSeries ℚ k)
    (hA : (↑(-10 : ℚ) : WithTop ℚ) ≤ A.orderTop)
    (hB : (↑(-15 : ℚ) : WithTop ℚ) ≤ B.orderTop)
    ...
    (firstIntegralFour68 (HahnSeries.C L) A B C0 D E
      ...
      (8 / 81 : k) * topRowFour68 (A.coeff (-10 : ℚ))
        (B.coeff (-15 : ℚ)) (C0.coeff (-20 : ℚ))
        (D.coeff (-25 : ℚ)) (E.coeff (-30 : ℚ)) := by
  rw [firstIntegralFour68_eq_localFaces_scratch,
    HahnSeries.coeff_add,
    firstIntegralFourTopFaceHahn68_coeff_neg45_scratch A B C0 D E
      hA hB hC hD hE,
    firstIntegralFourHigherHahn68_coeff_neg45_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowFour_zero_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.coordinateOrderBounds_scratch hp hH hp6
  ...
  rw [hconst] at hcoeff
  have hface := firstIntegralFour68_coeff_neg45_scratch
...
#print axioms SquareConstantLIntegratedSourceData68.clearedCoordinates_scratch
#print axioms localHahn_orderTop_ge_of_cleared_scratch
#print axioms ratFuncAtHahn68_linearRoot_eq_single_scratch
#print axioms localHahn_coeff_neg_of_cleared_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateOrderBounds_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateInitialCoeffs_scratch
#print axioms weightedMonomial68_coeff_at_weight_scratch
#print axioms weightedMonomial68_orderTop_gt_scratch
#print axioms firstIntegralFour68_coeff_neg45_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowFour_zero_scratch
