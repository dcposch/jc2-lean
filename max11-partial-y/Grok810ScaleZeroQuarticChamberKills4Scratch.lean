...
theorem quarticChamberBCEG16810_impossible
  ...
  have hr1 : (muQuarticChamberRest7810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest7810_natDegree_lt_of_live_BCEG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hDz hFz (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := muQuarticChamberFace7810_coeff_top hCne hGne (A := A) (B := B) (D := D) (E := E) (F := F) (by omega)
  have hq1 : (degreeZeroMuQuartic810 l beta gamma delta epsilon zeta eta theta
...
theorem quarticChamberBEFG6810_impossible
  ...
  have hr1 : (xiQuarticChamberRest19810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest19810_natDegree_lt_of_live_BEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hCz hDz (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct1 := xiQuarticChamberFace19810_coeff_top hAne hBne hEne hGne (C := C) (D := D) (F := F) (by omega)
...
theorem quarticChamberCDFG21810_impossible
  ...
  have hr0 : (muQuarticChamberRest8810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest8810_natDegree_lt_of_live_CDFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp0 hBz hEz (by omega) (by omega) hz0l hz0beta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hr1 : (xiQuarticChamberRest3810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest3810_natDegree_lt_of_live_CDFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp1 hBz hEz (by omega) hz1l hz1beta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
...
theorem quarticChamberBCDEF5810_impossible
  ...
  have hr2 : (piQuarticChamberRest2000810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest2000810_natDegree_lt_of_live_BCDEF l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdp2 hGz (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz2l hz2beta (Or.inr (by omega)) hz2delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  have hct2 := piQuarticChamberFace2000810_coeff_top hAne hBne hCne hFne (D := D) (E := E) (G := G) (by omega) (by omega) (by omega) (by omega)
  have hq2 : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).coeff (2 * A.natDegree + 4 * B.natDegree) = 0 := by
    apply coeff_eq_zero_of_natDegree_lt
