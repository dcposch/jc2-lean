import Sol68ScaleTwoLocalRowThreeScratch
...
boundary monomial. -/
theorem localHahn_deriv_coeff_neg_succ_of_cleared_scratch
...
theorem ratFuncAtHahn68_linearRoot_single_deriv_scratch
...
local package. -/
theorem SquareConstantLIntegratedLocalRootData68.coordinateDerivativeInitialCoeffs_scratch
  ...
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · convert localHahn_deriv_coeff_neg_succ_of_cleared_scratch
...
theorem algebraMap_localDerivativeCleared_scratch
...
theorem localHahn_deriv_orderTop_ge_of_cleared_scratch
  ...
  let dA0 : k[X] :=
    h0 * A0.derivative - C (n : k) * h0.derivative * A0
  apply localHahn_orderTop_ge_of_cleared_scratch a h0 dA0
    (Differential.deriv A) (n + 1) hscale
  dsimp only [dA0]
  exact algebraMap_localDerivativeCleared_scratch h0 A0 A n hclear

/-- The exact derivative Newton box for the five depressed coordinates. -/
theorem SquareConstantLIntegratedLocalRootData68.coordinateDerivativeOrderBounds_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
    (T : SquareConstantLIntegratedLocalRootData68 p q j h0 l)
    (hp : p.natDegree = 6) (hH : H = h0 ^ 2)
    (hp6 : p.coeff 6 = H ^ 3) :
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T.source.clearedCoordinates_scratch hp T.scale_ne_zero hH hp6
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · convert localHahn_deriv_orderTop_ge_of_cleared_scratch T.root h0
...
theorem lowerRowTwoHahn68_coeff_neg56_scratch
...
theorem SquareConstantLIntegratedLocalRootData68.topRowTwo_zero_of_integratedBoundary_scratch
    {p q : k[X][X]} {j l : k} {h0 H : k[X]}
  ...
  obtain ⟨hA, hB, hC, hD, hE⟩ :=
    T0.coordinateOrderBounds_scratch hp hH hp6
  obtain ⟨hdA, hdB, hdC, hdD, hdE⟩ :=
    T0.coordinateDerivativeOrderBounds_scratch hp hH hp6
  obtain ⟨hdAco, hdBco, hdCco, hdDco, hdEco⟩ :=
    T0.coordinateDerivativeInitialCoeffs_scratch hp hH hp6
  ...
  have hface := lowerRowTwoHahn68_coeff_neg56_scratch
...
#print axioms localHahn_deriv_coeff_neg_succ_of_cleared_scratch
#print axioms ratFuncAtHahn68_linearRoot_single_deriv_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateDerivativeInitialCoeffs_scratch
#print axioms algebraMap_localDerivativeCleared_scratch
#print axioms localHahn_deriv_orderTop_ge_of_cleared_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.coordinateDerivativeOrderBounds_scratch
#print axioms lowerRowTwoHahn68_coeff_neg56_scratch
#print axioms SquareConstantLIntegratedLocalRootData68.topRowTwo_zero_of_integratedBoundary_scratch
