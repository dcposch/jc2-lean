import Grok810ScaleZeroQuarticChamberResidual7Scratch
...
0 chambers of `QuarticChamberResidual4810`, the all-constant
...
theorem normalized810ScaleZero_impossible_of_residual7Kills
    ...
    (hresid :
      ∀ (j t l beta gamma delta epsilon zeta eta theta : k)
        ...
        QuarticChamberResidual7810 A B C D E F G →
        False)
    (hcorner :
  ...
  obtain ⟨t, j, lambda, cleared, l, beta, gamma, delta, epsilon, zeta,
    ...
    normalized810ScaleZero_quarticChamber7Residual hsource
  ...
  · rcases hcase with ⟨hl0, hb0, hd0, hz0, hBn, hCn, hDn, hEn, hFn, hGn⟩ | hres
    · subst hl0; subst hb0; subst hd0; subst hz0
      exact hcorner gamma epsilon eta theta A B C D E F G hjdiv hder
    ...
    · exact hresid j t l beta gamma delta epsilon zeta eta theta
        ...
        hconeA hres
  · exact habcdefg l beta gamma delta epsilon zeta eta theta
