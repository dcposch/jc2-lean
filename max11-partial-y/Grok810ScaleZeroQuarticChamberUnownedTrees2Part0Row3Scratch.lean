...
private theorem quarticChamberBCFG7810_impossible_row3
  ...
  have hdp1 : 0 < A.natDegree + 3 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz1 : 0 < A.natDegree + 3 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  ...
  have hz1l : l = 0 ∨ (5 * A.natDegree < A.natDegree + 3 * B.natDegree ∧ 3 * A.natDegree + C.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * A.natDegree + 2 * B.natDegree < A.natDegree + 3 * B.natDegree ∧ A.natDegree + 2 * C.natDegree < A.natDegree + 3 * B.natDegree ∧ 2 * B.natDegree + C.natDegree < A.natDegree + 3 * B.natDegree ∧ A.natDegree + G.natDegree < A.natDegree + 3 * B.natDegree ∧ B.natDegree + F.natDegree < A.natDegree + 3 * B.natDegree) := by
    ...
    · exact Or.inl h
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
  ...
  have hz1theta : theta = 0 ∨ (A.natDegree < A.natDegree + 3 * B.natDegree) := by
    ...
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
    · exact Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 h; omega)
  have hSpeedT_l_zero : l = 0 := by
    rcases hz1l with h | h
    · exact h
    · clear * - h hpv2
      omega
  have hSpeedT_beta_zero : beta = 0 := by
    rcases hz1beta with h | h
    · exact h
    · clear * - h hpv2
      omega
  have hSpeedT_delta_zero : delta = 0 := by
    rcases hz1delta with h | h
    · exact h
    · clear * - h hpv2
      omega
  have hSpeedT_zeta_zero : zeta = 0 := by
    rcases hz1zeta with h | h
    · exact h
    · clear * - h hpv2
      omega
  have hSpeedT_theta_zero : theta = 0 := by
    rcases hz1theta with h | h
    · exact h
    · clear * - h hpv2
      omega
  have hr1 : (kappaQuarticChamberRest9500810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest9500810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 hDz hEz hz1l hz1beta (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) hz1delta hz1zeta (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) hz1theta
  ...
  rw [degreeZeroKappaQuartic810_eq_face9500_add_rest, coeff_add,
    ...
    kappaQuarticChamberFace9500810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy0
  have hdp3 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz3 : 0 < A.natDegree + 2 * B.natDegree + C.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr3 : (muQuarticChamberRest9501810 l beta gamma delta epsilon zeta eta theta
    ...
    muQuarticChamberRest9501810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega))
  ...
  rw [degreeZeroMuQuartic810_eq_face9501_add_rest, coeff_add,
    ...
    muQuarticChamberFace9501810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy2
  have hdp5 : A.natDegree < A.natDegree + 3 * B.natDegree + C.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz5 : 0 < A.natDegree + 3 * B.natDegree + C.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hlf5 : (n3QuarticChamberRestLF9501810 A B C D E F G).natDegree < A.natDegree + 3 * B.natDegree + C.natDegree :=
    n3QuarticChamberRestLF9501810_natDegree_lt_of_live_BCFG
      A B C D E F G hdz5 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)
  have hr5 : (n3QuarticChamberRestOff1810 l beta gamma delta epsilon zeta eta theta
    ...
    n3QuarticChamberRestOff1810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz5 hDz hEz hlf5 (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  have hsy4 : (degreeZeroN3Quartic810 l beta gamma delta epsilon zeta eta theta
    ...
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2 hle; omega
  have hcc5 : (n3QuarticColumnTop1810 epsilon A B C D E F G).coeff
    ...
    rw [show (A.natDegree + 3 * B.natDegree + C.natDegree) = (A.natDegree + B.natDegree + C.natDegree) from by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega]
    exact n3QuarticColumnTop1810_coeff epsilon hAne hBne hCne hFne (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)
  rw [degreeZeroN3Quartic810_eq_face9501_add_rest,
    ...
    hcc5,
    n3QuarticChamberFace9501810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy4
  have hdp7 : A.natDegree < 2 * A.natDegree + 3 * B.natDegree + C.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz7 : 0 < 2 * A.natDegree + 3 * B.natDegree + C.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hlf7 : (n4QuarticChamberRestLF9502810 A B C D E F G).natDegree < 2 * A.natDegree + 3 * B.natDegree + C.natDegree :=
    n4QuarticChamberRestLF9502810_natDegree_lt_of_live_BCFG
      A B C D E F G hdz7 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)
  have hr7 : (n4QuarticChamberRestOff2810 l beta gamma delta epsilon zeta eta theta
    ...
    n4QuarticChamberRestOff2810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz7 hDz hEz hlf7 (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  ...
  have hcc7 : (n4QuarticColumnTop2810 epsilon A B C D E F G).coeff
    ...
    rw [show (2 * A.natDegree + 3 * B.natDegree + C.natDegree) = (2 * A.natDegree + B.natDegree + C.natDegree) from by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega]
    exact n4QuarticColumnTop2810_coeff epsilon hAne hBne hCne hFne (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)
  rw [degreeZeroN4Quartic810_eq_face9502_add_rest,
    ...
    hcc7,
    n4QuarticChamberFace9502810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy6
  have hdp9 : 2 * A.natDegree < 2 * A.natDegree + 3 * B.natDegree + C.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz9 : 0 < 2 * A.natDegree + 3 * B.natDegree + C.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr9 : (n6QuarticChamberRest9501810 l beta gamma delta epsilon zeta eta theta
    ...
    n6QuarticChamberRest9501810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz9 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  ...
  rw [degreeZeroN6Quartic810_eq_face9501_add_rest, coeff_add,
    ...
    n6QuarticChamberFace9501810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy8
  have hdp11 : 0 < 2 * A.natDegree + 3 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz11 : 0 < 2 * A.natDegree + 3 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr11 : (nuQuarticChamberRest9500810 l beta gamma delta epsilon zeta eta theta
    ...
    nuQuarticChamberRest9500810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz11 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  ...
  rw [degreeZeroNuQuartic810_eq_face9500_add_rest, coeff_add,
    ...
    nuQuarticChamberFace9500810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy10
  have hdp13 : 0 < 3 * A.natDegree + 3 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz13 : 0 < 3 * A.natDegree + 3 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr13 : (omicronQuarticChamberRest9500810 l beta gamma delta epsilon zeta eta theta
    ...
    omicronQuarticChamberRest9500810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz13 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  ...
  rw [degreeZeroOmicronQuartic810_eq_face9500_add_rest, coeff_add,
    ...
    omicronQuarticChamberFace9500810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy12
  have hdp15 : 0 < 2 * A.natDegree + 4 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz15 : 0 < 2 * A.natDegree + 4 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr15 : (piQuarticChamberRest9501810 l beta gamma delta epsilon zeta eta theta
    ...
    piQuarticChamberRest9501810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz15 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega))
  ...
  rw [degreeZeroPiQuartic810_eq_face9501_add_rest, coeff_add,
    ...
    piQuarticChamberFace9501810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy14
  have hdp17 : A.natDegree < 4 * A.natDegree + 3 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz17 : 0 < 4 * A.natDegree + 3 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hr17 : (primitiveQuarticChamberRest9500810 l beta gamma delta epsilon zeta eta theta
    ...
    primitiveQuarticChamberRest9500810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz17 hDz hEz (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_zeta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_theta_zero)
  ...
  rw [degreeZeroPrimitiveQuartic810_eq_face9500_add_rest, coeff_add,
    ...
    primitiveQuarticChamberFace9500810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy16
  have hdp19 : 0 < A.natDegree + 4 * B.natDegree := by
    clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  have hdz19 : 0 < A.natDegree + 4 * B.natDegree := by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega
  ...
  have hr19 : (xiQuarticChamberRestOff1810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRestOff1810_natDegree_lt_of_live_BCFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz19 hDz hEz hlf19 (Or.inl hSpeedT_l_zero) (Or.inl hSpeedT_beta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inl hSpeedT_delta_zero) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)) (Or.inr (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega))
  ...
  have hcc19 : (xiQuarticColumnTop1810 epsilon A B C D E F G).coeff
    ...
    rw [show (A.natDegree + 4 * B.natDegree) = (A.natDegree + 2 * B.natDegree) from by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega]
    exact xiQuarticColumnTop1810_coeff epsilon hAne hBne hCne hGne (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)
  rw [degreeZeroXiQuartic810_eq_face9501_add_rest,
    ...
    hcc19,
    xiQuarticChamberFace9501810_coeff_top hAne hBne hCne hFne hGne (D := D) (E := E) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega) (by clear * - hq0 hq1 hq4 hApos hDn hEn hpv2; omega)] at hsy18
