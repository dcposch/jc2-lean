...
theorem quarticChamberBCDEFG21810_impossible
  ...
  have hct0 := muQuarticChamberFace17810_coeff_top_S20 hAne hBne hDne hEne hFne (C := C) (G := G) (by omega) (by omega)
  ...
  have hct1 := xiQuarticChamberFace22810_coeff_top_S20 hAne hDne hEne hFne hGne (B := B) (C := C) (by omega)
  ...
  have hct2 := piQuarticChamberFace14810_coeff_top_S20 hAne hFne hGne (B := B) (C := C) (D := D) (E := E) (by omega)
