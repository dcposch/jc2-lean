...
/-- The Singular-lifted certificate of chamber `BCDEFG` / `CG·DD·CCC` leaf 8: the 10 face rows force `d ^ 2 * e = 0`. -/
theorem quarticUnownedSystemBCDEFG102L8810_cert
    (a b c d e f g : k)
...
set_option maxHeartbeats 64000000 in
/-- Unowned chamber `BCDEFG` / `CG·DD·CCC` leaf 8 dies on the 10-carrier system (κ, μ, ν, ξ, ο, π, Π, N₂, N₃, N₄). -/
theorem quarticRefinedBCDEFG102L8810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticRefinedBCDEFG102L8810 A B C D E F G)
  ...
  have hr0 : (kappaQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
    ...
    kappaQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  have hr2 : (nuQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
    ...
    nuQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  have hr3 : (xiQuarticChamberRest6002810 l beta gamma delta epsilon zeta eta theta
    ...
    xiQuarticChamberRest6002810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hr4 : (omicronQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
    ...
    omicronQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  have hr6 : (primitiveQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
    ...
    primitiveQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
  ...
  exact quarticUnownedSystemBCDEFG102L8810_cert A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hin5 hin6 hin7 hin8 hin9 hDc hEc
...
set_option maxHeartbeats 64000000 in
/-- Unowned chamber `BCDEFG` / `CG·DD·CCC` leaf 10 dies on the 5-carrier system (μ, π, N₂, N₃, N₄). -/
theorem quarticRefinedBCDEFG102L10810_impossible
    (l beta gamma delta epsilon zeta eta theta : k)
    (A B C D E F G : k[X])
    (hch : QuarticRefinedBCDEFG102L10810 A B C D E F G)
    (hnc : ¬ (B.natDegree = 0 ∧ C.natDegree = 0 ∧ D.natDegree = 0 ∧
        E.natDegree = 0 ∧ F.natDegree = 0 ∧ G.natDegree = 0))
    (hkap : (degreeZeroKappaQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0)
    ...
    (hpiDeg : (degreeZeroPiQuartic810 l beta gamma delta epsilon zeta eta theta
          A B C D E F G).natDegree = 0) :
    False := by
  obtain ⟨hcell, hx0, hx1, hx2, hx3, hx4⟩ := hch
  obtain ⟨hA, hBne, hCne, hDne, hEne, hFne, hGne, hq0, hq1, hq2, hq3, hq4, hq5, hq6, hq7, hq8, hq9, hq10, hq11, hq12, hq13, hq14, hq15, hq16, hq17, hq18, hq19, hq20, hq21, hq22⟩ := hcell
  obtain ⟨hApos, hAB, hAC, hAD, hAE, hAF, hAG⟩ := id hA
  have hAne : A ≠ 0 := by
    intro h0
  ...
  have hr1 : (piQuarticChamberRest6004810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + C.natDegree + 2 * D.natDegree :=
    piQuarticChamberRest6004810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz1 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz1l hz1beta (Or.inr (by omega)) hz1delta (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega)) (Or.inr (by omega))
  ...
  have hr3 : (n3QuarticChamberRest6000810 l beta gamma delta epsilon zeta eta theta
      A B C D E F G).natDegree < A.natDegree + 2 * C.natDegree + D.natDegree :=
    n3QuarticChamberRest6000810_natDegree_lt_of_live_BCDEFG l beta gamma delta epsilon zeta eta theta
      A B C D E F G hdz3 (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) (by omega) hz3l hz3beta (Or.inr (by omega)) hz3delta (Or.inr (by omega)) hz3zeta (Or.inr (by omega)) hz3theta
  ...
  exact quarticUnownedSystemBCDEFG102L10810_cert A.leadingCoeff B.leadingCoeff C.leadingCoeff D.leadingCoeff E.leadingCoeff F.leadingCoeff G.leadingCoeff hin0 hin1 hin2 hin3 hin4 hDc hGc
