import Grok810ScaleZeroQuarticAssemblyCoreScratch
...
* `quarticChamberResidual{tag}810_impossible` — the aggregate kill of the
  172-constructor inductive `QuarticChamberResidual6810`
...
theorem normalized810ScaleZero_impossible
    {P Q : MvPolynomial (Fin 2) k} {H : k[X]}
    (hsource : Normalized810LeadingCoreSource P Q H 0) :
    False :=
  normalized810ScaleZero_impossible_of_residualKills
    quarticChamberResidual6810_impossible
...
theorem planeKeller810ScaleZeroExclusion_closed :
    PlaneKeller810ScaleZeroExclusion (K := k) :=
  planeKeller810ScaleZeroExclusion_of_impossible
    (fun P Q H hsource => normalized810ScaleZero_impossible hsource)

#print axioms normalized810ScaleZero_impossible
#print axioms planeKeller810ScaleZeroExclusion_closed
